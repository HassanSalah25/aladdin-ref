        ...
        <div class="container">
            <div class="d-flex gap-4 position-relative overflow-hidden">
                ...
                <div class="cateogires__items flex-fill">
                    <!-- start order-area  -->
                    <div
                        class="categories__orders d-flex  flex-column mb-5 flex-md-row justify-content-between align-items-md-center gap-4">
                        <form class="d-flex flex-column flex-wrap flex-lg-row align-items-lg-center gap-4"
                            ...
                            <div class="d-flex gap-3 align-items-center categories__orders__item">
                                ...
                                <select class="form-select border-0" id="selectOrderBy" name="filter_sort_by">
                                    ...
                                    <option
                                        value="7" <?php echo e(("بالقرب مني" == request('search_city_state') || 7 == request('filter_sort_by')) ? 'selected' : ''); ?>><?php echo e(__('frontend.homepage.nearby-listings')); ?></option>
                                <option value="<?php echo e(\App\Models\Item::ITEMS_SORT_BY_NEWEST_CREATED); ?>" <?php echo e(request('filter_sort_by') == \App\Models\Item::ITEMS_SORT_BY_NEWEST_CREATED ? 'selected' : ''); ?>><?php echo e(__('listings_filter.sort-by-newest')); ?></option>
                                <option value="<?php echo e(\App\Models\Item::ITEMS_SORT_BY_OLDEST_CREATED); ?>" <?php echo e(request('filter_sort_by') == \App\Models\Item::ITEMS_SORT_BY_OLDEST_CREATED ? 'selected' : ''); ?>><?php echo e(__('listings_filter.sort-by-oldest')); ?></option>
                                </select>
                            </div>
                            ...
                            <div class="d-flex gap-3 align-items-center categories__orders__item">
                                <label for="selectOrderBy" class="white-space-nowrap">
                                    <i class="las la-filter"></i>
                                    <span><?php echo e(__('categories.all-cat')); ?></span>
                                </label>

                                <select class="form-select border-0" id="selectOrderBy" name="search_category">
                                    <option
                                        value="" <?php echo e(empty(request('search_category')) ? 'selected' : ''); ?>><?php echo e(__('categories.all-cat')); ?></option>
                                    
                                    <?php $__currentLoopData = $search_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category_key=> $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            value="<?php echo e($category->id); ?>" <?php echo e(request('search_category') == $category->id ? 'selected' : ''); ?>><?php echo e($category->category_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="d-flex gap-3 align-items-center categories__orders__item">
                                <label for="selectOrderBy" class="white-space-nowrap">
                                    <i class="las la-filter"></i>
                                    <span><?php echo e(__('categories.all-sub-cat')); ?></span>
                                </label>

                                <select class="form-select border-0" id="selectOrderBy" name="search_category_2">
                                    <option
                                        value="" <?php echo e(empty(request('search_category_2')) ? 'selected' : ''); ?>><?php echo e(__('categories.all-sub-cat')); ?></option>
                                    
                                    <?php $__currentLoopData = $all_sub_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category_key=> $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option
                                            value="<?php echo e($category->id); ?>" <?php echo e(request('search_category_2') == $category->id ? 'selected' : ''); ?>><?php echo e($category->category_name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div id="dropdown-parent-id" class="dropdown-parent gap-3 what_input_field_tpm">
                                <div id="search-by-id" class="autocomplete search-by" style="height: 44px;">
                                    ...
                                    <div id="search-whatautocomplete-list"
                                         class="autocomplete-items fixed-height"></div>
                                </div>
                            </div>
                            <button type="submit"
                                    class="categories__orders__layout-btn px-1 d-grid row align-items-center text-light"
                                    data-layout="4">
                                        ...
                                        <div class="swiper category-swiper__inner">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    ...
                                                    <?php else: ?>
                                                        <a class="category-slide__item  d-flex justify-content-center"
                                                           href="<?php echo e(route('page.item',[
                                                                                                                            'category_slug' => $ad->item->first()->category->parent?->category_slug ?? $ad->item->first()->category->category_slug,
                                                                                                                            'sub_category_slug' => $ad->item->first()->category->category_slug,
                                                                                                                            'state_slug' => $ad->item->first()->state->state_slug,
