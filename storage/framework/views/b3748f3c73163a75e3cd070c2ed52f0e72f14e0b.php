    ...
    <div class="row justify-content-center g-5 row-cols-1 row-cols-md-2 row-cols-xl-4">
        ...
        <div class='row'>
            <div class="auth__inner__form__auth-list d-flex align-items-center justify-content-center gap-3">
                <a href="https://www.facebook.com/profile.php?id=61550153913279 "><img width="30" height="30" src="<?php echo e(asset('facebook.png')); ?>"></a>
                <a href="https://www.instagram.com/aladdin__eg/"><img width="30" height="30" src="<?php echo e(asset('instagram.png')); ?>"></a>
                <a href="https://www.pinterest.com/aladdindirectory/"><img width="30" height="30" src="<?php echo e(asset('pinterest.png')); ?>"></a>
                <a href="https://www.tiktok.com/@aladdin__eg"><img width="30" height="30" src="<?php echo e(asset('tik-tok.png')); ?>"></a>
                <a href="https://twitter.com/Aladdin__eg"><img width="30" height="30" src="<?php echo e(asset('twitter.png')); ?>"></a>
                <a href="https://www.youtube.com/channel/UCbajMblORHZOQZmE38vfWDw"><img width="30" height="30" src="<?php echo e(asset('youtube (1).png')); ?>"></a>
                <a href="https://vimeo.com/user205850709"><img width="30" height="30" src="<?php echo e(asset('vimeo.png')); ?>"></a>
                <a href="https://www.behance.net/aladdineg"><img width="30" height="30" src="<?php echo e(asset('behance.png')); ?>"></a>
            </div>
