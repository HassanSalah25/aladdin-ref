                ...
                <div class="overlap-category ">
                    ...
                    <div class="row align-items-stretch no-gutters">
                        ...
                        <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
                            ...
                            <a href="<?php echo e(route('page.category', ['parent_category_slug'=> $category->parent->category_slug,'category_slug'=>$category->category_slug])); ?>" class="popular-category h-100">
                                <span class="icon">
                                    <span>
                            ...
                            <a href="<?php echo e(route('page.category', ['parent_category_slug'=> $category->parent->category_slug,'category_slug'=>$category->category_slug])); ?>" class="popular-category h-100 image-category">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="cateogries__filters">
                        ...
                        <form method="GET" action="<?php echo e(route('page.category', ['parent_category_slug'=> $category->parent->category_slug,'category_slug'=>$category->category_slug])); ?>" id="filter_form">
...
unset($__errorArgs, $__bag); ?>" name="filter_sort_by" id="filter_sort_by">
                                        <option value="<?php echo e(\App\Models\Item::ITEMS_SORT_BY_NEWEST_CREATED); ?>" <?php echo e($filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_NEWEST_CREATED ? 'selected' : ''); ?>><?php echo e(__('listings_filter.sort-by-newest')); ?></option>
                                        <option value="<?php echo e(\App\Models\Item::ITEMS_SORT_BY_OLDEST_CREATED); ?>" <?php echo e($filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_OLDEST_CREATED ? 'selected' : ''); ?>><?php echo e(__('listings_filter.sort-by-oldest')); ?></option>
                                        ...
                                        <option value="<?php echo e(\App\Models\Item::ITEMS_SORT_BY_NEARBY_FIRST); ?>" <?php echo e($filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_NEARBY_FIRST ? 'selected' : ''); ?>><?php echo e(__('theme_alaadin.filter-sort-by-nearby-first')); ?></option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row">
                                <div class="col-12 text-right">
                                    <a class="btn btn-sm btn-outline-primary rounded" href="<?php echo e(route('page.category', ['parent_category_slug'=> $category->parent->category_slug,'category_slug'=>$category->category_slug])); ?>">
