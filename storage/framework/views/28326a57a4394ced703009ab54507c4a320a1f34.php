...
unset($__errorArgs, $__bag); ?>" name="user_prefer_language">
                                    ...
                                    <?php $__currentLoopData = \App\Models\Setting::LANGUAGES; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting_languages_key => $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($site_global_settings->settingLanguage->$language == \App\Models\SettingLanguage::LANGUAGE_ENABLE): ?>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hassan/Downloads/refactore aladdin/resources/views/backend/admin/user/profile/edit.blade.php ENDPATH**/ ?>