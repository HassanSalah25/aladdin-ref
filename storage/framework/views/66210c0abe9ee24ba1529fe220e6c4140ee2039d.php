                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="import_item_data_process_status[]" id="import_item_data_process_status_not_processed" value="<?php echo e(\App\Models\ImportItemData::PROCESS_STATUS_NOT_PROCESSED); ?>" <?php echo e(in_array(\App\Models\ImportItemData::PROCESS_STATUS_NOT_PROCESSED, $import_item_data_process_status) ? 'checked' : ''); ?>>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="import_item_data_process_status[]" id="import_item_data_process_status_success_processed" value="<?php echo e(\App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS); ?>" <?php echo e(in_array(\App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS, $import_item_data_process_status) ? 'checked' : ''); ?>>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="import_item_data_process_status[]" id="import_item_data_process_status_error_processed" value="<?php echo e(\App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_ERROR); ?>" <?php echo e(in_array(\App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_ERROR, $import_item_data_process_status) ? 'checked' : ''); ?>>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-4">
                                <select class="custom-select" name="order_by">
                                    <option value="<?php echo e(\App\Models\ImportItemData::ORDER_BY_ITEM_NEWEST_PROCESSED); ?>" <?php echo e($order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_NEWEST_PROCESSED ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-order-newest-processed')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::ORDER_BY_ITEM_OLDEST_PROCESSED); ?>" <?php echo e($order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_OLDEST_PROCESSED ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-order-oldest-processed')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::ORDER_BY_ITEM_NEWEST_PARSED); ?>" <?php echo e($order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_NEWEST_PARSED ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-order-newest-parsed')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::ORDER_BY_ITEM_OLDEST_PARSED); ?>" <?php echo e($order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_OLDEST_PARSED ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-order-oldest-parsed')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::ORDER_BY_ITEM_TITLE_A_Z); ?>" <?php echo e($order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_TITLE_A_Z ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-order-title-a-z')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::ORDER_BY_ITEM_TITLE_Z_A); ?>" <?php echo e($order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_TITLE_Z_A ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-order-title-z-a')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::ORDER_BY_ITEM_CITY_A_Z); ?>" <?php echo e($order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_CITY_A_Z ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-order-city-a-z')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::ORDER_BY_ITEM_CITY_Z_A); ?>" <?php echo e($order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_CITY_Z_A ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-order-city-z-a')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::ORDER_BY_ITEM_STATE_A_Z); ?>" <?php echo e($order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_STATE_A_Z ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-order-state-a-z')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::ORDER_BY_ITEM_STATE_Z_A); ?>" <?php echo e($order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_STATE_Z_A ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-order-state-z-a')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::ORDER_BY_ITEM_COUNTRY_A_Z); ?>" <?php echo e($order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_COUNTRY_A_Z ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-order-country-a-z')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::ORDER_BY_ITEM_COUNTRY_Z_A); ?>" <?php echo e($order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_COUNTRY_Z_A ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-order-country-z-a')); ?></option>
                                </select>
                            </div>

                            <div class="col-12 col-md-4">
                                <select class="custom-select" name="count_per_page">
                                    <option value="<?php echo e(\App\Models\ImportItemData::COUNT_PER_PAGE_10); ?>" <?php echo e($count_per_page == \App\Models\ImportItemData::COUNT_PER_PAGE_10 ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-per-page-10')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::COUNT_PER_PAGE_25); ?>" <?php echo e($count_per_page == \App\Models\ImportItemData::COUNT_PER_PAGE_25 ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-per-page-25')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::COUNT_PER_PAGE_50); ?>" <?php echo e($count_per_page == \App\Models\ImportItemData::COUNT_PER_PAGE_50 ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-per-page-50')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::COUNT_PER_PAGE_100); ?>" <?php echo e($count_per_page == \App\Models\ImportItemData::COUNT_PER_PAGE_100 ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-per-page-100')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::COUNT_PER_PAGE_250); ?>" <?php echo e($count_per_page == \App\Models\ImportItemData::COUNT_PER_PAGE_250 ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-per-page-250')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::COUNT_PER_PAGE_500); ?>" <?php echo e($count_per_page == \App\Models\ImportItemData::COUNT_PER_PAGE_500 ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-per-page-500')); ?></option>
                                    <option value="<?php echo e(\App\Models\ImportItemData::COUNT_PER_PAGE_1000); ?>" <?php echo e($count_per_page == \App\Models\ImportItemData::COUNT_PER_PAGE_1000 ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-per-page-1000')); ?></option>
                                </select>
                            </div>
...
unset($__errorArgs, $__bag); ?>" name="user_id">
                                        ...
                                        <option value="<?php echo e(\App\Models\ImportItemData::IMPORT_RANDOM_USER); ?>"><?php echo e(__('theme_alaadin.importer.random-user')); ?></option>
...
unset($__errorArgs, $__bag); ?>" name="item_type">
                                        ...
                                        <option value="<?php echo e(\App\Models\Item::ITEM_TYPE_REGULAR); ?>"><?php echo e(__('theme_alaadin.online-listing.regular-listing')); ?></option>
                                        <option value="<?php echo e(\App\Models\Item::ITEM_TYPE_ONLINE); ?>"><?php echo e(__('theme_alaadin.online-listing.online-listing')); ?></option>
...
unset($__errorArgs, $__bag); ?>" name="item_status">
                                        <option value="<?php echo e(\App\Models\Item::ITEM_SUBMITTED); ?>"><?php echo e(__('backend.item.submitted')); ?></option>
                                        <option value="<?php echo e(\App\Models\Item::ITEM_PUBLISHED); ?>"><?php echo e(__('backend.item.published')); ?></option>
                                        <option value="<?php echo e(\App\Models\Item::ITEM_SUSPENDED); ?>"><?php echo e(__('backend.item.suspended')); ?></option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" name="item_featured">
                                        <option value="<?php echo e(\App\Models\Item::ITEM_NOT_FEATURED); ?>"><?php echo e(__('backend.shared.no')); ?></option>
                                        <option value="<?php echo e(\App\Models\Item::ITEM_FEATURED); ?>"><?php echo e(__('backend.shared.yes')); ?></option>
                                    </select>
                    ...
                    setTimeout(function() {
                        ...
                        jQuery.ajax({
                            ...
                            success: function(result){
                                ...
                                if(result.status == <?php echo e(\App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS); ?>)
                                {
                                    success_import_listing_count += 1;
                                }
                                if(result.status == <?php echo e(\App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_ERROR); ?>)
                                {
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hassan/Downloads/refactore aladdin/resources/views/backend/admin/importer/item/index.blade.php ENDPATH**/ ?>