...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.orders.index')); ?>">
            <i class="fas fa-th-large"></i>
            <span><?php echo e(__('backend.sidebar.all-orders')); ?></span>
            <?php if(Auth::user()->order_notify > 0): ?>
            <span class="badge badge-danger"><?php echo e(Auth::user()->order_notify); ?></span>
            <?php endif; ?>
        </a>
    </li>
<!--    <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <div id="collapse_review" class="collapse" aria-labelledby="collapse_review" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo e(route('admin.blogs.reviews.index')); ?>"><?php echo e(__('review.backend.sidebar.all-blogs')); ?></a>
    ...
    <li class="nav-item">
        ...
        <div id="collapse_section" class="collapse" aria-labelledby="collapse_section" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo e(route('admin.business.index')); ?>"><?php echo e(__('backend.sidebar.business')); ?></a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapse_page" class="collapse" aria-labelledby="collapse_page" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo e(route('admin.settings.page.slider.edit')); ?>"><?php echo e(__('backend.sidebar.slides')); ?></a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.activities.index')); ?>">
            <i class="fas fa-history"></i>
            <span><?php echo e(__('backend.sidebar.activities')); ?></span>
        </a>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapse_lang" class="collapse" aria-labelledby="collapse_lang" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(route('admin.lang.index')); ?>" target="_blank"><?php echo e(__('trans.edit-lang')); ?></a>
...
<!--    <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <div id="collapse_subscription" class="collapse" aria-labelledby="collapse_subscription" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(route('admin.features.index')); ?>"><?php echo e(__('backend.sidebar.feature')); ?></a>
...
<!-- End of Sidebar -->
<?php /**PATH /home/hassan/Downloads/refactore aladdin/resources/views/backend/admin/partials/sidebar.blade.php ENDPATH**/ ?>