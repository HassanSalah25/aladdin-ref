                                            ...
                                            <td>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        ...
                                                        <?php if($item->item_featured == \App\Models\Item::ITEM_FEATURED): ?>
                                                        ...
                                                        <?php endif; ?>
                                                            ...
                                                            <?php else: ?>
                                                                <span class="bg-primary text-white pl-1 pr-1 rounded"><?php echo e(__('theme_alaadin.online-listing.online-listing')); ?></span>
                                                            <?php endif; ?>
                                                            ...
                                                            <div class="row align-items-center">
                                                                ...
                                                                <?php else: ?>
                                                                    <div class="col-3 col-sm-2 col-md-3 col-lg-2 col-xl-1">
                                                                        <img id="image_preview" src="<?php echo e(asset('backend/images/placeholder/profile-' . intval(1 % 10) . '.webp')); ?>" class="img-fluid rounded-circle">
                                                                    </div>
                                                                    <div class="col-9 col-sm-10 col-md-9 col-lg-10 col-xl-11">
                                                                    <span>
                                                                        None
                                                            ...
                                                            <div class="pt-2">
                                                                <span class="border border-info text-info pl-1 pr-1 rounded"><?php echo e($item->category->category_name); ?></span>
                                                            </div>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-check">
                                            <input <?php echo e(in_array(\App\Models\Item::ITEM_SUBMITTED, $filter_item_status) ? 'checked' : ''); ?> name="filter_item_status[]" class="form-check-input" type="checkbox" value="<?php echo e(\App\Models\Item::ITEM_SUBMITTED); ?>" id="filter_item_status_<?php echo e(\App\Models\Item::ITEM_SUBMITTED); ?>">
                                            <label class="form-check-label" for="filter_item_status_<?php echo e(\App\Models\Item::ITEM_SUBMITTED); ?>">
                                        ...
                                        <div class="form-check">
                                            <input <?php echo e(in_array(\App\Models\Item::ITEM_PUBLISHED, $filter_item_status) ? 'checked' : ''); ?> name="filter_item_status[]" class="form-check-input" type="checkbox" value="<?php echo e(\App\Models\Item::ITEM_PUBLISHED); ?>" id="filter_item_status_<?php echo e(\App\Models\Item::ITEM_PUBLISHED); ?>">
                                            <label class="form-check-label" for="filter_item_status_<?php echo e(\App\Models\Item::ITEM_PUBLISHED); ?>">
                                        ...
                                        <div class="form-check">
                                            <input <?php echo e(in_array(\App\Models\Item::ITEM_SUSPENDED, $filter_item_status) ? 'checked' : ''); ?> name="filter_item_status[]" class="form-check-input" type="checkbox" value="<?php echo e(\App\Models\Item::ITEM_SUSPENDED); ?>" id="filter_item_status_<?php echo e(\App\Models\Item::ITEM_SUSPENDED); ?>">
                                            <label class="form-check-label" for="filter_item_status_<?php echo e(\App\Models\Item::ITEM_SUSPENDED); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-check">
                                            <input <?php echo e(in_array(\App\Models\Item::ITEM_FEATURED, $filter_item_featured) ? 'checked' : ''); ?> name="filter_item_featured[]" class="form-check-input" type="checkbox" value="<?php echo e(\App\Models\Item::ITEM_FEATURED); ?>" id="filter_item_featured_<?php echo e(\App\Models\Item::ITEM_FEATURED); ?>">
                                            <label class="form-check-label" for="filter_item_featured_<?php echo e(\App\Models\Item::ITEM_FEATURED); ?>">
                                                <?php echo e(__('prefer_country.featured')); ?>

                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input <?php echo e(in_array(\App\Models\Item::ITEM_NOT_FEATURED, $filter_item_featured) ? 'checked' : ''); ?> name="filter_item_featured[]" class="form-check-input" type="checkbox" value="<?php echo e(\App\Models\Item::ITEM_NOT_FEATURED); ?>" id="filter_item_featured_<?php echo e(\App\Models\Item::ITEM_NOT_FEATURED); ?>">
                                            <label class="form-check-label" for="filter_item_featured_<?php echo e(\App\Models\Item::ITEM_NOT_FEATURED); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-check">
                                            <input <?php echo e(in_array(\App\Models\Item::ITEM_TYPE_REGULAR, $filter_item_type) ? 'checked' : ''); ?> name="filter_item_type[]" class="form-check-input" type="checkbox" value="<?php echo e(\App\Models\Item::ITEM_TYPE_REGULAR); ?>" id="filter_item_type_<?php echo e(\App\Models\Item::ITEM_TYPE_REGULAR); ?>">
                                            <label class="form-check-label" for="filter_item_type_<?php echo e(\App\Models\Item::ITEM_TYPE_REGULAR); ?>">
                                                <?php echo e(__('theme_alaadin.online-listing.regular-listing')); ?>

                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input <?php echo e(in_array(\App\Models\Item::ITEM_TYPE_ONLINE, $filter_item_type) ? 'checked' : ''); ?> name="filter_item_type[]" class="form-check-input" type="checkbox" value="<?php echo e(\App\Models\Item::ITEM_TYPE_ONLINE); ?>" id="filter_item_type_<?php echo e(\App\Models\Item::ITEM_TYPE_ONLINE); ?>">
                                            <label class="form-check-label" for="filter_item_type_<?php echo e(\App\Models\Item::ITEM_TYPE_ONLINE); ?>">
...
unset($__errorArgs, $__bag); ?>" name="filter_sort_by" id="filter_sort_by">
                                            <option value="<?php echo e(\App\Models\Item::ITEMS_SORT_BY_NEWEST_CREATED); ?>" <?php echo e($filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_NEWEST_CREATED ? 'selected' : ''); ?>><?php echo e(__('prefer_country.item-sort-by-newest-created')); ?></option>
                                            <option value="<?php echo e(\App\Models\Item::ITEMS_SORT_BY_OLDEST_CREATED); ?>" <?php echo e($filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_OLDEST_CREATED ? 'selected' : ''); ?>><?php echo e(__('prefer_country.item-sort-by-oldest-created')); ?></option>

                                            <option value="<?php echo e(\App\Models\Item::ITEMS_SORT_BY_NEWEST_UPDATED); ?>" <?php echo e($filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_NEWEST_UPDATED ? 'selected' : ''); ?>><?php echo e(__('prefer_country.item-sort-by-newest-updated')); ?></option>
                                            <option value="<?php echo e(\App\Models\Item::ITEMS_SORT_BY_OLDEST_UPDATED); ?>" <?php echo e($filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_OLDEST_UPDATED ? 'selected' : ''); ?>><?php echo e(__('prefer_country.item-sort-by-oldest-updated')); ?></option>

                                            <option value="<?php echo e(\App\Models\Item::ITEMS_SORT_BY_HIGHEST_RATING); ?>" <?php echo e($filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_HIGHEST_RATING ? 'selected' : ''); ?>><?php echo e(__('listings_filter.sort-by-highest')); ?></option>
                                            <option value="<?php echo e(\App\Models\Item::ITEMS_SORT_BY_LOWEST_RATING); ?>" <?php echo e($filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_LOWEST_RATING ? 'selected' : ''); ?>><?php echo e(__('listings_filter.sort-by-lowest')); ?></option>

                                            <option value="<?php echo e(\App\Models\Item::ITEMS_SORT_BY_MOST_RELEVANT); ?>" <?php echo e($filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_MOST_RELEVANT ? 'selected' : ''); ?>><?php echo e(__('item_search.most-relevant')); ?></option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>" name="filter_count_per_page" id="filter_count_per_page">
                                            <option value="<?php echo e(\App\Models\Item::COUNT_PER_PAGE_10); ?>" <?php echo e($filter_count_per_page == \App\Models\Item::COUNT_PER_PAGE_10 ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-per-page-10')); ?></option>
                                            <option value="<?php echo e(\App\Models\Item::COUNT_PER_PAGE_25); ?>" <?php echo e($filter_count_per_page == \App\Models\Item::COUNT_PER_PAGE_25 ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-per-page-25')); ?></option>
                                            <option value="<?php echo e(\App\Models\Item::COUNT_PER_PAGE_50); ?>" <?php echo e($filter_count_per_page == \App\Models\Item::COUNT_PER_PAGE_50 ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-per-page-50')); ?></option>
                                            <option value="<?php echo e(\App\Models\Item::COUNT_PER_PAGE_100); ?>" <?php echo e($filter_count_per_page == \App\Models\Item::COUNT_PER_PAGE_100 ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-per-page-100')); ?></option>
                                            <option value="<?php echo e(\App\Models\Item::COUNT_PER_PAGE_250); ?>" <?php echo e($filter_count_per_page == \App\Models\Item::COUNT_PER_PAGE_250 ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-per-page-250')); ?></option>
                                            <option value="<?php echo e(\App\Models\Item::COUNT_PER_PAGE_500); ?>" <?php echo e($filter_count_per_page == \App\Models\Item::COUNT_PER_PAGE_500 ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-per-page-500')); ?></option>
                                            <option value="<?php echo e(\App\Models\Item::COUNT_PER_PAGE_1000); ?>" <?php echo e($filter_count_per_page == \App\Models\Item::COUNT_PER_PAGE_1000 ? 'selected' : ''); ?>><?php echo e(__('importer_csv.import-listing-per-page-1000')); ?></option>
                                        </select>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hassan/Downloads/refactore aladdin/resources/views/backend/admin/item/index.blade.php ENDPATH**/ ?>