        ...
        <div class="col-12">
            ...
            <div class="row border-left-info mb-4 pt-3 pb-3">
                <div class="col-12">
                    <div class="row mb-3">
                        <div class="col-12">
                            <span class="text-lg text-gray-800"><?php echo e(__('role_permission.item.listing-owner')); ?></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="form-row">
                                    <div class="col-6 col-sm-8 col-md-9 col-lg-10">
                                        <select id="user_id"
                                                ...
                                                class="selectpicker form-control <?php $__errorArgs = ['user_id'];
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <option
                                                value="<?php echo e($login_user->id); ?>" <?php echo e(old('user_id') == $login_user->id ? 'selected' : ''); ?>><?php echo e(__('role_permission.item.myself') . ' (' . $login_user->email . ')'); ?></option>
                                            <?php $__currentLoopData = $other_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $other_users_key => $other_user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                                    value="<?php echo e($other_user->id); ?>" <?php echo e(old('user_id') == $other_user->id ? 'selected' : ''); ?>

                                                    <?php echo e($other_user->id == request('user_id') ? 'selected' : ''); ?>

                                                ><?php echo e($other_user->name . ' (' . $other_user->email . ')'); ?></option>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                        <button type="submit"
                                                class="btn btn-primary"><?php echo e(__('backend.item.load-form')); ?></button>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?>"
                                                           name="item_title" value="<?php echo e(old('item_title')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <?php if($plan->check_plan(21)): ?>
                                                <div class="col-md-6">
                                                    <label for="user_id"
                                                           class="text-black"><?php echo e(__('backend.item.select-category')); ?></label>
                                                    <select size="<?php echo e(count($all_categories)); ?>"
                                                            class="selectpicker form-control <?php $__errorArgs = ['category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        <?php $__currentLoopData = $all_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option
                                                                value="<?php echo e($category['id']); ?>" <?php echo e(in_array($category['category_id'], empty($category_ids) ? array() : $category_ids) ? 'selected' : ''); ?>><?php echo e($category['category_name']); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    <option
                                                        value="<?php echo e(\App\Models\Item::ITEM_SUBMITTED); ?>"><?php echo e(__('backend.item.submitted')); ?></option>
                                                    <option value="<?php echo e(\App\Models\Item::ITEM_PUBLISHED); ?>"
                                                            selected><?php echo e(__('backend.item.published')); ?></option>
                                                    <option
                                                        value="<?php echo e(\App\Models\Item::ITEM_SUSPENDED); ?>"><?php echo e(__('backend.item.suspended')); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        <option value="<?php echo e(\App\Models\Item::ITEM_NOT_FEATURED); ?>"
                                                                selected><?php echo e(__('backend.shared.no')); ?></option>
                                                        <option
                                                            value="<?php echo e(\App\Models\Item::ITEM_FEATURED); ?>"><?php echo e(__('backend.shared.yes')); ?></option>
...
unset($__errorArgs, $__bag); ?>"
                                                           name="item_address" value="<?php echo e(old('item_address')); ?>">
                                        ...
                                        <div class="form-row mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-check form-check-inline">
                                                    <input
                                                        <?php echo e(old('item_address_hide') == 1 ? 'checked' : ''); ?> class="form-check-input"
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    <option selected
                                                            value=""><?php echo e(__('prefer_country.select-country')); ?></option>
                                                    <?php $__currentLoopData = $all_countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $all_countries_key => $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($country->country_status == \App\Models\Country::COUNTRY_STATUS_ENABLE): ?>
                                                            <option
                                                                value="<?php echo e($country->id); ?>" <?php echo e($country->id == old('country_id') ? 'selected' : ''); ?>><?php echo e($country->country_name); ?></option>
                                                        <?php endif; ?>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    <option selected
                                                            value=""><?php echo e(__('backend.item.select-state')); ?></option>
                                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    <option selected
                                                            value=""><?php echo e(__('backend.item.select-city')); ?></option>
                                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                                       name="item_postal_code" value="<?php echo e(old('item_postal_code')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-row mb-3">
                                            ...
                                            <div class="col-md-3">
                                                <label for="item_lat"
                                                       class="text-black"><?php echo e(__('backend.item.lat')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                                                       name="item_lat" value="<?php echo e(old('item_lat')); ?>"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-3">
                                                <label for="item_lng"
                                                       class="text-black"><?php echo e(__('backend.item.lng')); ?></label>
...
unset($__errorArgs, $__bag); ?>"
                                                       name="item_lng" value="<?php echo e(old('item_lng')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                           name="item_youtube_id" value="<?php echo e(old('item_youtube_id')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        name="item_description"><?php echo e(old('item_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                                           name="item_website" value="<?php echo e(old('item_website')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                                           ...
                                                           value="<?php echo e(old('item_social_facebook')); ?>">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
                                                        <?php echo e(__('backend.shared.url-help')); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                           ...
                                                           value="<?php echo e(old('item_social_tiktok')); ?>">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
                                                        <?php echo e(__('backend.shared.url-help')); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                           ...
                                                           value="<?php echo e(old('item_social_pinterest')); ?>">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
                                                        <?php echo e(__('backend.shared.url-help')); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                           ...
                                                           value="<?php echo e(old('item_social_telegram')); ?>">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
...
unset($__errorArgs, $__bag); ?>"
                                                           ...
                                                           value="<?php echo e(old('item_social_youtube')); ?>">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
                                                        <?php echo e(__('backend.shared.url-help')); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                           name="item_social_facebook"
                                                           value="<?php echo e(old('item_social_snapchat')); ?>">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
                                                        <?php echo e(__('backend.shared.url-help')); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                           ...
                                                           value="<?php echo e(old('item_social_twitter')); ?>">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
                                                        <?php echo e(__('backend.shared.url-help')); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                           ...
                                                           value="<?php echo e(old('item_social_linkedin')); ?>">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
                                                        <?php echo e(__('backend.shared.url-help')); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                           ...
                                                           value="<?php echo e(old('item_social_instagram')); ?>">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
...
unset($__errorArgs, $__bag); ?>"
                                                           ...
                                                           value="<?php echo e(old('item_social_whatsapp')); ?>">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        <?php $__currentLoopData = $time_zone_identifiers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time_zone_identifiers_key => $time_zone_identifier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option
                                                                value="<?php echo e($time_zone_identifier); ?>" <?php echo e(old('item_hour_time_zone') == $time_zone_identifier ? 'selected' : ''); ?>><?php echo e($time_zone_identifier); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                    <small class="form-text text-muted">
...
unset($__errorArgs, $__bag); ?>"
                                                        ...
                                                        <option
                                                            value="<?php echo e(\App\Models\Item::ITEM_HOUR_SHOW); ?>" <?php echo e(old('item_hour_show_hours') == \App\Models\Item::ITEM_HOUR_SHOW ? 'selected' : ''); ?>><?php echo e(__('item_hour.show-hour')); ?></option>
                                                        <option
                                                            value="<?php echo e(\App\Models\Item::ITEM_HOUR_NOT_SHOW); ?>" <?php echo e(old('item_hour_show_hours') == \App\Models\Item::ITEM_HOUR_NOT_SHOW ? 'selected' : ''); ?>><?php echo e(__('item_hour.not-show-hour')); ?></option>
                                                    </select>
                                                    <small class="form-text text-muted">
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-row mb-3">
                                                <div class="col-12">
                                                    <span
                                                        class="text-gray-800"><?php echo e(__('item_hour.open-hour-hours')); ?></span>
                                                    <small class="form-text text-muted">
                                                ...
                                                <div class="col-12 col-md-2">
                                                    ...
                                                    <select id="item_hour_open_time_open_minute"
                                                        ...
                                                        <?php for($full_minute=0; $full_minute<=59; $full_minute++): ?>
                                                            <option
                                                                value="<?php echo e($full_minute); ?>"><?php echo e($full_minute); ?></option>
                                                        <?php endfor; ?>
                                                    </select>
                                                </div>
                                                <div class="col-12 col-md-2">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php else: ?>
                            <div class="constant">
                                <h2 class="h2 text-center"><?php echo e(__('item.no-plans-to-this-user')); ?></h2>
                            </div>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hassan/Downloads/refactore aladdin/resources/views/backend/admin/item/create.blade.php ENDPATH**/ ?>