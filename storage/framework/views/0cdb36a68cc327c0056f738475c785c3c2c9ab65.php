...
<?php $__env->startSection('content'); ?>
    ...
    <section class="categories pt pb mt-header-height">
        <div class="container">
            ...
            <form action="<?php echo e(route('page.categories')); ?>" class="row justify-content-center my-5">
                <div class="search">
            ...
            <div class="categories__letters d-flex align-items-center justify-content-center flex-wrap gap-3 mb-md">
                <a  href="<?php echo e(route('page.categories')); ?>">الكل</a>
                <?php $__currentLoopData = $index; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a data-query="<?php echo e($v); ?>" href="<?php echo e(route('page.categories',['search_keyword'=>request('search_keyword'),'char'=>$v])); ?>"><?php echo e($v); ?></a>
                        ...
                        <div class="col d-flex justify-content-center" style="display:table !important">
                            <a
                                ...
                                class="registeration__categories__item" style="display: table-cell; padding: 1.2rem;">
                                    <img src="<?php echo e(asset('storage/category/' . $category->children->first()?->category_image)); ?>"
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hassan/Downloads/refactore aladdin/resources/views/frontend/categories.blade.php ENDPATH**/ ?>