...
class ItemDataEN extends Model
{
    use HasFactory;
    protected $guarded = [];
    protected $table = 'iteems_en';
    ...
    {
        return $this->belongsToMany('App\Models\Category', 'category_item')->withTimestamps();
    }
    ...
    {
        return $this->hasOne('App\Models\ItemDetails', 'item_id');
    }

    public function phones()
    {
        return $this->hasMany('App\Models\ItemPhone', 'item_id');
    }
    ...
    {
        return $this->hasMany('App\Models\ItemLead');
    }
    ...
    {
        return $this->hasMany('App\Models\ItemImageGallery');
    }
    ...
    {
        return $this->hasMany('App\Models\ItemSection');
    }
    ...
    {
        return $this->hasMany('App\Models\ItemClaim');
    }
    ...
    {
        return $this->hasMany('App\Models\ItemFeature')->orderBy('id');
    }
    ...
    {
        return $this->hasMany('App\Models\ThreadItem');
    }

    public function itemHours()
    {
        return $this->hasMany('App\Models\ItemHour');
    }

    public function itemHourExceptions()
    {
        return $this->hasMany('App\Models\ItemHourException');
    }
    ...
    {
        $average_rating_query =Review::selectRaw('ROUND(AVG(rating), 1) as average_rating')
    ...
    public function getApprovedRatingsSortBy(int $sort_by,$id)
    {
