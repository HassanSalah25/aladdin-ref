...
class Setting extends Model
{
    ...
    const SITE_SITEMAP_BLOG_ENABLE = 1;
    const SITE_SITEMAP_BLOG_DISABLE = 0;
    ...
    const SITE_SITEMAP_MAXIMUM_URLS = 10000;
    ...
    {
        return $this->hasOne('App\Models\SettingLicense');
    }

    public function settingItem()
    {
        return $this->hasOne('App\Models\SettingItem');
    }

    public function settingLanguage()
    {
        return $this->hasOne('App\Models\SettingLanguage');
    }
