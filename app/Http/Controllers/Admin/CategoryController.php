...
class CategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         * Start build query
         */
        $categories_query = Category::query()->whereNotNull('locale');
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'category_thumbnail_type' => 'nullable|in:1,2',
        ...
        $category_image_app_name = null;
        if(!empty($category_image))
        {
            $currentDate = Carbon::now()->toDateString();

            $category_image_file_name = $category_slug.'_'.$currentDate.'_'.uniqid().'.jpg';
            $category_image_app_name = $category_slug.'_'.$currentDate.'_'.uniqid().'.jpg';
            ...
            $category_image_obj_app = Image::make(base64_decode(preg_replace('#^data:image/\w+;base64,#i', '',$category_image)))
                ->resize(800, 800);
            $category_image_obj_app = $category_image_obj_app->stream('jpg', 100);
            Storage::disk('public')->put('category/'.$category_image_app_name, $category_image_obj_app);
        ...
        $category->category_image_app = $category_image_app_name;
    ...
    public function update(Request $request, Category $category)
    {
        $request->validate([
            ...
            'category_image' => 'nullable',
            'category_thumbnail_type' => 'nullable|in:1,2',
            'category_header_background_type' => 'nullable|in:1,2,3,4',
            'category_header_background_color' => 'nullable|max:255',
            'category_header_background_image' => 'nullable',
            'category_header_background_youtube_video' => 'nullable|url',
        ]);
        ...
        $category_image_app_name = $category->category_image_app;
        if(!empty($category_image))
        {
            $currentDate = Carbon::now()->toDateString();
            ...
            $category_image_obj = Image::make(base64_decode(preg_replace('#^data:image/\w+;base64,#i', '',$category_image)))
                ->stream('jpg', 100);
            Storage::disk('public')->put('category/'.$category_image_file_name, $category_image_obj);
