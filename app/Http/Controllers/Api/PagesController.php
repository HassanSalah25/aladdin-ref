            ...
            if ($item_user) {
                if ($item_user->hasActive()) {
                    ...
                    return response()->json([
                        ...
                        'reviews' => $reviews,
                        // 'ads_before_breadcrumb' => $ads_before_breadcrumb,
                        // 'ads_before_gallery' => $ads_before_gallery,
                        // 'ads_before_description' => $ads_before_description,
                        // 'ads_before_location' => $ads_before_location,
                        // 'ads_before_features' => $ads_before_features,
                        // 'ads_before_reviews' => $ads_before_reviews,
                        // 'ads_before_comments' => $ads_before_comments,
                        // 'ads_before_share' => $ads_before_share,
                        // 'ads_after_share' => $ads_after_share,
                        // 'ads_before_sidebar_content' => $ads_before_sidebar_content,
                        // 'ads_after_sidebar_content' => $ads_after_sidebar_content,
                        'item_display_categories' => $item_display_categories,
                        'item_total_categories' => $item_total_categories,
                        // 'item_all_categories' => $item_all_categories,
                        'item_count_rating' => $item_count_rating,
                        'item_average_rating' => $item_average_rating,
                        // 'item_one_star_percentage' => $item_one_star_percentage,
                        // 'item_two_star_percentage' => $item_two_star_percentage,
                        // 'item_three_star_percentage' => $item_three_star_percentage,
                        // 'item_four_star_percentage' => $item_four_star_percentage,
                        // 'item_five_star_percentage' => $item_five_star_percentage,
                        'rating_sort_by' => $rating_sort_by,
                        'item_has_claimed' => $item_has_claimed,
                        // 'item_sections_after_breadcrumb' => $item_sections_after_breadcrumb,
                        // 'item_sections_after_gallery' => $item_sections_after_gallery,
                        // 'item_sections_after_description' => $item_sections_after_description,
                        // 'item_sections_after_location_map' => $item_sections_after_location_map,
                        // 'item_sections_after_features' => $item_sections_after_features,
                        // 'item_sections_after_reviews' => $item_sections_after_reviews,
                        // 'item_sections_after_comments' => $item_sections_after_comments,
                        // 'item_sections_after_share' => $item_sections_after_share,
                        'item_features' => $item_features,
                        'opening_hours_obj' => $opening_hours_obj,
                        'datetime_now' => $datetime_now,
                        'current_open_range' => $current_open_range,
                        'item_hours_monday' => $item_hours_monday,
                        'item_hours_tuesday' => $item_hours_tuesday,
                        'item_hours_wednesday' => $item_hours_wednesday,
                        'item_hours_thursday' => $item_hours_thursday,
                        'item_hours_friday' => $item_hours_friday,
                        'item_hours_saturday' => $item_hours_saturday,
                        'item_hours_sunday' => $item_hours_sunday,
                        'item_hour_exceptions_obj' => $item_hour_exceptions_obj,
