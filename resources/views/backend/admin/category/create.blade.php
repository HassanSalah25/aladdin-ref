                                ...
                                <div class="form-row mb-3">
                                    <div class="col-12 col-md-6">
                                        <div class="form-check">
                                            <input {{ old('category_thumbnail_type') == \App\Models\Category::CATEGORY_THUMBNAIL_TYPE_ICON ? 'checked' : '' }} class="form-check-input" type="radio" name="category_thumbnail_type" id="category_thumbnail_type_icon" value="{{ \App\Models\Category::CATEGORY_THUMBNAIL_TYPE_ICON }}" aria-describedby="category_thumbnail_type_icon_HelpBlock">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-check">
                                            <input {{ old('category_thumbnail_type') == \App\Models\Category::CATEGORY_THUMBNAIL_TYPE_IMAGE ? 'checked' : '' }} class="form-check-input" type="radio" name="category_thumbnail_type" id="category_thumbnail_type_image" value="{{ \App\Models\Category::CATEGORY_THUMBNAIL_TYPE_IMAGE }}" aria-describedby="category_thumbnail_type_image_HelpBlock">
                                ...
                                <div class="form-row mb-3">
                                    <div class="col-12">
                                        ...
                                        <select class="custom-select @error('category_header_background_type') is-invalid @enderror" name="category_header_background_type">
                                            <option value="{{ \App\Models\Category::CATEGORY_HEADER_BACKGROUND_TYPE_INHERITED }}" {{ old('category_header_background_type') == \App\Models\Category::CATEGORY_HEADER_BACKGROUND_TYPE_INHERITED ? 'selected' : '' }}>{{ __('category_image_option.form-header-background-inherited') }}</option>
                                            <option value="{{ \App\Models\Category::CATEGORY_HEADER_BACKGROUND_TYPE_COLOR }}" {{ old('category_header_background_type') == \App\Models\Category::CATEGORY_HEADER_BACKGROUND_TYPE_COLOR ? 'selected' : '' }}>{{ __('category_image_option.form-header-background-color') }}</option>
                                            <option value="{{ \App\Models\Category::CATEGORY_HEADER_BACKGROUND_TYPE_IMAGE }}" {{ old('category_header_background_type') == \App\Models\Category::CATEGORY_HEADER_BACKGROUND_TYPE_IMAGE ? 'selected' : '' }}>{{ __('category_image_option.form-header-background-image') }}</option>
                                            <option value="{{ \App\Models\Category::CATEGORY_HEADER_BACKGROUND_TYPE_VIDEO }}" {{ old('category_header_background_type') == \App\Models\Category::CATEGORY_HEADER_BACKGROUND_TYPE_VIDEO ? 'selected' : '' }}>{{ __('category_image_option.form-header-background-video') }}</option>
                                        </select>
                                        <small class="form-text text-muted">
