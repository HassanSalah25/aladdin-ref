                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="custom-select" name="custom_field_type">
                                    <option value="{{ \App\Models\CustomField::TYPE_TEXT }}" {{ (old('custom_field_type') ? old('custom_field_type') : $customField->custom_field_type) == \App\Models\CustomField::TYPE_TEXT ? 'selected' : '' }}>{{ __('backend.custom-field.text') }}</option>
                                    <option value="{{ \App\Models\CustomField::TYPE_SELECT }}" {{ (old('custom_field_type') ? old('custom_field_type') : $customField->custom_field_type) == \App\Models\CustomField::TYPE_SELECT ? 'selected' : '' }}>{{ __('backend.custom-field.select') }}</option>
                                    <option value="{{ \App\Models\CustomField::TYPE_MULTI_SELECT }}" {{ (old('custom_field_type') ? old('custom_field_type') : $customField->custom_field_type) == \App\Models\CustomField::TYPE_MULTI_SELECT ? 'selected' : '' }}>{{ __('backend.custom-field.multi-select') }}</option>
                                    <option value="{{ \App\Models\CustomField::TYPE_LINK }}" {{ (old('custom_field_type') ? old('custom_field_type') : $customField->custom_field_type) == \App\Models\CustomField::TYPE_LINK ? 'selected' : '' }}>{{ __('backend.custom-field.link') }}</option>
                                </select>
