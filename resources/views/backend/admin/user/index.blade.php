                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-2">
                                <select class="custom-select" name="user_email_verified">
                                    <option value="{{ \App\Models\User::USER_EMAIL_VERIFIED }}" {{ $user_email_verified == \App\Models\User::USER_EMAIL_VERIFIED ? 'selected' : '' }}>{{ __('admin_users_table.email-verified') }}</option>
                                    <option value="{{ \App\Models\User::USER_EMAIL_NOT_VERIFIED }}" {{ $user_email_verified == \App\Models\User::USER_EMAIL_NOT_VERIFIED ? 'selected' : '' }}>{{ __('admin_users_table.email-un-verified') }}</option>
                                </select>
                            </div>

                            <div class="col-12 col-md-2">
                                <select class="custom-select" name="user_suspended">
                                    <option value="{{ \App\Models\User::USER_NOT_SUSPENDED }}" {{ $user_suspended == \App\Models\User::USER_NOT_SUSPENDED ? 'selected' : '' }}>{{ __('admin_users_table.status-active') }}</option>
                                    <option value="{{ \App\Models\User::USER_SUSPENDED }}" {{ $user_suspended == \App\Models\User::USER_SUSPENDED ? 'selected' : '' }}>{{ __('admin_users_table.status-suspend') }}</option>
                                </select>
                            </div>

                            <div class="col-12 col-md-2">
                                <select class="custom-select" name="order_by">
                                    <option value="{{ \App\Models\User::ORDER_BY_USER_NEWEST }}" {{ $order_by == \App\Models\User::ORDER_BY_USER_NEWEST ? 'selected' : '' }}>{{ __('admin_users_table.user-order-by-newest') }}</option>
                                    <option value="{{ \App\Models\User::ORDER_BY_USER_OLDEST }}" {{ $order_by == \App\Models\User::ORDER_BY_USER_OLDEST ? 'selected' : '' }}>{{ __('admin_users_table.user-order-by-oldest') }}</option>
                                    <option value="{{ \App\Models\User::ORDER_BY_USER_NAME_A_Z }}" {{ $order_by == \App\Models\User::ORDER_BY_USER_NAME_A_Z ? 'selected' : '' }}>{{ __('admin_users_table.user-order-by-name-a-z') }}</option>
                                    <option value="{{ \App\Models\User::ORDER_BY_USER_NAME_Z_A }}" {{ $order_by == \App\Models\User::ORDER_BY_USER_NAME_Z_A ? 'selected' : '' }}>{{ __('admin_users_table.user-order-by-name-z-a') }}</option>
                                    <option value="{{ \App\Models\User::ORDER_BY_USER_EMAIL_A_Z }}" {{ $order_by == \App\Models\User::ORDER_BY_USER_EMAIL_A_Z ? 'selected' : '' }}>{{ __('admin_users_table.user-order-by-email-a-z') }}</option>
                                    <option value="{{ \App\Models\User::ORDER_BY_USER_EMAIL_Z_A }}" {{ $order_by == \App\Models\User::ORDER_BY_USER_EMAIL_Z_A ? 'selected' : '' }}>{{ __('admin_users_table.user-order-by-email-z-a') }}</option>
                                </select>
                            </div>

                            <div class="col-12 col-md-2">
                                <select class="custom-select" name="count_per_page">
                                    <option value="{{ \App\Models\User::COUNT_PER_PAGE_10 }}" {{ $count_per_page == \App\Models\User::COUNT_PER_PAGE_10 ? 'selected' : '' }}>{{ __('admin_users_table.shared.count-per-page-10') }}</option>
                                    <option value="{{ \App\Models\User::COUNT_PER_PAGE_25 }}" {{ $count_per_page == \App\Models\User::COUNT_PER_PAGE_25 ? 'selected' : '' }}>{{ __('admin_users_table.shared.count-per-page-25') }}</option>
                                    <option value="{{ \App\Models\User::COUNT_PER_PAGE_50 }}" {{ $count_per_page == \App\Models\User::COUNT_PER_PAGE_50 ? 'selected' : '' }}>{{ __('admin_users_table.shared.count-per-page-50') }}</option>
                                    <option value="{{ \App\Models\User::COUNT_PER_PAGE_100 }}" {{ $count_per_page == \App\Models\User::COUNT_PER_PAGE_100 ? 'selected' : '' }}>{{ __('admin_users_table.shared.count-per-page-100') }}</option>
                                    <option value="{{ \App\Models\User::COUNT_PER_PAGE_250 }}" {{ $count_per_page == \App\Models\User::COUNT_PER_PAGE_250 ? 'selected' : '' }}>{{ __('admin_users_table.shared.count-per-page-250') }}</option>
                                    <option value="{{ \App\Models\User::COUNT_PER_PAGE_500 }}" {{ $count_per_page == \App\Models\User::COUNT_PER_PAGE_500 ? 'selected' : '' }}>{{ __('admin_users_table.shared.count-per-page-500') }}</option>
                                    <option value="{{ \App\Models\User::COUNT_PER_PAGE_1000 }}" {{ $count_per_page == \App\Models\User::COUNT_PER_PAGE_1000 ? 'selected' : '' }}>{{ __('admin_users_table.shared.count-per-page-1000') }}</option>
                                </select>
                            </div>
                        ...
                        <table class="table table-bordered mb-0" id="dataTable" width="100%" cellspacing="0">
                            ...
                            @foreach($all_users as $key => $user)
                                <tr>
                                    ...
                                    <td>
                                        @if($user->user_suspended == \App\Models\User::USER_SUSPENDED)
