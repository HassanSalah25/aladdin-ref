...
@section('content')
    <div class="row justify-content-between">
        <div class="col-9">
            <h1 class="h3 mb-2 text-gray-800">{{ __('backend.blog.edit-blog') }}</h1>
            <p class="mb-4">{{ __('backend.blog.edit-blog-desc') }}</p>
        </div>
                ...
                <div class="row my-3 vertical-image">
                    ...
                    <div class="col-md-6">
                        <img id="image_preview"
                             src="{{ old('image1') ? old('image1') : (!empty($blog->image) ? \Illuminate\Support\Facades\Storage::disk('public')->url('blog/'. $blog->image) : asset('backend/images/placeholder/full_item_feature_image.webp')) }}"
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <fieldset name="en">
                            ...
                            <div class="form-group col-md-12 m-3">
                                ...
                                <textarea class="form-control" name="content[en]">{{$blog->getTranslation('content','en')}}</textarea>
                            </div>
                            <div class="row">
                                <div class="mb-3 mt-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="canonical[en]"
                                               value="{{$blog->getTranslation('canonical','en')}}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="slug[en]" id="slug"
                                               value="{{$blog->getTranslation('blog_slug','en')}}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label for="meta_title" class="form-label">meta title</label>
                                        <input type="text" class="form-control" name="meta_title[en]"
                                               value="{{$blog->getTranslation('meta_title','en')}}"
                                               id="meta_title">
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="meta_description" class="form-label">meta description</label>
                                        <input type="text" class="form-control" name="meta_description[en]"
                                               value="{{$blog->getTranslation('meta_description','en')}}"
                                               id="meta_description">
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <fieldset name="ar">
                            ...
                            <div class="form-group col-md-12 m-3">
                                <label>{{__('blog.blog-content')}}</label>
                                <textarea class="form-control" name="content[ar]">{{$blog->getTranslation('content','ar')}}</textarea>
                            </div>
                            <div class="row">
                                <div class="mb-3 mt-3">
                                    <h2 for="content_ar" class="form-label">SEO Information</h2>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="canonical[ar]"
                                               value="{{$blog->getTranslation('canonical','ar')}}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="slug[ar]" id="slug"
                                               value="{{$blog->getTranslation('blog_slug','ar')}}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="meta_title[ar]" id="meta_title"
                                               value="{{$blog->getTranslation('meta_title','ar')}}">
                                    </div>
                                    <div class="mb-3 col-md-6">
                                        <label for="meta_description" class="form-label">meta description</label>
                                        <input type="text" class="form-control" name="meta_description[ar]"
                                               value="{{$blog->getTranslation('meta_description','ar')}}"
                                               id="meta_description">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="alt_image[ar]" id="alt_image"
                                               value="{{$blog->getTranslation('alt_image','ar')}}">
                                    </div>
                                </div>
                            </div>
                        </fieldset>
