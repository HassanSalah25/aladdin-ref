                ...
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">{{ __('القوائم المكررة') }}</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ number_format($duplicates) }}</div>
                            </div>
                            <div class="col-auto">
