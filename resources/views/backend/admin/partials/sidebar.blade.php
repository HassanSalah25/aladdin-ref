...
{{--    <li class="nav-item">--}}
{{--        <a class="nav-link collapsed" href="{{ route('admin.categories.index') }}" data-toggle="collapse" data-target="#collapse_category" aria-expanded="true" aria-controls="collapse_category">--}}
...
{{--                <a class="collapse-item" href="{{ route('admin.item-leads.index') }}">{{ __('role_permission.item-leads.item-leads') }}</a>--}}
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('admin.orders.index') }}">
            <i class="fas fa-th-large"></i>
            <span>{{ __('backend.sidebar.all-orders') }}</span>
            @if(Auth::user()->order_notify > 0)
            <span class="badge badge-danger">{{Auth::user()->order_notify}}</span>
            @endif
        </a>
    </li>
<!--    <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <div id="collapse_review" class="collapse" aria-labelledby="collapse_review" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('admin.blogs.reviews.index') }}">{{ __('review.backend.sidebar.all-blogs') }}</a>
...
{{--                <a class="collapse-item" href="{{ route('admin.testimonials.index') }}">{{ __('backend.sidebar.testimonial') }}</a>--}}
                <a class="collapse-item" href="{{ route('admin.business.index') }}">{{ __('backend.sidebar.business') }}</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapse_page" class="collapse" aria-labelledby="collapse_page" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('admin.settings.page.slider.edit') }}">{{ __('backend.sidebar.slides') }}</a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('admin.activities.index') }}">
            ...
            <span>{{ __('backend.sidebar.activities') }}</span>
        </a>
    </li>
 ...
 {{--   <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <div id="collapse_lang" class="collapse" aria-labelledby="collapse_lang" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('admin.lang.index') }}" target="_blank">{{ __('trans.edit-lang') }}</a>
...
<!--    <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <div id="collapse_subscription" class="collapse" aria-labelledby="collapse_subscription" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('admin.features.index') }}">{{ __('backend.sidebar.feature') }}</a>
