                ...
                <div class="col-12">
                    <form method="POST" action="{{ route('admin.settings.payment.paypal.update') }}" class="">
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                @if($all_paypal_settings->setting_site_paypal_enable == \App\Models\Setting::SITE_PAYMENT_PAYPAL_ENABLE)
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input value="{{ \App\Models\Setting::SITE_PAYMENT_PAYPAL_ENABLE }}" name="setting_site_paypal_enable" type="checkbox" class="custom-control-input" id="setting_site_paypal_enable" {{ (old('setting_site_paypal_enable') ? old('setting_site_paypal_enable') : $all_paypal_settings->setting_site_paypal_enable) == \App\Models\Setting::SITE_PAYMENT_PAYPAL_ENABLE ? 'checked' : '' }}>
                        ...
                        <div class="row form-group">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <select class="custom-select @error('setting_site_paypal_mode') is-invalid @enderror" name="setting_site_paypal_mode">
                                    <option value="{{ \App\Models\Setting::SITE_PAYMENT_PAYPAL_SANDBOX }}" {{ (old('setting_site_paypal_mode') ? old('setting_site_paypal_mode') : $all_paypal_settings->setting_site_paypal_mode) == \App\Models\Setting::SITE_PAYMENT_PAYPAL_SANDBOX ? 'selected' : '' }}>{{ __('paypal.paypal-sandbox') }}</option>
                                    <option value="{{ \App\Models\Setting::SITE_PAYMENT_PAYPAL_LIVE }}" {{ (old('setting_site_paypal_mode') ? old('setting_site_paypal_mode') : $all_paypal_settings->setting_site_paypal_mode) == \App\Models\Setting::SITE_PAYMENT_PAYPAL_LIVE ? 'selected' : '' }}>{{ __('paypal.paypal-live') }}</option>
                                </select>
