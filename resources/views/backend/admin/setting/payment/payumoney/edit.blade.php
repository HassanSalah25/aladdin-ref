                ...
                <div class="col-12">
                    <form method="POST" action="{{ route('admin.settings.payment.payumoney.update') }}" class="">
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                @if($site_global_settings->setting_site_payumoney_enable == \App\Models\Setting::SITE_PAYMENT_PAYUMONEY_ENABLE)
                        ...
                        <div class="row form-group">
                            <div class="col-md-4 col-sm-12">
                                ...
                                <select class="custom-select @error('setting_site_payumoney_mode') is-invalid @enderror" name="setting_site_payumoney_mode">
                                    <option value="{{ \App\Models\Setting::SITE_PAYMENT_PAYUMONEY_MODE_LIVE }}" {{ (old('setting_site_payumoney_mode') ? old('setting_site_payumoney_mode') : $site_global_settings->setting_site_payumoney_mode) == \App\Models\Setting::SITE_PAYMENT_PAYUMONEY_MODE_LIVE ? 'selected' : '' }}>{{ __('payumoney.live') }}</option>
                                    <option value="{{ \App\Models\Setting::SITE_PAYMENT_PAYUMONEY_MODE_TEST }}" {{ (old('setting_site_payumoney_mode') ? old('setting_site_payumoney_mode') : $site_global_settings->setting_site_payumoney_mode) == \App\Models\Setting::SITE_PAYMENT_PAYUMONEY_MODE_TEST ? 'selected' : '' }}>{{ __('payumoney.test') }}</option>
                                </select>
