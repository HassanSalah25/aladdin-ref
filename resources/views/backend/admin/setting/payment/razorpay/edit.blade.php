                ...
                <div class="col-12">
                    <form method="POST" action="{{ route('admin.settings.payment.razorpay.update') }}" class="">
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                @if($all_razorpay_settings->setting_site_razorpay_enable == \App\Models\Setting::SITE_PAYMENT_RAZORPAY_ENABLE)
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input value="{{ \App\Models\Setting::SITE_PAYMENT_RAZORPAY_ENABLE }}" name="setting_site_razorpay_enable" type="checkbox" class="custom-control-input" id="setting_site_razorpay_enable" {{ (old('setting_site_razorpay_enable') ? old('setting_site_razorpay_enable') : $all_razorpay_settings->setting_site_razorpay_enable) == \App\Models\Setting::SITE_PAYMENT_RAZORPAY_ENABLE ? 'checked' : '' }}>
