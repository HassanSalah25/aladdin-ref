                ...
                <div class="col-12">
                    <form method="POST" action="{{ route('admin.settings.payment.stripe.update') }}" class="">
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                @if($all_stripe_settings->setting_site_stripe_enable == \App\Models\Setting::SITE_PAYMENT_STRIPE_ENABLE)
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input value="{{ \App\Models\Setting::SITE_PAYMENT_STRIPE_ENABLE }}" name="setting_site_stripe_enable" type="checkbox" class="custom-control-input" id="setting_site_stripe_enable" {{ (old('setting_site_stripe_enable') ? old('setting_site_stripe_enable') : $all_stripe_settings->setting_site_stripe_enable) == \App\Models\Setting::SITE_PAYMENT_STRIPE_ENABLE ? 'checked' : '' }}>
