                ...
                <div class="col-mb-12 col-lg-6">
                    <form method="POST" action="{{ route('admin.settings.payment.bank-transfer.update', ['setting_bank_transfer' => $setting_bank_transfer->id]) }}">
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                @if($setting_bank_transfer->setting_bank_transfer_status == \App\Models\Setting::SITE_PAYMENT_BANK_TRANSFER_ENABLE)
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="custom-select @error('setting_bank_transfer_status') is-invalid @enderror" name="setting_bank_transfer_status">
                                    <option value="{{ \App\Models\Setting::SITE_PAYMENT_BANK_TRANSFER_ENABLE }}" {{ (old('setting_bank_transfer_status') ? old('setting_bank_transfer_status') : $setting_bank_transfer->setting_bank_transfer_status) == \App\Models\Setting::SITE_PAYMENT_BANK_TRANSFER_ENABLE ? 'selected' : '' }}>{{ __('bank_transfer.enable') }}</option>
                                    <option value="{{ \App\Models\Setting::SITE_PAYMENT_BANK_TRANSFER_DISABLE }}" {{ (old('setting_bank_transfer_status') ? old('setting_bank_transfer_status') : $setting_bank_transfer->setting_bank_transfer_status) == \App\Models\Setting::SITE_PAYMENT_BANK_TRANSFER_DISABLE ? 'selected' : '' }}>{{ __('bank_transfer.disable') }}</option>
                                </select>
