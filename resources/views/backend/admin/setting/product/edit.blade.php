                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <select id="setting_product_auto_approval_enable" class="custom-select" name="setting_product_auto_approval_enable">
                                    <option value="{{ \App\Models\Setting::SITE_PRODUCT_AUTO_APPROVAL_DISABLED }}" {{ $settings->setting_product_auto_approval_enable == \App\Models\Setting::SITE_PRODUCT_AUTO_APPROVAL_DISABLED ? 'selected' : '' }}>{{ __('products.disabled') }}</option>
                                    <option value="{{ \App\Models\Setting::SITE_PRODUCT_AUTO_APPROVAL_ENABLED }}" {{ $settings->setting_product_auto_approval_enable == \App\Models\Setting::SITE_PRODUCT_AUTO_APPROVAL_ENABLED ? 'selected' : '' }}>{{ __('products.enabled') }}</option>
                                </select>
