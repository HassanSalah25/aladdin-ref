                        ...
                        <div class="tab-content pt-3 pb-3" id="myTabContent">
                            <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-3">
                                        <label class="text-black" for="setting_site_location_country_id">{{ __('theme_alaadin.setting.default-country') }}</label>
                                        ...
                                        <small id="setting_site_location_country_idHelpBlock" class="form-text text-muted">
                                            {{ __('theme_alaadin.setting.default-country-help') }}
                                        </small>
                                    ...
                                    <div class="col-md-3">
                                        <label class="text-black" for="setting_site_location_lat">{{ __('theme_alaadin.setting.default-latitude') }}</label>
                                        ...
                                        <small id="latHelpBlock" class="form-text text-muted">
                                            {{ __('theme_alaadin.setting.default-latitude-help') }}
                                    ...
                                    <div class="col-md-3">
                                        <label class="text-black" for="setting_site_location_lng">{{ __('theme_alaadin.setting.default-longitude') }}</label>
                                    ...
                                    <div class="col-md-3">
                                        <label for="setting_product_currency_symbol" class="text-black">{{ __('theme_alaadin.setting.display-currency-symbol') }}</label>
                                        <select id="setting_product_currency_symbol" class="custom-select" name="setting_product_currency_symbol">
                                            <option value="L.E" {{ $settings->setting_product_currency_symbol == 'L.E' ? 'selected' : '' }}>L.E</option>
                                        ...
                                        <small id="setting_product_currency_symbolHelpBlock" class="form-text text-muted">
                                            {{ __('theme_alaadin.setting.display-currency-symbol-help') }}
                                        </small>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline">
                                            <input {{ $settings->settings_site_smtp_enabled == \App\Models\Setting::SITE_SMTP_ENABLED ? 'checked' : '' }} class="form-check-input @error('settings_site_smtp_enabled') is-invalid @enderror" type="checkbox" id="settings_site_smtp_enabled" name="settings_site_smtp_enabled" value="{{ \App\Models\Setting::SITE_SMTP_ENABLED }}">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="custom-select @error('settings_site_smtp_encryption') is-invalid @enderror" name="settings_site_smtp_encryption" id="settings_site_smtp_encryption">
                                            <option {{ (old('settings_site_smtp_encryption') ? old('settings_site_smtp_encryption') : $settings->settings_site_smtp_encryption) == \App\Models\Setting::SITE_SMTP_ENCRYPTION_NULL ? 'selected' : '' }} value="{{ \App\Models\Setting::SITE_SMTP_ENCRYPTION_NULL }}">{{ __('smtp.smtp-encryption-null') }}</option>
                                            <option {{ (old('settings_site_smtp_encryption') ? old('settings_site_smtp_encryption') : $settings->settings_site_smtp_encryption) == \App\Models\Setting::SITE_SMTP_ENCRYPTION_SSL ? 'selected' : '' }} value="{{ \App\Models\Setting::SITE_SMTP_ENCRYPTION_SSL }}">{{ __('smtp.smtp-encryption-ssl') }}</option>
                                            <option {{ (old('settings_site_smtp_encryption') ? old('settings_site_smtp_encryption') : $settings->settings_site_smtp_encryption) == \App\Models\Setting::SITE_SMTP_ENCRYPTION_TLS ? 'selected' : '' }} value="{{ \App\Models\Setting::SITE_SMTP_ENCRYPTION_TLS }}">{{ __('smtp.smtp-encryption-tls') }}</option>
                                        </select>
                            ...
                            <div class="tab-pane fade" id="google-analytics" role="tabpanel" aria-labelledby="google-analytics-tab">
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-6 pl-2">
                                        <div class="form-check form-check-inline">
                                            <input {{ $settings->setting_site_google_analytic_enabled == \App\Models\Setting::TRACKING_ON ? 'checked' : '' }} class="form-check-input @error('setting_site_google_analytic_enabled') is-invalid @enderror" type="checkbox" id="setting_site_google_analytic_enabled" name="setting_site_google_analytic_enabled" value="{{ \App\Models\Setting::TRACKING_ON }}">
                            ...
                            <div class="tab-pane fade" id="html" role="tabpanel" aria-labelledby="html-tab">
                                ...
                                <div class="row form-group mb-5">
                                    ...
                                    <div class="col-md-3 pl-2">
                                        <div class="form-check form-check-inline">
                                            <input {{ $settings->setting_site_header_enabled == \App\Models\Setting::SITE_HEADER_ENABLED ? 'checked' : '' }} class="form-check-input @error('setting_site_header_enabled') is-invalid @enderror" type="checkbox" id="setting_site_header_enabled" name="setting_site_header_enabled" value="{{ \App\Models\Setting::SITE_HEADER_ENABLED }}">
                                ...
                                <div class="row form-group mt-5">
                                    ...
                                    <div class="col-md-3 pl-2">
                                        <div class="form-check form-check-inline">
                                            <input {{ $settings->setting_site_footer_enabled == \App\Models\Setting::SITE_FOOTER_ENABLED ? 'checked' : '' }} class="form-check-input @error('setting_site_footer_enabled') is-invalid @enderror" type="checkbox" id="setting_site_footer_enabled" name="setting_site_footer_enabled" value="{{ \App\Models\Setting::SITE_FOOTER_ENABLED }}">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="custom-select @error('setting_site_map') is-invalid @enderror" name="setting_site_map" id="setting_site_map">
                                            <option {{ (old('setting_site_map') ? old('setting_site_map') : $settings->setting_site_map) == \App\Models\Setting::SITE_MAP_OPEN_STREET_MAP ? 'selected' : '' }} value="{{ \App\Models\Setting::SITE_MAP_OPEN_STREET_MAP }}">{{ __('google_map.open-street-map') }}</option>
                                            <option {{ (old('setting_site_map') ? old('setting_site_map') : $settings->setting_site_map) == \App\Models\Setting::SITE_MAP_GOOGLE_MAP ? 'selected' : '' }} value="{{ \App\Models\Setting::SITE_MAP_GOOGLE_MAP }}">{{ __('google_map.google-map') }}</option>
                                        </select>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <select class="custom-select @error('setting_site_map_reload_homepage') is-invalid @enderror" name="setting_site_map_reload_homepage" id="setting_site_map_reload_homepage">
                                            <option {{ (old('setting_site_map_reload_homepage') ? old('setting_site_map_reload_homepage') : $settings->setting_site_map_reload_homepage) == \App\Models\Setting::SITE_MAP_RELOAD_HOMEPAGE_YES ? 'selected' : '' }} value="{{ \App\Models\Setting::SITE_MAP_RELOAD_HOMEPAGE_YES }}">{{ __('category_image_option.geolocation.reload-homepage-popup-yes') }}</option>
                                            <option {{ (old('setting_site_map_reload_homepage') ? old('setting_site_map_reload_homepage') : $settings->setting_site_map_reload_homepage) == \App\Models\Setting::SITE_MAP_RELOAD_HOMEPAGE_NO ? 'selected' : '' }} value="{{ \App\Models\Setting::SITE_MAP_RELOAD_HOMEPAGE_NO }}">{{ __('category_image_option.geolocation.reload-homepage-popup-no') }}</option>
                                        </select>
