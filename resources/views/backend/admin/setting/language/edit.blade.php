                    ...
                    <form method="POST" action="{{ route('admin.settings.language.update') }}" class="">
                        ...
                        <div class="row form-group align-items-center">
                            <div class="col-12 col-xl-2">
                                <label class="text-black" for="setting_language_default_language">{{ __('theme_alaadin.setting.default-language') }}</label>
                                ...
                                <small class="form-text text-muted">
                                    {{ __('theme_alaadin.setting.default-language-help') }}
                                </small>
                                    ...
                                    @foreach(\App\Models\Setting::LANGUAGES as $setting_languages_key => $language)
                                        <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2">
                                            <div class="form-check form-check-inline">
                                                ...
                                                @else
                                                    <input name="setting_languages[]" class="form-check-input" type="checkbox" id="setting_languages_{{ $setting_languages_key }}" value="{{ $setting_languages_key }}" {{ $settings->settingLanguage->$language == \App\Models\SettingLanguage::LANGUAGE_ENABLE  ? 'checked' : '' }}>
                                                @endif
