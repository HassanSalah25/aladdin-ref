                                ...
                                <div class="form-row">
                                    <div class="col-12 col-md-6 mb-3 mb-md-0">
                                        <div class="form-check">
                                            <input {{ (old('setting_site_maintenance_mode') ? old('setting_site_maintenance_mode') : $settings->setting_site_maintenance_mode) == \App\Models\Setting::SITE_MAINTENANCE_MODE_OFF ? 'checked' : '' }} class="form-check-input" type="radio" name="setting_site_maintenance_mode" id="setting_site_maintenance_mode_off" value="{{ \App\Models\Setting::SITE_MAINTENANCE_MODE_OFF }}" aria-describedby="setting_site_maintenance_mode_off_help">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-check">
                                            <input {{ (old('setting_site_maintenance_mode') ? old('setting_site_maintenance_mode') : $settings->setting_site_maintenance_mode) == \App\Models\Setting::SITE_MAINTENANCE_MODE_ON ? 'checked' : '' }} class="form-check-input" type="radio" name="setting_site_maintenance_mode" id="setting_site_maintenance_mode_on" value="{{ \App\Models\Setting::SITE_MAINTENANCE_MODE_ON }}" aria-describedby="setting_site_maintenance_mode_on_help">
