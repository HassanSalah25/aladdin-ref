                    ...
                    <form method="POST" action="{{ route('admin.settings.recaptcha.update') }}" class="">
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input value="{{ \App\Models\Setting::SITE_RECAPTCHA_LOGIN_ENABLE }}" name="setting_site_recaptcha_login_enable" type="checkbox" class="custom-control-input" id="setting_site_recaptcha_login_enable" {{ (old('setting_site_recaptcha_login_enable') ? old('setting_site_recaptcha_login_enable') : $all_recaptcha_settings->setting_site_recaptcha_login_enable) == \App\Models\Setting::SITE_RECAPTCHA_LOGIN_ENABLE ? 'checked' : '' }}>
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input value="{{ \App\Models\Setting::SITE_RECAPTCHA_SIGN_UP_ENABLE }}" name="setting_site_recaptcha_sign_up_enable" type="checkbox" class="custom-control-input" id="setting_site_recaptcha_sign_up_enable" {{ (old('setting_site_recaptcha_sign_up_enable') ? old('setting_site_recaptcha_sign_up_enable') : $all_recaptcha_settings->setting_site_recaptcha_sign_up_enable) == \App\Models\Setting::SITE_RECAPTCHA_SIGN_UP_ENABLE ? 'checked' : '' }}>
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input value="{{ \App\Models\Setting::SITE_RECAPTCHA_CONTACT_ENABLE }}" name="setting_site_recaptcha_contact_enable" type="checkbox" class="custom-control-input" id="setting_site_recaptcha_contact_enable" {{ (old('setting_site_recaptcha_contact_enable') ? old('setting_site_recaptcha_contact_enable') : $all_recaptcha_settings->setting_site_recaptcha_contact_enable) == \App\Models\Setting::SITE_RECAPTCHA_CONTACT_ENABLE ? 'checked' : '' }}>
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input value="{{ \App\Models\Setting::SITE_RECAPTCHA_ITEM_LEAD_ENABLE }}" name="setting_site_recaptcha_item_lead_enable" type="checkbox" class="custom-control-input" id="setting_site_recaptcha_item_lead_enable" {{ (old('setting_site_recaptcha_item_lead_enable') ? old('setting_site_recaptcha_item_lead_enable') : $all_recaptcha_settings->setting_site_recaptcha_item_lead_enable) == \App\Models\Setting::SITE_RECAPTCHA_ITEM_LEAD_ENABLE ? 'checked' : '' }}>
