...
@section('content')
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            <form id="ad-create-form" method="POST" action="{{ route('admin.features.update',$feature) }}">
                @csrf
                @method('PUT')
                <div class="row">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <input id="feature_name" type="text"
                                       ...
                                       name="feature_name" value="{{ old('feature_name')??$feature->name}}" autofocus>
                                @error('feature_name')
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <input id="feature_name_ar" type="text"
                                       ...
                                       name="feature_name_ar" value="{{ old('feature_name_ar')??$feature->name_ar }}"
                                       autofocus>
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <label for="plan_features"
                                       class="text-black">{{ __('plan.plan-features_type') }}</label>
                                <select id="plan_features_type" type="text"
                                    ...
                                    <option value="1" {{ $feature->type == \App\Models\Feature::TYPE_CHAR ? 'selected' : '' }}>{{__('feature.type-char')}}</option>
                                    <option value="2" {{ $feature->type == \App\Models\Feature::TYPE_AVAILABLE ? 'selected' : '' }}>{{__('feature.type-available')}}</option>
                                    <option value="3" {{ $feature->type == \App\Models\Feature::TYPE_COUNT ? 'selected' : '' }}>{{__('feature.type-count')}}</option>
                                    <option value="4" {{ $feature->type == \App\Models\Feature::TYPE_STATEMENT ? 'selected' : '' }}>{{__('feature.type-statement')}}</option>
                                </select>
