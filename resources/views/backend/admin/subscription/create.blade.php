...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-9">
            <h1 class="h3 mb-2 text-gray-800">{{ __('subscription.add-subscription') }}</h1>
            <p class="mb-4">{{ __('subscription.add-subscription-desc') }}</p>
        </div>
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            <form id="ad-create-form" method="POST" action="{{ route('admin.subscriptions.store') }}">
                @csrf
                    ...
                    <div class="col-12 col-md-10 col-lg-6">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <select id="plan_name" type="text"
                                        class="js-example-basic-single form-control @error('plan_name') is-invalid @enderror"
                                        name="plan_name" autofocus>
                                    <option value="">---</option>
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <label for="user_name"
                                       class="text-black">{{ __('user.name') }}</label>
                                <select id="user_name" type="text"
                                        class="js-example-basic-single form-control @error('user_name') is-invalid @enderror"
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <label for="payment_type"
                                       class="text-black">{{ __('subscription.payment-type') }}</label>
                                <select id="payment_type"
                                        class="js-example-basic-single form-control @error('payment_type') is-invalid @enderror"
                                        name="payment_type" autofocus>
                                    <option value="">---</option>
                                    <option value="1">Paybal</option>
                                    <option value="2">Bank</option>
                                    <option value="3">Fawry</option>
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-success py-2 px-4 text-white">
                                    {{ __('subscription.create-subscription') }}
                                </button>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            var simplemde = new SimpleMDE({
                element: document.getElementById("subscription_code"),
                status: false,
                toolbar: false,
                spellChecker: false,
            });
