        ...
        <div class="col-12">
            <div class="row">
                <div class="col-12 col-md-8 col-lg-6">
                    <form method="POST" action="{{ route('admin.social-medias.update', $socialMedia->id) }}" class="" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="social_media_icon" type="file" class="form-control @error('social_media_icon') is-invalid @enderror" name="social_media_icon" value="{{ old('social_media_icon') }}">
                                <small class="text-muted">
                                    {!! __('size image must be 512*512 png.jpeg') !!}
                                </small>
