                    ...
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="{{ \App\Models\ImportCsvData::URL_PHP_TIMEZONE }}" target="_blank">
                            ...
                            <li>
                                <a href="{{ \App\Models\ImportCsvData::URL_DOWNLOAD_SAMPLE_CSV  }}" target="_blank">
                        ...
                        <div class="row form-group">
                            <div class="col-md-6 col-12">
                                ...
                                <select class="custom-select @error('import_csv_data_for_model') is-invalid @enderror" name="import_csv_data_for_model" id="import_csv_data_for_model">
                                    <option {{ old('import_csv_data_for_model') == \App\Models\ImportCsvData::IMPORT_CSV_FOR_MODEL_LISTING ? 'selected' : '' }} value="{{ \App\Models\ImportCsvData::IMPORT_CSV_FOR_MODEL_LISTING }}">{{ __('importer_csv.csv-for-model-listing') }}</option>
                                </select>
                        ...
                        <div class="row form-group">
                            <div class="col-md-6 col-12">
                                <div class="custom-control custom-checkbox">
                                    <input value="{{ \App\Models\ImportCsvData::IMPORT_CSV_SKIP_FIRST_ROW_YES }}" name="import_csv_data_skip_first_row" type="checkbox" class="custom-control-input" id="import_csv_data_skip_first_row" {{ old('import_csv_data_skip_first_row') == \App\Models\ImportCsvData::IMPORT_CSV_SKIP_FIRST_ROW_YES ? 'checked' : '' }}>
