                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="import_item_data_process_status[]" id="import_item_data_process_status_not_processed" value="{{ \App\Models\ImportItemData::PROCESS_STATUS_NOT_PROCESSED }}" {{ in_array(\App\Models\ImportItemData::PROCESS_STATUS_NOT_PROCESSED, $import_item_data_process_status) ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="import_item_data_process_status[]" id="import_item_data_process_status_success_processed" value="{{ \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS }}" {{ in_array(\App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS, $import_item_data_process_status) ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="import_item_data_process_status[]" id="import_item_data_process_status_error_processed" value="{{ \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_ERROR }}" {{ in_array(\App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_ERROR, $import_item_data_process_status) ? 'checked' : '' }}>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-4">
                                <select class="custom-select" name="order_by">
                                    <option value="{{ \App\Models\ImportItemData::ORDER_BY_ITEM_NEWEST_PROCESSED }}" {{ $order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_NEWEST_PROCESSED ? 'selected' : '' }}>{{ __('importer_csv.import-listing-order-newest-processed') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::ORDER_BY_ITEM_OLDEST_PROCESSED }}" {{ $order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_OLDEST_PROCESSED ? 'selected' : '' }}>{{ __('importer_csv.import-listing-order-oldest-processed') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::ORDER_BY_ITEM_NEWEST_PARSED }}" {{ $order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_NEWEST_PARSED ? 'selected' : '' }}>{{ __('importer_csv.import-listing-order-newest-parsed') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::ORDER_BY_ITEM_OLDEST_PARSED }}" {{ $order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_OLDEST_PARSED ? 'selected' : '' }}>{{ __('importer_csv.import-listing-order-oldest-parsed') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::ORDER_BY_ITEM_TITLE_A_Z }}" {{ $order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_TITLE_A_Z ? 'selected' : '' }}>{{ __('importer_csv.import-listing-order-title-a-z') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::ORDER_BY_ITEM_TITLE_Z_A }}" {{ $order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_TITLE_Z_A ? 'selected' : '' }}>{{ __('importer_csv.import-listing-order-title-z-a') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::ORDER_BY_ITEM_CITY_A_Z }}" {{ $order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_CITY_A_Z ? 'selected' : '' }}>{{ __('importer_csv.import-listing-order-city-a-z') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::ORDER_BY_ITEM_CITY_Z_A }}" {{ $order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_CITY_Z_A ? 'selected' : '' }}>{{ __('importer_csv.import-listing-order-city-z-a') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::ORDER_BY_ITEM_STATE_A_Z }}" {{ $order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_STATE_A_Z ? 'selected' : '' }}>{{ __('importer_csv.import-listing-order-state-a-z') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::ORDER_BY_ITEM_STATE_Z_A }}" {{ $order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_STATE_Z_A ? 'selected' : '' }}>{{ __('importer_csv.import-listing-order-state-z-a') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::ORDER_BY_ITEM_COUNTRY_A_Z }}" {{ $order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_COUNTRY_A_Z ? 'selected' : '' }}>{{ __('importer_csv.import-listing-order-country-a-z') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::ORDER_BY_ITEM_COUNTRY_Z_A }}" {{ $order_by == \App\Models\ImportItemData::ORDER_BY_ITEM_COUNTRY_Z_A ? 'selected' : '' }}>{{ __('importer_csv.import-listing-order-country-z-a') }}</option>
                                </select>
                            </div>

                            <div class="col-12 col-md-4">
                                <select class="custom-select" name="count_per_page">
                                    <option value="{{ \App\Models\ImportItemData::COUNT_PER_PAGE_10 }}" {{ $count_per_page == \App\Models\ImportItemData::COUNT_PER_PAGE_10 ? 'selected' : '' }}>{{ __('importer_csv.import-listing-per-page-10') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::COUNT_PER_PAGE_25 }}" {{ $count_per_page == \App\Models\ImportItemData::COUNT_PER_PAGE_25 ? 'selected' : '' }}>{{ __('importer_csv.import-listing-per-page-25') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::COUNT_PER_PAGE_50 }}" {{ $count_per_page == \App\Models\ImportItemData::COUNT_PER_PAGE_50 ? 'selected' : '' }}>{{ __('importer_csv.import-listing-per-page-50') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::COUNT_PER_PAGE_100 }}" {{ $count_per_page == \App\Models\ImportItemData::COUNT_PER_PAGE_100 ? 'selected' : '' }}>{{ __('importer_csv.import-listing-per-page-100') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::COUNT_PER_PAGE_250 }}" {{ $count_per_page == \App\Models\ImportItemData::COUNT_PER_PAGE_250 ? 'selected' : '' }}>{{ __('importer_csv.import-listing-per-page-250') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::COUNT_PER_PAGE_500 }}" {{ $count_per_page == \App\Models\ImportItemData::COUNT_PER_PAGE_500 ? 'selected' : '' }}>{{ __('importer_csv.import-listing-per-page-500') }}</option>
                                    <option value="{{ \App\Models\ImportItemData::COUNT_PER_PAGE_1000 }}" {{ $count_per_page == \App\Models\ImportItemData::COUNT_PER_PAGE_1000 ? 'selected' : '' }}>{{ __('importer_csv.import-listing-per-page-1000') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-12 col-md-6">
                                    ...
                                    <select id="user_id" class="custom-select @error('user_id') is-invalid @enderror" name="user_id">
                                        ...
                                        <option value="{{ \App\Models\ImportItemData::IMPORT_RANDOM_USER }}">{{ __('theme_alaadin.importer.random-user') }}</option>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select id="item_type" class="custom-select @error('item_type') is-invalid @enderror" name="item_type">
                                        ...
                                        <option value="{{ \App\Models\Item::ITEM_TYPE_REGULAR }}">{{ __('theme_alaadin.online-listing.regular-listing') }}</option>
                                        <option value="{{ \App\Models\Item::ITEM_TYPE_ONLINE }}">{{ __('theme_alaadin.online-listing.online-listing') }}</option>
                            ...
                            <div class="row mb-3">
                                <div class="col-12 col-md-6">
                                    ...
                                    <select id="item_status" class="custom-select @error('item_status') is-invalid @enderror" name="item_status">
                                        <option value="{{ \App\Models\Item::ITEM_SUBMITTED }}">{{ __('backend.item.submitted') }}</option>
                                        <option value="{{ \App\Models\Item::ITEM_PUBLISHED }}">{{ __('backend.item.published') }}</option>
                                        <option value="{{ \App\Models\Item::ITEM_SUSPENDED }}">{{ __('backend.item.suspended') }}</option>
                                    </select>
                                    @error('item_status')
                                    <span class="invalid-tooltip">
                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select id="item_featured" class="custom-select @error('item_featured') is-invalid @enderror" name="item_featured">
                                        <option value="{{ \App\Models\Item::ITEM_NOT_FEATURED }}">{{ __('backend.shared.no') }}</option>
                                        <option value="{{ \App\Models\Item::ITEM_FEATURED }}">{{ __('backend.shared.yes') }}</option>
                                    </select>
                                    @error('item_featured')
                                    <span class="invalid-tooltip">
                                        <strong>{{ $message }}</strong>
                    ...
                    setTimeout(function() {
                        ...
                        jQuery.ajax({
                            ...
                            success: function(result){
                                ...
                                if(result.status == {{ \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS }})
                                {
                                    success_import_listing_count += 1;
                                }
                                if(result.status == {{ \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_ERROR }})
                                {
