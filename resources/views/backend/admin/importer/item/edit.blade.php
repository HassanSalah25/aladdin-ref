        ...
        <div class="col-12">
            ...
            <div class="row border-left-info mb-3">
                ...
                <div class="col-12 col-md-8 text-right">
                    @if($import_item_data->import_item_data_source == \App\Models\ImportItemData::SOURCE_CSV)
            ...
            <div class="row border-left-info mb-2">
                ...
                <div class="col-12 col-md-8 text-right">
                    ...
                    @if($import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_NOT_PROCESSED)
                        <span class="bg-warning rounded pl-2 pr-2 pt-1 pb-1 text-white">{{ __('importer_csv.import-listing-status-not-processed') }}</span>
                    @elseif($import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS)
                        <span class="bg-success rounded pl-2 pr-2 pt-1 pb-1 text-white">{{ __('importer_csv.import-listing-status-success') }}</span>
                    @elseif($import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_ERROR)
            ...
            @if($import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_ERROR && !empty($import_item_data->import_item_data_process_error_log))
                    ...
                    <form method="POST" action="{{ route('admin.importer.item.data.update', ['import_item_data' => $import_item_data]) }}" class="">
                        ...
                        <div class="row form-group">
                            <div class="col-12 col-md-4">
                                ...
                                <input id="import_item_data_item_title" type="text" class="form-control @error('import_item_data_item_title') is-invalid @enderror" name="import_item_data_item_title" value="{{ old('import_item_data_item_title') ? old('import_item_data_item_title') : $import_item_data->import_item_data_item_title }}" {{ $import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS ? 'disabled' : '' }}>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input id="import_item_data_state" type="text" class="form-control @error('import_item_data_state') is-invalid @enderror" name="import_item_data_state" value="{{ old('import_item_data_state') ? old('import_item_data_state') : $import_item_data->import_item_data_state }}" {{ $import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS ? 'disabled' : '' }}>
                        ...
                        <div class="row form-group">
                            <div class="col-12 col-md-4">
                                ...
                                <input id="import_item_data_item_lat" type="text" class="form-control @error('import_item_data_item_lat') is-invalid @enderror" name="import_item_data_item_lat" value="{{ old('import_item_data_item_lat') ? old('import_item_data_item_lat') : $import_item_data->import_item_data_item_lat }}" {{ $import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS ? 'disabled' : '' }}>
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input id="import_item_data_item_lng" type="text" class="form-control @error('import_item_data_item_lng') is-invalid @enderror" name="import_item_data_item_lng" value="{{ old('import_item_data_item_lng') ? old('import_item_data_item_lng') : $import_item_data->import_item_data_item_lng }}" {{ $import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS ? 'disabled' : '' }}>
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('import_item_data_item_description') is-invalid @enderror" id="import_item_data_item_description" rows="5" name="import_item_data_item_description" {{ $import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS ? 'disabled' : '' }}>{{ old('import_item_data_item_description') ? old('import_item_data_item_description') : $import_item_data->import_item_data_item_description }}</textarea>
                        ...
                        <div class="row form-group">
                            <div class="col-12 col-md-3">
                                ...
                                <input id="import_item_data_item_phone" type="text" class="form-control @error('import_item_data_item_phone') is-invalid @enderror" name="import_item_data_item_phone" value="{{ old('import_item_data_item_phone') ? old('import_item_data_item_phone') : $import_item_data->import_item_data_item_phone }}" {{ $import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS ? 'disabled' : '' }}>
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <input id="import_item_data_item_social_twitter" type="text" class="form-control @error('import_item_data_item_social_twitter') is-invalid @enderror" name="import_item_data_item_social_twitter" value="{{ old('import_item_data_item_social_twitter') ? old('import_item_data_item_social_twitter') : $import_item_data->import_item_data_item_social_twitter }}" {{ $import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS ? 'disabled' : '' }}>
                                <small class="form-text text-muted">
                                    {{ __('backend.shared.url-help') }}
                                </small>
                        ...
                        <div class="row form-group">
                            <div class="col-12 col-md-3">
                                ...
                                <input id="import_item_data_item_social_linkedin" type="text" class="form-control @error('import_item_data_item_social_linkedin') is-invalid @enderror" name="import_item_data_item_social_linkedin" value="{{ old('import_item_data_item_social_linkedin') ? old('import_item_data_item_social_linkedin') : $import_item_data->import_item_data_item_social_linkedin }}" {{ $import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS ? 'disabled' : '' }}>
                                <small class="form-text text-muted">
                                    {{ __('backend.shared.url-help') }}
                                </small>
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <input id="import_item_data_item_social_instagram" type="text" class="form-control @error('import_item_data_item_social_instagram') is-invalid @enderror" name="import_item_data_item_social_instagram" value="{{ old('import_item_data_item_social_instagram') ? old('import_item_data_item_social_instagram') : $import_item_data->import_item_data_item_social_instagram }}" {{ $import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS ? 'disabled' : '' }}>
                                <small class="form-text text-muted">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="import_item_data_item_hour_show_hours" class="selectpicker form-control @error('import_item_data_item_hour_show_hours') is-invalid @enderror" name="import_item_data_item_hour_show_hours" data-live-search="true" {{ $import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS ? 'disabled' : '' }}>
                                    <option value="{{ \App\Models\Item::ITEM_HOUR_SHOW }}" {{ (old('import_item_data_item_hour_show_hours') ? old('import_item_data_item_hour_show_hours') : $import_item_data->import_item_data_item_hour_show_hours) == \App\Models\Item::ITEM_HOUR_SHOW ? 'selected' : '' }}>{{ __('item_hour.show-hour') }}</option>
                                    <option value="{{ \App\Models\Item::ITEM_HOUR_NOT_SHOW }}" {{ (old('import_item_data_item_hour_show_hours') ? old('import_item_data_item_hour_show_hours') : $import_item_data->import_item_data_item_hour_show_hours) == \App\Models\Item::ITEM_HOUR_NOT_SHOW ? 'selected' : '' }}>{{ __('item_hour.not-show-hour') }}</option>
                                </select>
                                <small class="form-text text-muted">
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('import_item_data_item_hours') is-invalid @enderror" id="import_item_data_item_hours" rows="5" name="import_item_data_item_hours" {{ $import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS ? 'disabled' : '' }}>{{ old('import_item_data_item_hours') ? old('import_item_data_item_hours') : $import_item_data->import_item_data_item_hours }}</textarea>
                                <small class="form-text text-muted">
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                ...
                                <input id="import_item_data_item_image" type="text" class="form-control @error('import_item_data_item_image') is-invalid @enderror" name="import_item_data_item_image" value="{{ old('import_item_data_item_image') ? old('import_item_data_item_image') : $import_item_data->import_item_data_item_image }}" {{ $import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS ? 'disabled' : '' }}>
                                <small class="form-text text-muted">
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('import_item_data_item_image_galleries') is-invalid @enderror" id="import_item_data_item_image_galleries" rows="5" name="import_item_data_item_image_galleries" {{ $import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS ? 'disabled' : '' }}>{{ old('import_item_data_item_image_galleries') ? old('import_item_data_item_image_galleries') : $import_item_data->import_item_data_item_image_galleries }}</textarea>
                                <small class="form-text text-muted">
                        ...
                        <div class="row form-group">
                            <div class="col-12">
                                ...
                                <small class="form-text text-muted">
                                    {{ __('theme_alaadin.importer.import-custom-field-help') }}
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="row form-group justify-content-between">
                            <div class="col-8">
                                ...
                                @if($import_item_data->import_item_data_process_status == \App\Models\ImportItemData::PROCESS_STATUS_PROCESSED_SUCCESS)
                                    ...
                                    <div class="row form-group">
                                        <div class="col-12 col-md-3">
                                            ...
                                            <select id="user_id" class="custom-select @error('user_id') is-invalid @enderror" name="user_id">
                                                ...
                                                <option value="{{ \App\Models\ImportItemData::IMPORT_RANDOM_USER }}" {{ old('user_id') == \App\Models\ImportItemData::IMPORT_RANDOM_USER ? 'selected' : '' }}>{{ __('theme_alaadin.importer.random-user') }}</option>
                                        ...
                                        <div class="col-12 col-md-3">
                                            <label for="item_type" class="text-black">{{ __('theme_alaadin.online-listing.listing-type') }}</label>
                                            <select id="item_type" class="custom-select @error('item_type') is-invalid @enderror" name="item_type">

                                                <option value="{{ \App\Models\Item::ITEM_TYPE_REGULAR }}" {{ old('item_type') == \App\Models\Item::ITEM_TYPE_REGULAR ? 'selected' : '' }}>{{ __('theme_alaadin.online-listing.regular-listing') }}</option>
                                                <option value="{{ \App\Models\Item::ITEM_TYPE_ONLINE }}" {{ old('item_type') == \App\Models\Item::ITEM_TYPE_ONLINE ? 'selected' : '' }}>{{ __('theme_alaadin.online-listing.online-listing') }}</option>
                                        ...
                                        <div class="col-12 col-md-3">
                                            ...
                                            <select id="item_status" class="custom-select @error('item_status') is-invalid @enderror" name="item_status">
                                                <option value="{{ \App\Models\Item::ITEM_SUBMITTED }}" {{ old('item_status') == \App\Models\Item::ITEM_SUBMITTED ? 'selected' : '' }}>{{ __('backend.item.submitted') }}</option>
                                                <option value="{{ \App\Models\Item::ITEM_PUBLISHED }}" {{ old('item_status') == \App\Models\Item::ITEM_PUBLISHED ? 'selected' : '' }}>{{ __('backend.item.published') }}</option>
                                                <option value="{{ \App\Models\Item::ITEM_SUSPENDED }}" {{ old('item_status') == \App\Models\Item::ITEM_SUSPENDED ? 'selected' : '' }}>{{ __('backend.item.suspended') }}</option>
                                            </select>
                                            @error('item_status')
                                            <span class="invalid-tooltip">
                                                <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-12 col-md-3">
                                            ...
                                            <select id="item_featured" class="custom-select @error('item_featured') is-invalid @enderror" name="item_featured">
                                                <option value="{{ \App\Models\Item::ITEM_NOT_FEATURED }}" {{ old('item_featured') == \App\Models\Item::ITEM_NOT_FEATURED ? 'selected' : '' }}>{{ __('backend.shared.no') }}</option>
                                                <option value="{{ \App\Models\Item::ITEM_FEATURED }}" {{ old('item_featured') == \App\Models\Item::ITEM_FEATURED ? 'selected' : '' }}>{{ __('backend.shared.yes') }}</option>
                                            </select>
                                            @error('item_featured')
                                            <span class="invalid-tooltip">
                                                <strong>{{ $message }}</strong>
