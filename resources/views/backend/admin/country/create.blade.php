                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <select class="custom-select" name="country_status">
                                    <option value="{{ \App\Models\Country::COUNTRY_STATUS_ENABLE }}" {{ old('country_status') == \App\Models\Country::COUNTRY_STATUS_ENABLE ? 'selected' : '' }}>
                                        {{ __('setting_language.country.country-status-enable') }}
                                    </option>
                                    <option value="{{ \App\Models\Country::COUNTRY_STATUS_DISABLE }}" {{ old('country_status') == \App\Models\Country::COUNTRY_STATUS_DISABLE ? 'selected' : '' }}>
