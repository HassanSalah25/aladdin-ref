        ...
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-3">
                    ...
                    <a target="_blank" href="{{ route('page.item', [
                    ...
                    ]) }}" class="btn btn-primary btn-block mt-2">{{ __('backend.message.view-listing') }}</a>
                    ...
                    <div class="row mb-3 align-items-center">
                        <div class="col-md-1">
                            @if(empty(\App\Models\User::find($review->author_id)->user_image))
                                <img src="{{ asset('backend/images/placeholder/profile-'. intval(\App\Models\User::find($review->author_id)->id % 10) . '.webp') }}" alt="Image" class="img-fluid rounded-circle">
                            @else
