        ...
        <div class="col-12">
            ...
            <div class="row border-left-info mb-4 pt-3 pb-3">
                <div class="col-12">
                    <div class="row mb-3">
                        <div class="col-12">
                            <span class="text-lg text-gray-800">{{  __('role_permission.item.listing-owner') }}</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                                ...
                                <div class="form-row">
                                    <div class="col-6 col-sm-8 col-md-9 col-lg-10">
                                        <select id="user_id"
                                            ...
                                            <option
                                                value="{{ $login_user->id }}" {{ old('user_id') == $login_user->id ? 'selected' : '' }}>{{ __('role_permission.item.myself') . ' (' . $login_user->email . ')' }}</option>
                                            @foreach($other_users as $other_users_key => $other_user)
                                                <option
                                                    value="{{ $other_user->id }}" {{ old('user_id') == $other_user->id ? 'selected' : '' }}
                                                    {{ $other_user->id == request('user_id') ? 'selected' : '' }}
                                                >{{ $other_user->name . ' (' . $other_user->email . ')' }}</option>
                                            @endforeach
                                        </select>
                                        @error('user_id')
                                    ...
                                    <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                                        <button type="submit"
                                                class="btn btn-primary">{{ __('backend.item.load-form') }}</button>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-12">
                    @if($user_id)
                        @php
                            $plan = $user_id->subscription?->plan;
                        @endphp
                        @if($plan)
                                            ...
                                            @if($plan->check_plan(1))
                                                <div class="col-md-6">
                                                    ...
                                                    <input id="item_title" type="text"
                                                           ...
                                                           name="item_title" value="{{ old('item_title') }}">
                                                    @error('item_title')
                                                    <span class="invalid-tooltip">
                                    <strong>{{ $message }}</strong>
                                </span>
                                            ...
                                            @if($plan->check_plan(21))
                                                <div class="col-md-6">
                                                    <label for="user_id"
                                                           class="text-black">{{ __('backend.item.select-category') }}</label>
                                                    <select size="{{ count($all_categories) }}"
                                                            class="selectpicker form-control @error('category') is-invalid @enderror"
                                                            name="category"
                                                            data-live-search="true" data-actions-box="true">
                                                        @foreach($all_categories as $key => $category)
                                                            <option
                                                                value="{{ $category['id'] }}" {{ in_array($category['category_id'], empty($category_ids) ? array() : $category_ids) ? 'selected' : '' }}>{{ $category['category_name'] }}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="form-row mb-3">
                                            <div class="col-md-3">
                                                ...
                                                <select
                                                    ...
                                                    <option
                                                        value="{{ \App\Models\Item::ITEM_SUBMITTED }}">{{ __('backend.item.submitted') }}</option>
                                                    <option value="{{ \App\Models\Item::ITEM_PUBLISHED }}"
                                                            selected>{{ __('backend.item.published') }}</option>
                                                    <option
                                                        value="{{ \App\Models\Item::ITEM_SUSPENDED }}">{{ __('backend.item.suspended') }}</option>
                                            ...
                                            @if($plan->check_plan(3))
                                                <div class="col-md-3">
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="{{ \App\Models\Item::ITEM_NOT_FEATURED }}"
                                                                selected>{{ __('backend.shared.no') }}</option>
                                                        <option
                                                            value="{{ \App\Models\Item::ITEM_FEATURED }}">{{ __('backend.shared.yes') }}</option>
                                            ...
                                            @if($plan->check_plan(4))
                                                <div class="col-md-6">
                                                    ...
                                                    <input id="item_address" type="text"
                                                           ...
                                                           name="item_address" value="{{ old('item_address') }}">
                                                    @error('item_address')
                                                    <span class="invalid-tooltip">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-row mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-check form-check-inline">
                                                    <input
                                                        {{ old('item_address_hide') == 1 ? 'checked' : '' }} class="form-check-input"
                                        ...
                                        <div class="form-row mb-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="select_country_id"
                                                    ...
                                                    <option selected
                                                            value="">{{ __('prefer_country.select-country') }}</option>
                                                    @foreach($all_countries as $all_countries_key => $country)
                                                        @if($country->country_status == \App\Models\Country::COUNTRY_STATUS_ENABLE)
                                                            <option
                                                                value="{{ $country->id }}" {{ $country->id == old('country_id') ? 'selected' : '' }}>{{ $country->country_name }}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                                @error('country_id')
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="select_state_id"
                                                    ...
                                                    <option selected
                                                            value="">{{ __('backend.item.select-state') }}</option>
                                                </select>
                                                @error('state_id')
                                                <span class="invalid-tooltip">
                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select id="select_city_id"
                                                    ...
                                                    <option selected
                                                            value="">{{ __('backend.item.select-city') }}</option>
                                                </select>
                                                @error('city_id')
                                                <span class="invalid-tooltip">
                                            <strong>{{ $message }}</strong>
                                            ...
                                            @if($plan->check_plan(25))
                                                <div class="col-md-4">
                                                    ...
                                                    <input id="item_website" type="text"
                                                           ...
                                                           name="item_website" value="{{ old('item_website') }}">
                                            ...
                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input id="item_social_facebook" type="text"
                                                           ...
                                                           value="{{ old('item_social_facebook') }}">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
                                                        {{ __('backend.shared.url-help') }}
                                                    </small>
                                            ...
                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input id="item_social_pinterest" type="text"
                                                           ...
                                                           value="{{ old('item_social_pinterest') }}">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
                                                        {{ __('backend.shared.url-help') }}
                                                    </small>
                                            ...
                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input id="item_social_telegram" type="text"
                                                           ...
                                                           value="{{ old('item_social_telegram') }}">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
                                            ...
                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input id="item_social_snapchat" type="text"
                                                           ...
                                                           name="item_social_facebook"
                                                           value="{{ old('item_social_snapchat') }}">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
                                                        {{ __('backend.shared.url-help') }}
                                                    </small>
                                            ...
                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input id="item_social_linkedin" type="text"
                                                           ...
                                                           value="{{ old('item_social_linkedin') }}">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
                                                        {{ __('backend.shared.url-help') }}
                                                    </small>
                                            ...
                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input id="item_social_instagram" type="text"
                                                           ...
                                                           value="{{ old('item_social_instagram') }}">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
                                            ...
                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input id="item_social_whatsapp" type="text"
                                                           ...
                                                           value="{{ old('item_social_whatsapp') }}">
                                                    <small id="linkHelpBlock" class="form-text text-muted">
                                ...
                                @if($plan->check_plan(19))
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <select id="item_hour_time_zone"
                                                        ...
                                                        @foreach($time_zone_identifiers as $time_zone_identifiers_key => $time_zone_identifier)
                                                            <option
                                                                value="{{ $time_zone_identifier }}" {{ old('item_hour_time_zone') == $time_zone_identifier ? 'selected' : '' }}>{{ $time_zone_identifier }}</option>
                                                        @endforeach
                                                    </select>
                                                    <small class="form-text text-muted">
                                    ...
                                    <strong>{{ $message }}</strong>
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <select id="item_hour_show_hours"
                                                        ...
                                                        <option
                                                            value="{{ \App\Models\Item::ITEM_HOUR_SHOW }}" {{ old('item_hour_show_hours') == \App\Models\Item::ITEM_HOUR_SHOW ? 'selected' : '' }}>{{ __('item_hour.show-hour') }}</option>
                                                        <option
                                                            value="{{ \App\Models\Item::ITEM_HOUR_NOT_SHOW }}" {{ old('item_hour_show_hours') == \App\Models\Item::ITEM_HOUR_NOT_SHOW ? 'selected' : '' }}>{{ __('item_hour.not-show-hour') }}</option>
                                                    </select>
                                                    <small class="form-text text-muted">
                                    ...
                                    <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-row mb-3">
                                                <div class="col-12">
                                                    <span
                                                        class="text-gray-800">{{ __('item_hour.open-hour-hours') }}</span>
                                                    <small class="form-text text-muted">
                                            ...
                                            <div class="form-row mb-3 align-items-end">
                                                ...
                                                <div class="col-12 col-md-2">
                                                    ...
                                                    <select id="item_hour_open_time_open_hour"
                                                            class="selectpicker form-control"
                                                            name="item_hour_open_time_open_hour"
                                                ...
                                                <div class="col-12 col-md-2">
                                                    ...
                                                    <select id="item_hour_open_time_open_minute"
                                                            class="selectpicker form-control"
                                                            name="item_hour_open_time_open_minute"
                                                            data-live-search="true">
                                                        @for($full_minute=0; $full_minute<=59; $full_minute++)
                                                            <option
                                                                value="{{ $full_minute }}">{{ $full_minute }}</option>
                                                        @endfor
                                                    </select>
                                                </div>
                                                <div class="col-12 col-md-2">
                                                    ...
                                                    <select id="item_hour_open_time_close_hour"
                                                            class="selectpicker form-control"
                                                            name="item_hour_open_time_close_hour"
                                                            data-live-search="true">
                                                        @for($full_hour=0; $full_hour<=24; $full_hour++)
                                                            <option value="{{ $full_hour }}">{{ $full_hour }}</option>
                                                        @endfor
                                                ...
                                                <div class="col-12 col-md-2">
                                                    ...
                                                    <select id="item_hour_open_time_close_minute"
                                                            class="selectpicker form-control"
                                                            name="item_hour_open_time_close_minute"
                                                            data-live-search="true">
                                                        @for($full_minute=0; $full_minute<=59; $full_minute++)
                                                            <option
                                                                value="{{ $full_minute }}">{{ $full_minute }}</option>
                                            ...
                                            <div class="form-row mb-3 align-items-end">
                                                <div class="col-12 col-md-2">
                                                    ...
                                                    <input id="item_hour_exception_date" type="text"
                                                           class="form-control"
                                                           name="item_hour_exception_date" value=""
                                            ...
                                            <strong>{{ $message }}</strong>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-8">
                                                            ...
                                                            <input id="feature_image" type="hidden"
                                                                   name="feature_image">
                                                        </div>
                                                    </div>
                        ...
                        @else
                            <div class="constant">
                                <h2 class="h2 text-center">{{__('item.no-plans-to-this-user')}}</h2>
                            </div>
                        @endif
                    @endif
                </div>
