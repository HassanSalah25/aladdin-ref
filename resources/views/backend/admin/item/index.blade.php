                                            ...
                                            <td>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        ...
                                                        @if($item->item_featured == \App\Models\Item::ITEM_FEATURED)
                                                        ...
                                                        @endif
                                                            ...
                                                            <div class="row align-items-center">
                                                                ...
                                                                @else
                                                                    <div class="col-3 col-sm-2 col-md-3 col-lg-2 col-xl-1">
                                                                        <img id="image_preview" src="{{ asset('backend/images/placeholder/profile-' . intval(1 % 10) . '.webp') }}" class="img-fluid rounded-circle">
                                                                    </div>
                                                                    <div class="col-9 col-sm-10 col-md-9 col-lg-10 col-xl-11">
                                                                    <span>
                                                                        None
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-check">
                                            <input {{ in_array(\App\Models\Item::ITEM_SUBMITTED, $filter_item_status) ? 'checked' : '' }} name="filter_item_status[]" class="form-check-input" type="checkbox" value="{{ \App\Models\Item::ITEM_SUBMITTED }}" id="filter_item_status_{{ \App\Models\Item::ITEM_SUBMITTED }}">
                                            <label class="form-check-label" for="filter_item_status_{{ \App\Models\Item::ITEM_SUBMITTED }}">
                                                {{ __('backend.item.submitted') }}
                                            </label>
                                        </div>

                                        <div class="form-check">
                                            <input {{ in_array(\App\Models\Item::ITEM_PUBLISHED, $filter_item_status) ? 'checked' : '' }} name="filter_item_status[]" class="form-check-input" type="checkbox" value="{{ \App\Models\Item::ITEM_PUBLISHED }}" id="filter_item_status_{{ \App\Models\Item::ITEM_PUBLISHED }}">
                                            <label class="form-check-label" for="filter_item_status_{{ \App\Models\Item::ITEM_PUBLISHED }}">
                                                {{ __('backend.item.published') }}
                                            </label>
                                        </div>

                                        <div class="form-check">
                                            <input {{ in_array(\App\Models\Item::ITEM_SUSPENDED, $filter_item_status) ? 'checked' : '' }} name="filter_item_status[]" class="form-check-input" type="checkbox" value="{{ \App\Models\Item::ITEM_SUSPENDED }}" id="filter_item_status_{{ \App\Models\Item::ITEM_SUSPENDED }}">
                                            <label class="form-check-label" for="filter_item_status_{{ \App\Models\Item::ITEM_SUSPENDED }}">
                                        ...
                                        <div class="form-check">
                                            <input {{ in_array(\App\Models\Item::ITEM_FEATURED, $filter_item_featured) ? 'checked' : '' }} name="filter_item_featured[]" class="form-check-input" type="checkbox" value="{{ \App\Models\Item::ITEM_FEATURED }}" id="filter_item_featured_{{ \App\Models\Item::ITEM_FEATURED }}">
                                            <label class="form-check-label" for="filter_item_featured_{{ \App\Models\Item::ITEM_FEATURED }}">
                                                {{ __('prefer_country.featured') }}
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input {{ in_array(\App\Models\Item::ITEM_NOT_FEATURED, $filter_item_featured) ? 'checked' : '' }} name="filter_item_featured[]" class="form-check-input" type="checkbox" value="{{ \App\Models\Item::ITEM_NOT_FEATURED }}" id="filter_item_featured_{{ \App\Models\Item::ITEM_NOT_FEATURED }}">
                                            <label class="form-check-label" for="filter_item_featured_{{ \App\Models\Item::ITEM_NOT_FEATURED }}">
                                        ...
                                        <div class="form-check">
                                            <input {{ in_array(\App\Models\Item::ITEM_TYPE_REGULAR, $filter_item_type) ? 'checked' : '' }} name="filter_item_type[]" class="form-check-input" type="checkbox" value="{{ \App\Models\Item::ITEM_TYPE_REGULAR }}" id="filter_item_type_{{ \App\Models\Item::ITEM_TYPE_REGULAR }}">
                                            <label class="form-check-label" for="filter_item_type_{{ \App\Models\Item::ITEM_TYPE_REGULAR }}">
                                                {{ __('theme_alaadin.online-listing.regular-listing') }}
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input {{ in_array(\App\Models\Item::ITEM_TYPE_ONLINE, $filter_item_type) ? 'checked' : '' }} name="filter_item_type[]" class="form-check-input" type="checkbox" value="{{ \App\Models\Item::ITEM_TYPE_ONLINE }}" id="filter_item_type_{{ \App\Models\Item::ITEM_TYPE_ONLINE }}">
                                            <label class="form-check-label" for="filter_item_type_{{ \App\Models\Item::ITEM_TYPE_ONLINE }}">
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <select class="selectpicker form-control @error('filter_sort_by') is-invalid @enderror" name="filter_sort_by" id="filter_sort_by">
                                            <option value="{{ \App\Models\Item::ITEMS_SORT_BY_NEWEST_CREATED }}" {{ $filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_NEWEST_CREATED ? 'selected' : '' }}>{{ __('prefer_country.item-sort-by-newest-created') }}</option>
                                            <option value="{{ \App\Models\Item::ITEMS_SORT_BY_OLDEST_CREATED }}" {{ $filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_OLDEST_CREATED ? 'selected' : '' }}>{{ __('prefer_country.item-sort-by-oldest-created') }}</option>

                                            <option value="{{ \App\Models\Item::ITEMS_SORT_BY_NEWEST_UPDATED }}" {{ $filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_NEWEST_UPDATED ? 'selected' : '' }}>{{ __('prefer_country.item-sort-by-newest-updated') }}</option>
                                            <option value="{{ \App\Models\Item::ITEMS_SORT_BY_OLDEST_UPDATED }}" {{ $filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_OLDEST_UPDATED ? 'selected' : '' }}>{{ __('prefer_country.item-sort-by-oldest-updated') }}</option>
                                            ...
                                            <option value="{{ \App\Models\Item::ITEMS_SORT_BY_MOST_RELEVANT }}" {{ $filter_sort_by == \App\Models\Item::ITEMS_SORT_BY_MOST_RELEVANT ? 'selected' : '' }}>{{ __('item_search.most-relevant') }}</option>
                                        </select>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        ...
                                        <select class="selectpicker form-control @error('filter_count_per_page') is-invalid @enderror" name="filter_count_per_page" id="filter_count_per_page">
                                            <option value="{{ \App\Models\Item::COUNT_PER_PAGE_10  }}" {{ $filter_count_per_page == \App\Models\Item::COUNT_PER_PAGE_10 ? 'selected' : '' }}>{{ __('importer_csv.import-listing-per-page-10') }}</option>
                                            <option value="{{ \App\Models\Item::COUNT_PER_PAGE_25 }}" {{ $filter_count_per_page == \App\Models\Item::COUNT_PER_PAGE_25 ? 'selected' : '' }}>{{ __('importer_csv.import-listing-per-page-25') }}</option>
                                            <option value="{{ \App\Models\Item::COUNT_PER_PAGE_50 }}" {{ $filter_count_per_page == \App\Models\Item::COUNT_PER_PAGE_50 ? 'selected' : '' }}>{{ __('importer_csv.import-listing-per-page-50') }}</option>
                                            <option value="{{ \App\Models\Item::COUNT_PER_PAGE_100 }}" {{ $filter_count_per_page == \App\Models\Item::COUNT_PER_PAGE_100 ? 'selected' : '' }}>{{ __('importer_csv.import-listing-per-page-100') }}</option>
                                            <option value="{{ \App\Models\Item::COUNT_PER_PAGE_250 }}" {{ $filter_count_per_page == \App\Models\Item::COUNT_PER_PAGE_250 ? 'selected' : '' }}>{{ __('importer_csv.import-listing-per-page-250') }}</option>
                                            <option value="{{ \App\Models\Item::COUNT_PER_PAGE_500 }}" {{ $filter_count_per_page == \App\Models\Item::COUNT_PER_PAGE_500 ? 'selected' : '' }}>{{ __('importer_csv.import-listing-per-page-500') }}</option>
                                            <option value="{{ \App\Models\Item::COUNT_PER_PAGE_1000 }}" {{ $filter_count_per_page == \App\Models\Item::COUNT_PER_PAGE_1000 ? 'selected' : '' }}>{{ __('importer_csv.import-listing-per-page-1000') }}</option>
                                        </select>
