...
{{--                            {{ __('item_claim.unclaimed') . ", " . __('item_claim.item-posted-by') . " " . $item->user->name }}--}}
                    ...
                    <p>
                        ...
                        {{ $item->item_address_hide == \App\Models\Item::ITEM_ADDR_NOT_HIDE ? $item->item_address . ', ' : '' }} {{ $item->city->city_name . ', ' . $item->state->state_name . ' ' . $item->item_postal_code }}
                        @else
                            <span class="bg-primary text-white pl-1 pr-1 rounded">{{ __('theme_alaadin.online-listing.online-listing') }}</span>
                        @endif
                    </p>
                    <hr/>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <select class="custom-select" name="item_section_position">
                                    <option value="{{ \App\Models\ItemSection::POSITION_AFTER_BREADCRUMB }}" {{ old('item_section_position') == \App\Models\ItemSection::POSITION_AFTER_BREADCRUMB ? 'selected' : '' }}>{{ __('item_section.position-after-breadcrumb') }}</option>
                                    <option value="{{ \App\Models\ItemSection::POSITION_AFTER_GALLERY }}" {{ old('item_section_position') == \App\Models\ItemSection::POSITION_AFTER_GALLERY ? 'selected' : '' }}>{{ __('item_section.position-after-gallery') }}</option>
                                    <option value="{{ \App\Models\ItemSection::POSITION_AFTER_DESCRIPTION }}" {{ old('item_section_position') == \App\Models\ItemSection::POSITION_AFTER_DESCRIPTION ? 'selected' : '' }}>{{ __('item_section.position-after-description') }}</option>
                                    <option value="{{ \App\Models\ItemSection::POSITION_AFTER_LOCATION_MAP }}" {{ old('item_section_position') == \App\Models\ItemSection::POSITION_AFTER_LOCATION_MAP ? 'selected' : '' }}>{{ __('item_section.position-after-location-map') }}</option>
                                    <option value="{{ \App\Models\ItemSection::POSITION_AFTER_FEATURES }}" {{ old('item_section_position') == \App\Models\ItemSection::POSITION_AFTER_FEATURES ? 'selected' : '' }}>{{ __('item_section.position-after-features') }}</option>
                                    <option value="{{ \App\Models\ItemSection::POSITION_AFTER_REVIEWS }}" {{ old('item_section_position') == \App\Models\ItemSection::POSITION_AFTER_REVIEWS ? 'selected' : '' }}>{{ __('item_section.position-after-reviews') }}</option>
                                    <option value="{{ \App\Models\ItemSection::POSITION_AFTER_COMMENTS }}" {{ old('item_section_position') == \App\Models\ItemSection::POSITION_AFTER_COMMENTS ? 'selected' : '' }}>{{ __('item_section.position-after-comments') }}</option>
                                    <option value="{{ \App\Models\ItemSection::POSITION_AFTER_SHARE }}" {{ old('item_section_position') == \App\Models\ItemSection::POSITION_AFTER_SHARE ? 'selected' : '' }}>{{ __('item_section.position-after-share') }}</option>
                                </select>
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <select class="custom-select" name="item_section_status">
                                    <option value="{{ \App\Models\ItemSection::STATUS_DRAFT }}" {{ old('item_section_status') == \App\Models\ItemSection::STATUS_DRAFT ? 'selected' : '' }}>{{ __('item_section.item-section-status-draft') }}</option>
                                    <option value="{{ \App\Models\ItemSection::STATUS_PUBLISHED }}" {{ old('item_section_status') == \App\Models\ItemSection::STATUS_PUBLISHED ? 'selected' : '' }}>{{ __('item_section.item-section-status-published') }}</option>
                                </select>
            ...
            @if($item_sections_after_breadcrumb->count() > 0)
                ...
                @foreach($item_sections_after_breadcrumb as $item_sections_after_breadcrumb_key => $after_breadcrumb_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_sections_after_breadcrumb_key%2 == 0 ? 'bg-light' : '' }} {{ $after_breadcrumb_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            <span class="text-gray-800">{{ $after_breadcrumb_section->item_section_title }}</span>
                            |
                            @if($after_breadcrumb_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT)
                                <span class="bg-warning pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-draft') }}
                                </span>
                            @elseif($after_breadcrumb_section->item_section_status == \App\Models\ItemSection::STATUS_PUBLISHED)
            ...
            @if($item_section_after_gallery->count() > 0)
                ...
                @foreach($item_section_after_gallery as $item_section_after_gallery_key => $after_gallery_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_section_after_gallery_key%2 == 0 ? 'bg-light' : '' }} {{ $after_gallery_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            <span class="text-gray-800">{{ $after_gallery_section->item_section_title }}</span>
                            |
                            @if($after_gallery_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT)
                                <span class="bg-warning pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-draft') }}
                                </span>
                            @elseif($after_gallery_section->item_section_status == \App\Models\ItemSection::STATUS_PUBLISHED)
                                <span class="bg-success pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-published') }}
                                </span>
                            @endif
            ...
            @if($item_section_after_description->count() > 0)
                ...
                @foreach($item_section_after_description as $item_section_after_description_key => $after_description_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_section_after_description_key%2 == 0 ? 'bg-light' : '' }} {{ $after_description_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            <span class="text-gray-800">{{ $after_description_section->item_section_title }}</span>
                            |
                            @if($after_description_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT)
                                <span class="bg-warning pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-draft') }}
                                </span>
                            @elseif($after_description_section->item_section_status == \App\Models\ItemSection::STATUS_PUBLISHED)
                                <span class="bg-success pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-published') }}
                                </span>
                            @endif
            ...
            @if($item_section_after_location_map->count() > 0)
                ...
                @foreach($item_section_after_location_map as $item_section_after_location_map_key => $after_location_map_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_section_after_location_map_key%2 == 0 ? 'bg-light' : '' }} {{ $after_location_map_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            <span class="text-gray-800">{{ $after_location_map_section->item_section_title }}</span>
                            |
                            @if($after_location_map_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT)
                                <span class="bg-warning pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-draft') }}
                                </span>
                            @elseif($after_location_map_section->item_section_status == \App\Models\ItemSection::STATUS_PUBLISHED)
                                <span class="bg-success pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-published') }}
                                </span>
                            @endif
            ...
            @if($item_section_after_features->count() > 0)
                ...
                @foreach($item_section_after_features as $item_section_after_features_key => $after_features_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_section_after_features_key%2 == 0 ? 'bg-light' : '' }} {{ $after_features_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            <span class="text-gray-800">{{ $after_features_section->item_section_title }}</span>
                            |
                            @if($after_features_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT)
                                <span class="bg-warning pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-draft') }}
                                </span>
                            @elseif($after_features_section->item_section_status == \App\Models\ItemSection::STATUS_PUBLISHED)
                                <span class="bg-success pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-published') }}
                                </span>
                            @endif
            ...
            @if($item_section_after_reviews->count() > 0)
                ...
                @foreach($item_section_after_reviews as $item_section_after_reviews_key => $after_reviews_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_section_after_reviews_key%2 == 0 ? 'bg-light' : '' }} {{ $after_reviews_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            <span class="text-gray-800">{{ $after_reviews_section->item_section_title }}</span>
                            |
                            @if($after_reviews_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT)
                                <span class="bg-warning pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-draft') }}
                                </span>
                            @elseif($after_reviews_section->item_section_status == \App\Models\ItemSection::STATUS_PUBLISHED)
                                <span class="bg-success pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-published') }}
                                </span>
                            @endif
            ...
            @if($item_section_after_comments->count() > 0)
                ...
                @foreach($item_section_after_comments as $item_section_after_comments_key => $after_comments_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_section_after_comments_key%2 == 0 ? 'bg-light' : '' }} {{ $after_comments_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            <span class="text-gray-800">{{ $after_comments_section->item_section_title }}</span>
                            |
                            @if($after_comments_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT)
                                <span class="bg-warning pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-draft') }}
                                </span>
                            @elseif($after_comments_section->item_section_status == \App\Models\ItemSection::STATUS_PUBLISHED)
                                <span class="bg-success pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-published') }}
                                </span>
                            @endif
            ...
            @if($item_section_after_share->count() > 0)
                ...
                @foreach($item_section_after_share as $item_section_after_share_key => $after_share_section)
                    <div class="row align-items-center pt-2 mb-2 {{ $item_section_after_share_key%2 == 0 ? 'bg-light' : '' }} {{ $after_share_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT ? 'border-left-warning' : 'border-left-success' }}">
                        <div class="col-lg-8 col-md-7 col-sm-12">
                            <span class="text-gray-800">{{ $after_share_section->item_section_title }}</span>
                            |
                            @if($after_share_section->item_section_status == \App\Models\ItemSection::STATUS_DRAFT)
                                <span class="bg-warning pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-draft') }}
                                </span>
                            @elseif($after_share_section->item_section_status == \App\Models\ItemSection::STATUS_PUBLISHED)
                                <span class="bg-success pl-1 text-white text-sm rounded mr-1">
                                    {{ __('item_section.item-section-status-published') }}
                                </span>
                            @endif
