...
@section('content')
                ...
                <div class="col-12">
                    @if($item_owner->isUser())
                        <div class="alert alert-warning" role="alert">
                            ...
                            <a href="{{ route('admin.users.edit', ['user' => $item_owner->id]) }}" class="alert-link"
                               target="_blank">
                ...
                <div class="col-12">
                    ...
                    <div class="row mb-2">
                        <div class="col-12">
                            ...
                            @if($item->item_status == \App\Models\Item::ITEM_SUBMITTED)
                                <span class="text-warning">{{ __('backend.item.submitted') }}</span>
                            @elseif($item->item_status == \App\Models\Item::ITEM_PUBLISHED)
                                <span class="text-success">{{ __('backend.item.published') }}</span>
                            @elseif($item->item_status == \App\Models\Item::ITEM_SUSPENDED)
                    ...
                    <div class="row mb-2">
                        <div class="col-12">
                            ...
                            @if($item->item_status == \App\Models\Item::ITEM_PUBLISHED)
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            @if($item->item_status == \App\Models\Item::ITEM_PUBLISHED)
                                <form class="float-left pr-1" action="{{ route('admin.items.disapprove', $item) }}"
                                      method="POST">
                                    @csrf
                                    @method('PUT')
                                ...
                                <form class="float-left pr-1" action="{{ route('admin.items.suspend', $item) }}"
                                      method="POST">
                                    @csrf
                                    @method('PUT')
                            ...
                            @elseif($item->item_status == \App\Models\Item::ITEM_SUBMITTED)
                                <form class="float-left pr-1" action="{{ route('admin.items.approve', $item) }}"
                                      method="POST">
                                    @csrf
                                    @method('PUT')
                            ...
                            <a class="btn btn-sm btn-primary"
                               href="{{ route('admin.items.sections.index', ['item' => $item]) }}">
                            ...
                            <form action="{{route('items.ad.update', $item)}}"
                                  method="post"
                                  class="container row my-3 align-items-end">
                                @csrf
                                  <div class="col-md-6 mx-2">
                                    <label class="label-primary">{{__('backend.sidebar.ads')}}</label>
                                    <select id="ad_id[]"
                                            class="selectpicker form-control @error('ad_id') is-invalid @enderror"
                                            multiple
                                            name="ad_id[]" data-live-search="true"
                                    >
                                       @foreach($ads as $ad)
                                            <option value="{{$ad->id}}"
                                                {{ in_array($ad->id, $item->ads?->pluck('id')->toArray() ?? []) ? 'selected' : '' }}
                                            >{{ $ad->advertisement_name  }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-12 col-md-6 mb-3 mb-md-0">
                                        <div class="form-check">
                                            <input
                                                {{ (old('item_type') ? old('item_type') : $item->item_type) == \App\Models\Item::ITEM_TYPE_REGULAR ? 'checked' : '' }} class="form-check-input"
                                                type="radio" name="item_type" id="item_type_regular"
                                                value="{{ \App\Models\Item::ITEM_TYPE_REGULAR }}"
                                                aria-describedby="item_type_regularHelpBlock">
                                            <label class="form-check-label" for="item_type_regular">
                                                {{ __('theme_alaadin.online-listing.regular-listing') }}
                                            </label>
                                            <small id="item_type_regularHelpBlock" class="form-text text-muted">
                                                {{ __('theme_alaadin.online-listing.regular-listing-help') }}
                                            </small>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-check">
                                            <input
                                                {{ (old('item_type') ? old('item_type') : $item->item_type) == \App\Models\Item::ITEM_TYPE_ONLINE ? 'checked' : '' }} class="form-check-input"
                                                type="radio" name="item_type" id="item_type_online"
                                                value="{{ \App\Models\Item::ITEM_TYPE_ONLINE }}"
                                                aria-describedby="item_type_onlineHelpBlock">
                                            <label class="form-check-label" for="item_type_online">
                                                {{ __('theme_alaadin.online-listing.online-listing') }}
                                            </label>
                                            <small id="item_type_onlineHelpBlock" class="form-text text-muted">
                                                {{ __('theme_alaadin.online-listing.online-listing-help') }}
                                            </small>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row border-left-primary mb-4">
                            <div class="col-12">
                                ...
                                <div class="form-row mb-3">
                                    {{--                                    @if($plan?->check_plan(1))--}}
                                    <div class="col-md-3">
                                        <label for="item_title"
                                               class="text-black">{{ __('backend.item.title') }}</label>
                                        <input id="item_title" type="text"
                                               class="form-control @error('item_title') is-invalid @enderror"
                                               name="item_title"
                                               value="{{ old('item_title') ? old('item_title') : $item->item_title }}">
                                        @error('item_title')
                                    ...
                                    <div class="col-md-2">
                                        <label for="item_status"
                                               class="text-black">{{ __('backend.item.status') }}</label>
                                        <select
                                            class="selectpicker form-control @error('item_status') is-invalid @enderror"
                                            name="item_status">

                                            <option
                                                {{ $item->item_status == \App\Models\Item::ITEM_SUBMITTED ? 'selected' : '' }} value="{{ \App\Models\Item::ITEM_SUBMITTED }}">{{ __('backend.item.submitted') }}</option>
                                            <option
                                                {{ $item->item_status == \App\Models\Item::ITEM_PUBLISHED ? 'selected' : '' }} value="{{ \App\Models\Item::ITEM_PUBLISHED }}">{{ __('backend.item.published') }}</option>
                                            <option
                                                {{ $item->item_status == \App\Models\Item::ITEM_SUSPENDED ? 'selected' : '' }} value="{{ \App\Models\Item::ITEM_SUSPENDED }}">{{ __('backend.item.suspended') }}</option>
                                    ...
                                    {{--                                    @if($plan?->check_plan(3))--}}
                                    <div class="col-md-2">
                                        <label for="item_featured"
                                               class="text-black">{{ __('backend.item.featured') }}</label>
                                        <select
                                            class="selectpicker form-control @error('item_featured') is-invalid @enderror"
                                            name="item_featured">

                                            <option
                                                {{ $item->item_featured == \App\Models\Item::ITEM_NOT_FEATURED ? 'selected' : '' }} value="{{ \App\Models\Item::ITEM_NOT_FEATURED }}">{{ __('backend.shared.no') }}</option>
                                            <option
                                                {{ $item->item_featured == \App\Models\Item::ITEM_FEATURED ? 'selected' : '' }} value="{{ \App\Models\Item::ITEM_FEATURED }}">{{ __('backend.shared.yes') }}</option>
                                    ...
                                    {{--                                    @if($plan?->check_plan(4))--}}
                                    <div class="col-md-5">
                                        <label for="item_address"
                                               class="text-black">{{ __('backend.item.address') }}</label>
                                        <input id="item_address" type="text"
                                               class="form-control @error('item_address') is-invalid @enderror"
                                               name="item_address"
                                               value="{{ old('item_address') ? old('item_address') : $item->item_address }}">
                                        @error('item_address')
                                        <span class="invalid-tooltip">
                                    <strong>{{ $message }}</strong>
                                </span>
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check form-check-inline">
                                            <input
                                                {{ $item->item_address_hide == \App\Models\Item::ITEM_ADDR_HIDE ? 'checked' : '' }} class="form-check-input"
                                                type="checkbox" id="item_address_hide" name="item_address_hide"
                                                value="{{ \App\Models\Item::ITEM_ADDR_HIDE }}">
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select id="select_country_id"
                                            ...
                                            <option selected
                                                    value="0">{{ __('prefer_country.select-country') }}</option>
                                            @foreach($all_countries as $all_countries_key => $country)
                                                @if($country->country_status == \App\Models\Country::COUNTRY_STATUS_ENABLE || ($country->country_status == \App\Models\Country::COUNTRY_STATUS_DISABLE && $item->country_id == $country->id))
                                                    <option
                                                        value="{{ $country->id }}" {{ (old('country_id') ? old('country_id') : $item->country_id) == $country->id ? 'selected' : '' }}>{{ $country->country_name }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                        @error('country_id')
                                    ...
                                    <div class="col-md-3">
                                        <label for="select_state_id"
                                               class="text-black">{{ __('backend.state.state') }}</label>
                                        <select id="select_state_id"
                                                class="selectpicker form-control @error('state_id') is-invalid @enderror"
                                            ...
                                            @foreach($all_states as $key => $state)
                                                <option
                                                    {{ $item->state_id == $state->id ? 'selected' : '' }} value="{{ $state->id }}">{{ $state->state_name }}</option>
                                            @endforeach
                                        </select>
                                        @error('state_id')
                                        <span class="invalid-tooltip">
                                    ...
                                    <div class="col-md-3">
                                        <label for="select_city_id"
                                               class="text-black">{{ __('backend.city.city') }}</label>
                                        <select id="select_city_id"
                                                class="selectpicker form-control @error('city_id') is-invalid @enderror"
                                            ...
                                            @foreach($all_cities as $key => $city)
                                                <option
                                                    {{ $item->city_id == $city->id ? 'selected' : '' }} value="{{ $city->id }}">{{ $city->city_name }}</option>
                                            @endforeach
                                        </select>
                                        @error('city_id')
                                        <span class="invalid-tooltip">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input id="item_postal_code" type="text"
                                               ...
                                               value="{{ old('item_postal_code') ? old('item_postal_code') : $item->item_postal_code }}">
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input id="item_lat" type="text"
                                               class="form-control @error('item_lat') is-invalid @enderror"
                                               name="item_lat"
                                               value="{{ old('item_lat') ? old('item_lat') : $item->item_lat }}"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input id="item_lng" type="text"
                                               class="form-control @error('item_lng') is-invalid @enderror"
                                               name="item_lng"
                                               value="{{ old('item_lng') ? old('item_lng') : $item->item_lng }}"
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input id="item_youtube_id" type="text"
                                               ...
                                               value="{{ old('item_youtube_id') ? old('item_youtube_id') : $item->item_youtube_id }}">
                                ...
                                <div class="form-row mb-3 align-items-end">
                                    ...
                                    <div class="col-md-3">
                                        <label for="item_phone"
                                               class="text-black">{{ __('backend.item.phone') }}</label>
                                        <input id="item_phone" type="text"
                                               class="form-control @error('item_phone') is-invalid @enderror"
                                               name="item_phones[]">
                                        @error('item_phone')
                                        <span class="invalid-tooltip">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="form-row mb-3" id="item_phones_container">
                                    @if(old('item_phones'))
                                        @foreach(old('item_phones') as $key => $phone)
                                        ...
                                        @endforeach
                                    @elseif($item->itemPhones->count() > 0)
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea
                                            ...
                                            name="item_description">{{ old('item_description') ? old('item_description') : $item->item_description }}</textarea>
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="item_website" type="text"
                                               class="form-control @error('item_website') is-invalid @enderror"
                                               name="item_website"
                                               value="{{ old('item_website') ? old('item_website') : $item->item_website }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="item_social_facebook" type="text"
                                               ...
                                               value="{{ old('item_social_facebook') ? old('item_social_facebook') : $item->item_social_facebook }}">
                                        <small id="linkHelpBlock" class="form-text text-muted">
                                            {{ __('backend.shared.url-help') }}
                                        </small>
                                    ...
                                    {{--                                    @if($plan?->check_plan(10))--}}
                                    <div class="col-md-4">
                                        <label for="item_social_tiktok" class="text-black">
                                            <i class="fa-brands fa-tiktok"></i>
                                            {{ __('backend.item.tiktok') }}
                                        </label>
                                        <input id="item_social_tiktok" type="text"
                                               class="form-control @error('item_social_tiktok') is-invalid @enderror"
                                               name="item_social_tiktok"
                                               value="{{ old('item_social_tiktok') ? old('item_social_tiktok') : $item->item_social_tiktok }}">
                                        <small id="linkHelpBlock" class="form-text text-muted">
                                            {{ __('backend.shared.url-help') }}
                                        </small>
                                        @error('item_social_tiktok')
                                        <span class="invalid-tooltip">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        @enderror
                                    ...
                                    {{--                                    @if($plan?->check_plan(11))--}}
                                    <div class="col-md-4">
                                        <label for="item_social_pinterest" class="text-black">
                                            <i class="fa-brands fa-pinterest-square"></i>
                                            {{ __('backend.item.pinterest') }}
                                        </label>
                                        <input id="item_social_pinterest" type="text"
                                               class="form-control @error('item_social_pinterest') is-invalid @enderror"
                                               name="item_social_pinterest"
                                               value="{{ old('item_social_pinterest') ? old('item_social_pinterest') : $item->item_social_pinterest }}">
                                        <small id="linkHelpBlock" class="form-text text-muted">
                                            {{ __('backend.shared.url-help') }}
                                        </small>
                                        @error('item_social_pinterest')
                                        <span class="invalid-tooltip">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        @enderror
                                    ...
                                    {{--                                    @if($plan?->check_plan(12))--}}
                                    <div class="col-md-4">
                                        <label for="item_social_telegram" class="text-black">
                                            <i class="fa-brands fa-telegram-square"></i>
                                            {{ __('item_whatsapp_instagram.item-social-telegram') }}
                                        </label>
                                        <input id="item_social_telegram" type="text"
                                               class="form-control @error('item_social_telegram') is-invalid @enderror"
                                               name="item_social_telegram"
                                               value="{{ old('item_social_telegram') ? old('item_social_telegram') : $item->item_social_telegram }}">
                                        <small id="linkHelpBlock" class="form-text text-muted">
                                            {{ __('item_whatsapp_instagram.item-social-telegram-help') }}
                                        </small>
                                        @error('item_social_telegram')
                                        <span class="invalid-tooltip">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        @enderror
                                    ...
                                    <div class="col-md-4">
                                        <label for="item_social_youtube" class="text-black">
                                            ...
                                            {{ __('backend.item.youtube') }}
                                        </label>
                                        <input id="item_social_youtube" type="text"
                                               class="form-control @error('item_social_youtube') is-invalid @enderror"
                                               name="item_social_youtube"
                                               value="{{ old('item_social_youtube') ? old('item_social_youtube') : $item->item_social_youtube }}">
                                        <small id="linkHelpBlock" class="form-text text-muted">
                                            {{ __('backend.shared.url-help') }}
                                        </small>
                                        @error('item_social_youtube')
                                        <span class="invalid-tooltip">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        @enderror
                                    ...
                                    {{--                                    @if($plan?->check_plan(16))--}}
                                    <div class="col-md-4">
                                        <label for="item_social_snapchat" class="text-black">
                                            <i class="fa-brands fa-snapchat-square"></i>
                                            {{ __('backend.item.snapchat') }}
                                        </label>
                                        <input id="item_social_snapchat" type="text"
                                               class="form-control @error('item_social_snapchat') is-invalid @enderror"
                                               name="item_social_snapchat"
                                               value="{{ old('item_social_snapchat') ? old('item_social_snapchat') : $item->item_social_snapchat }}">
                                        <small id="linkHelpBlock" class="form-text text-muted">
                                            {{ __('backend.shared.url-help') }}
                                        </small>
                                        @error('item_social_snapchat')
                                        <span class="invalid-tooltip">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        @enderror
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="item_social_twitter" type="text"
                                               ...
                                               value="{{ old('item_social_twitter') ? old('item_social_twitter') : $item->item_social_twitter }}">
                                        <small id="linkHelpBlock" class="form-text text-muted">
                                            {{ __('backend.shared.url-help') }}
                                        </small>
                                    ...
                                    <div class="col-md-4">
                                        <label for="item_social_email" class="text-black">
                                            ...
                                            {{  __('role_permission.item.listing-owner') }}
                                        </label>
                                        <input id="item_social_email" type="text"
                                               class="form-control @error('item_social_email') is-invalid @enderror"
                                               name="item_social_email"
                                               value="{{ old('item_social_email') ? old('item_social_email') : $item->item_social_email }}">
                                        @error('item_social_email')
                                        <span class="invalid-tooltip">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        @enderror
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="item_social_linkedin" type="text"
                                               ...
                                               value="{{ old('item_social_linkedin') ? old('item_social_linkedin') : $item->item_social_linkedin }}">
                                        <small id="linkHelpBlock" class="form-text text-muted">
                                            {{ __('backend.shared.url-help') }}
                                        </small>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="item_social_instagram" type="text"
                                               class="form-control @error('item_social_instagram') is-invalid @enderror"
                                               name="item_social_instagram"
                                               value="{{ old('item_social_instagram') ? old('item_social_instagram') : $item->item_social_instagram }}">
                                        <small id="linkHelpBlock" class="form-text text-muted">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="item_social_whatsapp" type="text"
                                               class="form-control @error('item_social_whatsapp') is-invalid @enderror"
                                               name="item_social_whatsapp"
                                               value="{{ old('item_social_whatsapp') ? old('item_social_whatsapp') : $item->item_social_whatsapp }}">
                                        <small id="linkHelpBlock" class="form-text text-muted">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-row mb-3">
                                    <div class="col-12 col-md-6">
                                        <label for="item_hour_time_zone"
                                               class="text-black">{{ __('item_hour.timezone') }}</label>
                                        <select id="item_hour_time_zone"
                                                class="selectpicker form-control @error('item_hour_time_zone') is-invalid @enderror"
                                            ...
                                            @foreach($time_zone_identifiers as $time_zone_identifiers_key => $time_zone_identifier)
                                                <option
                                                    value="{{ $time_zone_identifier }}" {{ (old('item_hour_time_zone') ? old('item_hour_time_zone') : $item->item_hour_time_zone) == $time_zone_identifier ? 'selected' : '' }}>{{ $time_zone_identifier }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label for="item_hour_show_hours"
                                               class="text-black">{{ __('item_hour.show-open-hour') }}</label>
                                        <select id="item_hour_show_hours"
                                                class="selectpicker form-control @error('item_hour_show_hours') is-invalid @enderror"
                                                name="item_hour_show_hours" data-live-search="true">
                                            <option
                                                value="{{ \App\Models\Item::ITEM_HOUR_SHOW }}" {{ (old('item_hour_show_hours') ? old('item_hour_show_hours') : $item->item_hour_show_hours) == \App\Models\Item::ITEM_HOUR_SHOW ? 'selected' : '' }}>{{ __('item_hour.show-hour') }}</option>
                                            <option
                                                value="{{ \App\Models\Item::ITEM_HOUR_NOT_SHOW }}" {{ (old('item_hour_show_hours') ? old('item_hour_show_hours') : $item->item_hour_show_hours) == \App\Models\Item::ITEM_HOUR_NOT_SHOW ? 'selected' : '' }}>{{ __('item_hour.not-show-hour') }}</option>
                                        </select>
                                        <small class="form-text text-muted">
                                ...
                                <div class="form-row mb-3 align-items-end">
                                    <div class="col-12 col-md-2">
                                        <label for="item_hour_day_of_week"
                                               class="text-black">{{ __('item_hour.day-of-week') }}</label>
                                        <select id="item_hour_day_of_week" class="selectpicker form-control"
                                                name="item_hour_day_of_week" data-live-search="true">
                                            <option
                                                value="{{ \App\Models\ItemHour::DAY_OF_WEEK_MONDAY }}">{{ __('item_hour.monday') }}</option>
                                            <option
                                                value="{{ \App\Models\ItemHour::DAY_OF_WEEK_TUESDAY }}">{{ __('item_hour.tuesday') }}</option>
                                            <option
                                                value="{{ \App\Models\ItemHour::DAY_OF_WEEK_WEDNESDAY }}">{{ __('item_hour.wednesday') }}</option>
                                            <option
                                                value="{{ \App\Models\ItemHour::DAY_OF_WEEK_THURSDAY }}">{{ __('item_hour.thursday') }}</option>
                                            <option
                                                value="{{ \App\Models\ItemHour::DAY_OF_WEEK_FRIDAY }}">{{ __('item_hour.friday') }}</option>
                                            <option
                                                value="{{ \App\Models\ItemHour::DAY_OF_WEEK_SATURDAY }}">{{ __('item_hour.saturday') }}</option>
                                            <option
                                                value="{{ \App\Models\ItemHour::DAY_OF_WEEK_SUNDAY }}">{{ __('item_hour.sunday') }}</option>
                                        </select>
                                    </div>
                                    <div class="col-12 col-md-2">
                                        <label for="item_hour_open_time_open_hour"
                                               class="text-black">{{ __('item_hour.item-hour-open-hour') }}</label>
                                    ...
                                    <div class="col-12 col-md-2">
                                        <label for="item_hour_open_time_open_minute"
                                               class="text-black">{{ __('item_hour.item-hour-open-minute') }}</label>
                                    ...
                                    <div class="col-12 col-md-2">
                                        <label for="item_hour_open_time_close_hour"
                                               class="text-black">{{ __('item_hour.item-hour-close-hour') }}</label>
                                    ...
                                    <div class="col-12 col-md-2">
                                        <label for="item_hour_open_time_close_minute"
                                               class="text-black">{{ __('item_hour.item-hour-close-minute') }}</label>
                                ...
                                <div class="form-row mb-3" id="open_hour_added_hours">
                                    @foreach($item_hours as $item_hours_key => $item_hour)
                                        <div class="col-12 col-md-3">
                                            @if($item_hour->item_hour_day_of_week == \App\Models\ItemHour::DAY_OF_WEEK_MONDAY)
                                                {{ __('item_hour.monday') }}
                                            @elseif($item_hour->item_hour_day_of_week == \App\Models\ItemHour::DAY_OF_WEEK_TUESDAY)
                                                {{ __('item_hour.tuesday') }}
                                            @elseif($item_hour->item_hour_day_of_week == \App\Models\ItemHour::DAY_OF_WEEK_WEDNESDAY)
                                                {{ __('item_hour.wednesday') }}
                                            @elseif($item_hour->item_hour_day_of_week == \App\Models\ItemHour::DAY_OF_WEEK_THURSDAY)
                                                {{ __('item_hour.thursday') }}
                                            @elseif($item_hour->item_hour_day_of_week == \App\Models\ItemHour::DAY_OF_WEEK_FRIDAY)
                                                {{ __('item_hour.friday') }}
                                            @elseif($item_hour->item_hour_day_of_week == \App\Models\ItemHour::DAY_OF_WEEK_SATURDAY)
                                                {{ __('item_hour.saturday') }}
                                            @elseif($item_hour->item_hour_day_of_week == \App\Models\ItemHour::DAY_OF_WEEK_SUNDAY)
                                                {{ __('item_hour.sunday') }}
                                            @endif
                                            ...
                                            <a class="text-primary" href="#" data-toggle="modal"
                                               data-target="#editItemHourModal_{{ $item_hour->id }}">
                                                <i class="far fa-edit"></i>
                                            </a>
                                            <a class="text-danger" href="#" data-toggle="modal"
                                               data-target="#deleteItemHourModal_{{ $item_hour->id }}">
                                                <i class='far fa-trash-alt'></i>
                                            </a>
                                        </div>
                                    @endforeach
                                ...
                                <div class="form-row mb-3">
                                    <div class="col-12">
                                            <span
                                                class="text-gray-800">{{ __('item_hour.open-hour-exceptions') }}</span>
                                        <small class="form-text text-muted">
                                ...
                                <div class="form-row mb-3 align-items-end">
                                    <div class="col-12 col-md-2">
                                        <label for="item_hour_exception_date"
                                               class="text-black">{{ __('item_hour.open-hour-exception-date') }}</label>
                                        <input id="item_hour_exception_date" type="text"
                                               class="form-control date-picker-input"
                                               name="item_hour_exception_date"
                                               value=""
                                               placeholder="{{ __('item_hour.open-hour-exception-date-placeholder') }}">
                                    </div>
                                    <div class="col-12 col-md-2">
                                        ...
                                        <select id="item_hour_exception_open_time_open_hour"
                                            ...
                                            <option
                                                value="">{{ __('item_hour.open-hour-exception-close-all-day') }}</option>
                                            @for($full_hour=0; $full_hour<=24; $full_hour++)
                                                <option value="{{ $full_hour }}">{{ $full_hour }}</option>
                                            @endfor
                                        </select>
                                ...
                                <div class="form-row mb-3" id="open_hour_added_exceptions">
                                    @foreach($item_hour_exceptions as $item_hour_exceptions_key => $item_hour_exception)
                                        <div class="col-12 col-md-3">
                                            ...
                                            @endif
                                            <a class="text-primary" href="#" data-toggle="modal"
                                               data-target="#editItemHourExceptionModal_{{ $item_hour_exception->id }}">
                                                <i class="far fa-edit"></i>
                                            </a>
                                            <a class="text-danger" href="#" data-toggle="modal"
                                               data-target="#deleteItemHourExceptionModal_{{ $item_hour_exception->id }}">
                                                <i class='far fa-trash-alt'></i>
                                            </a>
                                        </div>
                                    @endforeach
                        ...
                        <div class="row border-left-primary mb-4">
                            <div class="col-12">
                                ...
                                <div class="form-row mb-3">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <span
                                            class="text-lg text-gray-800">{{ __('backend.item.feature-image') }}</span>
                                        <small class="form-text text-muted">
                                            ...
                                            <div class="col-8">
                                                ...
                                                @if(empty($item->item_image))
                                                    <img id="image_preview"
                                                         src="{{ asset('backend/images/placeholder/full_item_feature_image.webp') }}"
                                                         class="img-responsive">
                                                @else
                                                    <img id="image_preview"
                                                         src="{{ Storage::disk('public')->url('item/'. $item->item_image) }}"
                                                         class="img-responsive">
                                                @endif
                                    ...
                                    {{--                                    @if($plan?->check_plan(20))--}}
                                    <div class="col-12 col-md-6">
                                        <span
                                            class="text-lg text-gray-800">{{ __('backend.item.gallery-images') }}</span>
                                        <small class="form-text text-muted">
                                            {{ __('theme_alaadin.listing.gallery-upload-help', ['gallery_photos_count' => $setting_item_max_gallery_photos]) }}
                                        </small>
                                        @error('image_gallery')
                                        <span class="invalid-tooltip">
                                    <strong>{{ $message }}</strong>
                                                ...
                                                <div class="row" id="selected-images">
                                                    @foreach($item->galleries as $key => $gallery)
                                                        <div class="col-3 mb-2"
                                                             id="item_image_gallery_{{ $gallery->id }}">
                                                            <img class="item_image_gallery_img"
                                                                 src="{{ Storage::disk('public')->url('item/gallery/'. $gallery->item_image_gallery_name) }}">
                                                            <br/>
                                                            <button class="btn btn-danger btn-sm text-white mt-1"
                                                                    onclick="$(this).attr('disabled', true); deleteGallery({{ $gallery->id }});">{{ __('backend.shared.delete') }}</button>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control"
                                               ...
                                               value="{{$item->getTranslation('meta_title','en')}}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea id="meta_description" name="meta_description[en]"
                                                  rows="4"
                                                  class="form-control">{{$item->getTranslation('meta_description','en')}}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="metaKeywords">{{__('backend.meta_keywords')}}</label>
                                        <input type="text" id="meta_keywords"
                                               name="meta_keywords[en]"
                                               value="{{$item->getTranslation('meta_keywords','en')}}"
                                               class="form-control">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" id="alt_image"
                                               name="alt_image[en]" value="{{$item->getTranslation('alt_image','en')}}"
                                               class="form-control">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="url" id="canonical"
                                               name="canonical[en]" value="{{$item->getTranslation('canonical','en')}}"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="tab-pane fade show" id="nav-profile" role="tabpanel"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control"
                                               ...
                                               value="{{$item->getTranslation('meta_title','ar')}}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea id="meta_description" name="meta_description[ar]"
                                                  rows="4"
                                                  class="form-control">{{$item->getTranslation('meta_description','ar')}}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="metaKeywords">{{__('backend.meta_keywords')}}</label>
                                        <input type="text" id="meta_keywords"
                                               name="meta_keywords[ar]"
                                               value="{{$item->getTranslation('meta_keywords','ar')}}"
                                               class="form-control">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label for="alt_image">{{__('backend.alt_image')}}</label>
                                        <input type="text" id="alt_image"
                                               name="alt_image[ar]" value="{{$item->getTranslation('alt_image','ar')}}"
                                               class="form-control">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label for="canonical">{{__('backend.canonical')}}</label>
                                        <input type="url" id="canonical"
                                               name="canonical[ar]" value="{{$item->getTranslation('canonical','ar')}}"
                                               class="form-control">
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="categoriesModal" tabindex="-1" role="dialog" aria-labelledby="categoriesModal"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="update-item-category-form" action="{{ route('admin.item.category.update', $item) }}"
                          method="POST">
                        @csrf
                        @method('PUT')
                        <select size="{{ count($all_categories) }}" class="selectpicker form-control"
                                name="category" id="category" data-live-search="true" data-actions-box="true">
                            @foreach($all_categories as $key => $a_category)
                                <option
                                    {{ $item->category_id == $a_category->id? 'selected' : '' }} value="{{ $a_category['id'] }}">{{ $a_category['category_name'] }}</option>
                            @endforeach
                        </select>
                        @error('category')
                        <span class="invalid-tooltip">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success"
                            id="update-item-category-button">{{ __('categories.update-cat') }}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="itemSlugModal" tabindex="-1" role="dialog" aria-labelledby="itemSlugModal"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="update-item-slug-form" action="{{ route('admin.item.slug.update', ['item' => $item]) }}"
                          method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-12">
                                <div class="input-group mb-2">
                                    ...
                                    <input type="text" class="form-control" name="item_slug"
                                           value="{{ old('item_slug') ? old('item_slug') : $item->item_slug }}"
                                           id="item_slug">
                                </div>
                                <small class="form-text text-muted">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary"
                            data-dismiss="modal">{{ __('backend.shared.cancel') }}</button>
                    <button type="button" class="btn btn-success"
                            id="update-item-slug-button">{{ __('item_slug.update-url') }}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    @foreach($item_hours as $item_hours_key => $item_hour)
        <div class="modal fade" id="editItemHourModal_{{ $item_hour->id }}" tabindex="-1" role="dialog"
             aria-labelledby="editItemHourModal_{{ $item_hour->id }}" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"
                            id="exampleModalLongTitle">{{ __('item_hour.modal-edit-hours-title') }}</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form id="update-item-slug-form"
                          action="{{ route('admin.items.hours.update', ['item_hour' => $item_hour]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            @php
                            ...
                            <div class="form-row mb-3 align-items-end">
                                <div class="col-12 col-md-4">
                                    ...
                                    <select id="item_hour_day_of_week" class="selectpicker form-control"
                                            name="item_hour_day_of_week" data-live-search="true">
                                        <option
                                            value="{{ \App\Models\ItemHour::DAY_OF_WEEK_MONDAY }}" {{ $item_hour->item_hour_day_of_week == \App\Models\ItemHour::DAY_OF_WEEK_MONDAY ? 'selected' :'' }}>{{ __('item_hour.monday') }}</option>
                                        <option
                                            value="{{ \App\Models\ItemHour::DAY_OF_WEEK_TUESDAY }}" {{ $item_hour->item_hour_day_of_week == \App\Models\ItemHour::DAY_OF_WEEK_TUESDAY ? 'selected' :'' }}>{{ __('item_hour.tuesday') }}</option>
                                        <option
                                            value="{{ \App\Models\ItemHour::DAY_OF_WEEK_WEDNESDAY }}" {{ $item_hour->item_hour_day_of_week == \App\Models\ItemHour::DAY_OF_WEEK_WEDNESDAY ? 'selected' :'' }}>{{ __('item_hour.wednesday') }}</option>
                                        <option
                                            value="{{ \App\Models\ItemHour::DAY_OF_WEEK_THURSDAY }}" {{ $item_hour->item_hour_day_of_week == \App\Models\ItemHour::DAY_OF_WEEK_THURSDAY ? 'selected' :'' }}>{{ __('item_hour.thursday') }}</option>
                                        <option
                                            value="{{ \App\Models\ItemHour::DAY_OF_WEEK_FRIDAY }}" {{ $item_hour->item_hour_day_of_week == \App\Models\ItemHour::DAY_OF_WEEK_FRIDAY ? 'selected' :'' }}>{{ __('item_hour.friday') }}</option>
                                        <option
                                            value="{{ \App\Models\ItemHour::DAY_OF_WEEK_SATURDAY }}" {{ $item_hour->item_hour_day_of_week == \App\Models\ItemHour::DAY_OF_WEEK_SATURDAY ? 'selected' :'' }}>{{ __('item_hour.saturday') }}</option>
                                        <option
                                            value="{{ \App\Models\ItemHour::DAY_OF_WEEK_SUNDAY }}" {{ $item_hour->item_hour_day_of_week == \App\Models\ItemHour::DAY_OF_WEEK_SUNDAY ? 'selected' :'' }}>{{ __('item_hour.sunday') }}</option>
                                    </select>
                                </div>
                                <div class="col-12 col-md-2">
                                    ...
                                    <select id="item_hour_open_time_hour" class="selectpicker form-control"
                                        ...
                                        @for($full_hour=0; $full_hour<=24; $full_hour++)
                                            <option
                                                value="{{ $full_hour }}" {{ $full_hour == $item_hour_open_time_hour ? 'selected' :'' }}>{{ $full_hour }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-12 col-md-2">
                                    ...
                                    <select id="item_hour_open_time_minute" class="selectpicker form-control"
                                        ...
                                        @for($full_minute=0; $full_minute<=59; $full_minute++)
                                            <option
                                                value="{{ $full_minute }}" {{ $full_minute == $item_hour_open_time_minute ? 'selected' :'' }}>{{ $full_minute }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-12 col-md-2">
                                    ...
                                    <select id="item_hour_close_time_hour" class="selectpicker form-control"
                                        ...
                                        @for($full_hour=0; $full_hour<=24; $full_hour++)
                                            <option
                                                value="{{ $full_hour }}" {{ $full_hour == $item_hour_close_time_hour ? 'selected' :'' }}>{{ $full_hour }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-12 col-md-2">
                                    ...
                                    <select id="item_hour_close_time_minute" class="selectpicker form-control"
                                        ...
                                        @for($full_minute=0; $full_minute<=59; $full_minute++)
                                            <option
                                                value="{{ $full_minute }}" {{ $full_minute == $item_hour_close_time_minute ? 'selected' :'' }}>{{ $full_minute }}</option>
                                        @endfor
                                    </select>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="deleteItemHourModal_{{ $item_hour->id }}" tabindex="-1" role="dialog"
             aria-labelledby="deleteItemHourModal_{{ $item_hour->id }}" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"
                            id="exampleModalLongTitle">{{ __('item_hour.modal-delete-hours-title') }}</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                                data-dismiss="modal">{{ __('backend.shared.cancel') }}</button>
                        <form action="{{ route('admin.items.hours.destroy', ['item_hour' => $item_hour]) }}"
                              method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger">{{ __('backend.shared.delete') }}</button>
    ...
    @foreach($item_hour_exceptions as $item_hour_exceptions_key => $item_hour_exception)
        <div class="modal fade" id="editItemHourExceptionModal_{{ $item_hour_exception->id }}" tabindex="-1"
             role="dialog" aria-labelledby="editItemHourExceptionModal_{{ $item_hour_exception->id }}"
             aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"
                            id="exampleModalLongTitle">{{ __('item_hour.modal-edit-hour-exceptions-title') }}</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form id="update-item-slug-form"
                          action="{{ route('admin.items.hour-exceptions.update', ['item_hour_exception' => $item_hour_exception]) }}"
                          method="POST">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            ...
                            <div class="form-row mb-3 align-items-end">
                                <div class="col-12 col-md-4">
                                    ...
                                    <input id="item_hour_exception_date" type="text"
                                           ...
                                           value="{{ $item_hour_exception->item_hour_exception_date }}"
                                           placeholder="{{ __('item_hour.open-hour-exception-date-placeholder') }}">
                                </div>
                                <div class="col-12 col-md-2">
                                    ...
                                    <select id="item_hour_exception_open_time_hour" class="selectpicker form-control"
                                        ...
                                        <option
                                            value="" {{ is_null($item_hour_exception_open_time_hour) ? 'selected' :'' }}>{{ __('item_hour.open-hour-exception-close-all-day') }}</option>
                                        @for($full_hour=0; $full_hour<=24; $full_hour++)
                                            <option
                                                value="{{ $full_hour }}" {{ (!is_null($item_hour_exception_open_time_hour) && $full_hour == $item_hour_exception_open_time_hour) ? 'selected' :'' }}>{{ $full_hour }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-12 col-md-2">
                                    ...
                                    <select id="item_hour_exception_open_time_minute" class="selectpicker form-control"
                                        ...
                                        <option
                                            value="" {{ is_null($item_hour_exception_open_time_minute) ? 'selected' :'' }}>{{ __('item_hour.open-hour-exception-close-all-day') }}</option>
                                        @for($full_minute=0; $full_minute<=59; $full_minute++)
                                            <option
                                                value="{{ $full_minute }}" {{ (!is_null($item_hour_exception_open_time_minute) && $full_minute == $item_hour_exception_open_time_minute) ? 'selected' :'' }}>{{ $full_minute }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-12 col-md-2">
                                    ...
                                    <select id="item_hour_exception_close_time_hour" class="selectpicker form-control"
                                        ...
                                        <option
                                            value="" {{ is_null($item_hour_exception_close_time_hour) ? 'selected' :'' }}>{{ __('item_hour.open-hour-exception-close-all-day') }}</option>
                                        @for($full_hour=0; $full_hour<=24; $full_hour++)
                                            <option
                                                value="{{ $full_hour }}" {{ (!is_null($item_hour_exception_close_time_hour) && $full_hour == $item_hour_exception_close_time_hour) ? 'selected' :'' }}>{{ $full_hour }}</option>
                                        @endfor
                                    </select>
                                </div>
                                <div class="col-12 col-md-2">
                                    ...
                                    <select id="item_hour_exception_close_time_minute" class="selectpicker form-control"
                                        ...
                                        <option
                                            value="" {{ is_null($item_hour_exception_close_time_minute) ? 'selected' :'' }}>{{ __('item_hour.open-hour-exception-close-all-day') }}</option>
                                        @for($full_minute=0; $full_minute<=59; $full_minute++)
                                            <option
                                                value="{{ $full_minute }}" {{ (!is_null($item_hour_exception_close_time_minute) && $full_minute == $item_hour_exception_close_time_minute) ? 'selected' :'' }}>{{ $full_minute }}</option>
                                        @endfor
                                    </select>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="deleteItemHourExceptionModal_{{ $item_hour_exception->id }}" tabindex="-1"
             role="dialog" aria-labelledby="deleteItemHourExceptionModal_{{ $item_hour_exception->id }}"
             aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"
                            id="exampleModalLongTitle">{{ __('item_hour.modal-delete-hour-exception-title') }}</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                                data-dismiss="modal">{{ __('backend.shared.cancel') }}</button>
                        <form
                            action="{{ route('admin.items.hour-exceptions.destroy', ['item_hour_exception' => $item_hour_exception]) }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger">{{ __('backend.shared.delete') }}</button>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
             ...
             */
            @if((old('item_type') ? old('item_type') : $item->item_type) == \App\Models\Item::ITEM_TYPE_ONLINE)
            ...
            var count = {{$item->itemPhones->count() ?? 0}};
            /**
        ...
        function updateWordCount() {
            ...
            var maxWords = {{@$plan?->check_plan(7)->value ?? 10000}};
    ...
    @if($site_global_settings->setting_site_map == \App\Models\Setting::SITE_MAP_GOOGLE_MAP)
        ...
        <script>
            function initMap() {
                const myLatlng = {
                    lat: {{ empty($item->item_lat) ? $site_global_settings->setting_site_location_lat : $item->item_lat }},
                    lng: {{ empty($item->item_lng) ? $site_global_settings->setting_site_location_lng : $item->item_lng }}
                };
