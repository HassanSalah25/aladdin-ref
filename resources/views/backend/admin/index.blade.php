    ...
    @if($warning_smtp)
        <div class="alert alert-warning" role="alert">
            <p>
                ...
                {{ __('theme_alaadin.setting.warning-smtp') }}
            </p>
            <p>
                <a href="{{ route('admin.settings.general.edit') }}" class="btn btn-sm btn-outline-info">
                    <i class="fas fa-cog"></i>
                    {{ __('theme_alaadin.setting.warning-smtp-action') }}
                </a>
            </p>
        </div>
    @endif
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    @foreach($recent_threads as $recent_threads_key => $thread)
                        <div class="row pt-2 pb-2 {{ $recent_threads_key%2 == 0 ? 'bg-light' : '' }}">
                            ...
                            <div class="col-3 text-right">
                                <span>{{ $thread->activity_name }}</span>
                            </div>
                        </div>
                    @endforeach
                    ...
                    <div class="row text-center mt-3">
                        <div class="col-12">
                            <a href="{{ route('admin.orders.index') }}">{{ __('backend.homepage.view-all-message') }}</a>
                        </div>
                    </div>
                </div>
            </div>
