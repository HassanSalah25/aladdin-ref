...
@section('content')
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            <form id="ad-create-form" method="POST" action="{{ route('admin.plans.store') }}">
                @csrf
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <input id="plan_name" type="text"
                                       ...
                                       name="plan_name" value="{{ old('plan_name') }}" autofocus>
                                @error('plan_name')
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <input id="plan_name_ar" type="text"
                                       ...
                                       name="plan_name_ar" value="{{ old('plan_name_ar') }}" autofocus>
                                @error('plan_name_ar')
                                <span class="invalid-tooltip">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <input id="plan_price" type="number"
                                       ...
                                       name="plan_price" value="{{ old('plan_price') }}" autofocus>
                                @error('plan_price')
                                <span class="invalid-tooltip">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <input id="plan_period" type="number"
                                       ...
                                       name="plan_period" value="{{ old('plan_period') }}" autofocus>
                                @error('plan_period')
                                <span class="invalid-tooltip">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row form-group">
                            <div class="col-md-6">
                                ...
                                <select class="custom-select @error('plan_status') is-invalid @enderror"
                                        name="plan_status">
                                    <option
                                        value="{{ \App\Models\Plan::PLAN_ENABLED }}" {{  old('plan_status') == \App\Models\Plan::PLAN_ENABLED ? 'selected' : '' }}>{{ __('plan.plan-status-enable') }}</option>
                                    <option
                                        value="{{ \App\Models\Plan::PLAN_DISABLED }}" {{ old('plan_status') == \App\Models\Plan::PLAN_DISABLED ? 'selected' : '' }}>{{ __('plan.plan-status-disable') }}</option>
                                </select>
                                @error('plan_status')
                                <span class="invalid-tooltip">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="row form-group ">
                            <div class="col-md-12 h-100 ">
                                ...
                                <textarea id="plan_description" type="text"
                                          ...
                                          name="plan_description">{{ old('plan_description') }}</textarea>
                        ...
                        <div class="row form-group ">
                            <div class="col-md-12 h-100 ">
                                ...
                                <textarea id="plan_description_ar" type="text"
                                          ...
                                          name="plan_description_ar">{{ old('plan_description_ar') }}</textarea>
