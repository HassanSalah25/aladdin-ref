        ...
        <div class="col-12">
                            ...
                            <form class="form-inline" action="{{ route('admin.advertisements.create') }}" method="GET">
                                <div class="form-group mr-2">
                                    <select id="advertisement_place_type"
                                            class="selectpicker form-control @error('advertisement_place_type') is-invalid @enderror"
                                            name="advertisement_place_type" data-live-search="true" onchange="$('#ad-create-form').remove();">
                                         <option
                                            value="3" {{ $advertisement_place_type == 3 ? 'selected' : '' }}>
                                            {{ __('theme_alaadin.theme-system-default') }}
                                        </option>
                                        <option
                                            value="1" {{ $advertisement_place_type == 1 ? 'selected' : '' }}>
                                            {{ __('backend.shared.state') }}
                                        </option>
                                        <option
                                            value="2" {{ $advertisement_place_type == 2 ? 'selected' : '' }}>
                                            {{ __('listings_filter.categories') }}
                                        </option>
                                ...
                                <div id="default" class="form-group mr-2">
                                    <select id="advertisement_place"
                                            class="selectpicker form-control @error('advertisement_place') is-invalid @enderror"
                                            name="advertisement_place" data-live-search="true" onchange="$('#ad-create-form').remove();">
                                        <option value="">{{ __('advertisement.select-ad-place') }}</option>
                                        <option
                                            value="{{ \App\Models\Advertisement::AD_PLACE_HOME_PAGES }}"
                                            {{ $advertisement_place == \App\Models\Advertisement::AD_PLACE_HOME_PAGES ? 'selected' : '' }}>
                                            {{ __('advertisement.ad-place-home-page') }}
                                        </option>
                                        <option
                                            value="{{ \App\Models\Advertisement::AD_PLACE_LISTING_SEARCH_PAGE }}"
                                            {{ $advertisement_place == \App\Models\Advertisement::AD_PLACE_LISTING_SEARCH_PAGE ? 'selected' : '' }}>
                                            {{ __('advertisement.ad-place-listing-search') }}
                                        </option>
                                        <option
                                            value="{{ \App\Models\Advertisement::AD_PLACE_LISTING_POPULAR_PAGE }}"
                                            {{ $advertisement_place == \App\Models\Advertisement::AD_PLACE_LISTING_POPULAR_PAGE ? 'selected' : '' }}>
                                            {{ __('advertisement.ad-place-listing-popular') }}
                                        </option>
                                    </select>
                                    @error('ad_place')
                                    <span class="invalid-tooltip">
                                ...
                                <div id="states" class="form-group mr-2">
                                    <select id="advertisement_place_states"
                                                class="selectpicker form-control @error('advertisement_place_states') is-invalid @enderror"
                                                name="advertisement_place_states" data-live-search="true" onchange="$('#ad-create-form').remove();">
                                        <option value="">{{ __('advertisement.select-ad-place') }}</option>
                                        @foreach($states as $state)
                                            <option
                                                value="{{$state->id}}" {{ $advertisement_place_states == $state->id ? 'selected' : '' }}>
                                                {{ $state->state_name }}
                                            </option>
                                        @endforeach
                                ...
                                <div id="categories" class="form-group mr-2">
                                    <select id="advertisement_place_categories"
                                            class="selectpicker form-control @error('advertisement_place_categories') is-invalid @enderror"
                                            name="advertisement_place_categories" data-live-search="true" onchange="$('#ad-create-form').remove();">
                                        <option value="">{{ __('advertisement.select-ad-place') }}</option>

                                        @foreach($categories as $category)
                                            <option
                                                value="{{$category->id}}" {{ $advertisement_place_categories == $category->id ? 'selected' : '' }}>
            ...
            <div class="row">
                <div class="col-12 col-md-10 col-lg-6">
                    @if($advertisement_place > 0 || $advertisement_place_states > 0 || $advertisement_place_categories > 0)
                        <form id="ad-create-form" method="POST" action="{{ route('admin.advertisements.store') }}">
                            ...
                            <input name="advertisement_place_states" value="{{ $advertisement_place_states }}" type="hidden"
                                   id="input_advertisement_place_states">
                            <input name="advertisement_place_categories" value="{{ $advertisement_place_categories }}" type="hidden"
