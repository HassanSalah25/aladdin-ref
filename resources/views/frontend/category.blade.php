        ...
        <nav class="breadcrumb-wrapper" style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <a href="{{route('page.categories')}}"> {{__('categories.categories')}}</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">
                    <a href="{{route('page.sub_categories',$category->parent->category_slug )}}">{{$category->parent->category_name}} </a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">
                    {{$category->category_name}}  ( {{$free_items->total()}} )
                </li>
            </ol>
        </nav>
    </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="cateogries__filters">
                        ...
                        <form method="GET" action="{{ route('page.category', ['parent_category_slug'=> $category->parent->category_slug,'category_slug'=>$category->category_slug]) }}" id="filter_form">
                            ...
                            <div class="row">
                                <div class="col-12 text-right">
                                    <a class="btn btn-sm btn-outline-primary rounded" href="{{ route('page.category', ['parent_category_slug'=> $category->parent->category_slug,'category_slug'=>$category->category_slug]) }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#filter_state').on('change', function() {
                ...
                if (this.value > 0) {
                    $('#filter_city').html("<option value='' selected>{{ __('prefer_country.loading-wait') }}</option>");
