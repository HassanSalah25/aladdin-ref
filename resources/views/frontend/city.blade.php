    ...
    <div class="container">
        <nav class="breadcrumb-wrapper" style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('page.states') }}">{{ __('frontend.search.state-or-city') }}</a></li>
                <li class="breadcrumb-item"><a href="{{ route('page.cities',$state->state_name) }}">{{ $state->state_name }}</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ $city->city_name }} ( {{ $free_items->total() }} )</li>
                ...
                <div class="overlap-category ">
                    ...
                    <div class="row align-items-stretch no-gutters">
                        ...
                        <div class="col-sm-6 col-md-4 mb-4 mb-lg-0 col-lg-2">
                            ...
                            <a href="{{ route('page.category', ['parent_category_slug'=> $category->parent->category_slug,'category_slug'=>$category->category_slug]) }}" class="popular-category h-100">
                                <span class="icon">
                                    <span>
                            ...
                            <a href="{{ route('page.category', ['parent_category_slug'=> $category->parent->category_slug,'category_slug'=>$category->category_slug]) }}" class="popular-category h-100 image-category">
                            ...
                            <div class="col-12 col-sm-6 col-md-12">
                                <div class=" filter_category_div">
                                    <div class="col-12 col-md-12 pl-0">
                                        <label for="filter_category" class="my-4">{{ __('theme_alaadin.filter-category') }}</label>
                                        <select class="selectpicker form-control @error('filter_category') is-invalid @enderror" name="filter_category" id="filter_category" data-live-search="true">
                                            <option value="0" {{ request('filter_category') ? 'selected' : '' }}>{{ __('prefer_country.all-categories') }}</option>
                                            @foreach($filter_categories as $children_categories_key => $children_category)
                                                <option value="{{ $children_category->id }}" {{ request('filter_category') == $children_category->id ? 'selected' : '' }}>{{ $children_category->category_name }}</option>
                                            @endforeach
                                        </select>
