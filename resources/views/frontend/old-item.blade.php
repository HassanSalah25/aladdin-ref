...
@section('styles')
    ...
    @if($item->item_type == \App\Models\Item::ITEM_TYPE_REGULAR && $site_global_settings->setting_site_map == \App\Models\Setting::SITE_MAP_OPEN_STREET_MAP)
    ...
    @if($site_global_settings->setting_site_recaptcha_item_lead_enable == \App\Models\Setting::SITE_RECAPTCHA_ITEM_LEAD_ENABLE)
        ...
        <div class="container">
            <div class="row align-items-center item-blocks-cover">
                ...
                <div class="col-lg-7 col-md-5" data-aos="fade-up" data-aos-delay="400">
                    ...
                    @if($item_total_categories > \App\Models\Item::ITEM_TOTAL_SHOW_CATEGORY)
                        <a class="text-primary" href="#" data-toggle="modal" data-target="#showCategoriesModal">
                            {{ __('categories.and') . " " . strval($item_total_categories - \App\Models\Item::ITEM_TOTAL_SHOW_CATEGORY) . " ". __('categories.more') }}
                    ...
                    @endif
                    <a class="btn btn-primary rounded text-white" href="#" data-toggle="modal" data-target="#qrcodeModal"><i class="fas fa-qrcode"></i> {{ __('theme_alaadin.listing.qr-code') }}</a>
        ...
        <div class="container">
            ...
            @if($ads_before_breadcrumb->count() > 0)
                @foreach($ads_before_breadcrumb as $ads_before_breadcrumb_key => $ad_before_breadcrumb)
                    <div class="row mb-3">
                        @if($ad_before_breadcrumb->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_LEFT)
                            <div class="col-12 text-left">
                                <div>
                                    {!! $ad_before_breadcrumb->advertisement_code !!}
                                </div>
                            </div>
                        @elseif($ad_before_breadcrumb->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_CENTER)
                            <div class="col-12 text-center">
                                <div>
                                    {!! $ad_before_breadcrumb->advertisement_code !!}
                                </div>
                            </div>
                        @elseif($ad_before_breadcrumb->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_RIGHT)
            ...
            @if($ads_after_breadcrumb->count() > 0)
                @foreach($ads_after_breadcrumb as $ads_after_breadcrumb_key => $ad_after_breadcrumb)
                    <div class="row mb-3">
                        @if($ad_after_breadcrumb->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_LEFT)
                            <div class="col-12 text-left">
                                <div>
                                    {!! $ad_after_breadcrumb->advertisement_code !!}
                                </div>
                            </div>
                        @elseif($ad_after_breadcrumb->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_CENTER)
                            <div class="col-12 text-center">
                                <div>
                                    {!! $ad_after_breadcrumb->advertisement_code !!}
                                </div>
                            </div>
                        @elseif($ad_after_breadcrumb->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_RIGHT)
                            <div class="col-12 text-right">
                                <div>
                                    {!! $ad_after_breadcrumb->advertisement_code !!}
                                </div>
                ...
                <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            @foreach($after_breadcrumb_section_collections as $after_breadcrumb_section_collections_key => $after_breadcrumb_section_collection)
                                                <div class="col-md-6 col-sm-12 mb-3">
                                                    ...
                                                    @if($after_breadcrumb_section_collection->item_section_collection_collectible_type == \App\Models\ItemSectionCollection::COLLECTIBLE_TYPE_PRODUCT)
                                                        @php
                                                            $find_product_after_breadcrumb = \App\Models\Product::find($after_breadcrumb_section_collection->item_section_collection_collectible_id);
                                                        @endphp
                    ...
                    @if($ads_before_gallery->count() > 0)
                        @foreach($ads_before_gallery as $ads_before_gallery_key => $ad_before_gallery)
                            <div class="row mb-3">
                                @if($ad_before_gallery->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_LEFT)
                                    <div class="col-12 text-left">
                                        <div>
                                            {!! $ad_before_gallery->advertisement_code !!}
                                        </div>
                                    </div>
                                @elseif($ad_before_gallery->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_CENTER)
                                    <div class="col-12 text-center">
                                        <div>
                                            {!! $ad_before_gallery->advertisement_code !!}
                                        </div>
                                    </div>
                                @elseif($ad_before_gallery->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_RIGHT)
                                    <div class="col-12 text-right">
                                        <div>
                                            {!! $ad_before_gallery->advertisement_code !!}
                                        </div>
                                        ...
                                        <div class="row">
                                            @foreach($after_gallery_section_collections as $after_gallery_section_collections_key => $after_gallery_section_collection)
                                                <div class="col-md-6 col-sm-12 mb-3">
                                                    ...
                                                    @if($after_gallery_section_collection->item_section_collection_collectible_type == \App\Models\ItemSectionCollection::COLLECTIBLE_TYPE_PRODUCT)
                                                        @php
                                                            $find_product_after_gallery = \App\Models\Product::find($after_gallery_section_collection->item_section_collection_collectible_id);
                                                        @endphp
                                                        <div class="row align-items-center border-right">
                                                            <div class="col-md-5 col-4">
                    ...
                    @if($ads_before_description->count() > 0)
                        @foreach($ads_before_description as $ads_before_description_key => $ad_before_description)
                            <div class="row mb-3">
                                @if($ad_before_description->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_LEFT)
                                    <div class="col-12 text-left">
                                        <div>
                                            {!! $ad_before_description->advertisement_code !!}
                                        </div>
                                    </div>
                                @elseif($ad_before_description->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_CENTER)
                                    <div class="col-12 text-center">
                                        <div>
                                            {!! $ad_before_description->advertisement_code !!}
                                        </div>
                                    </div>
                                @elseif($ad_before_description->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_RIGHT)
                                    <div class="col-12 text-right">
                                        <div>
                                            {!! $ad_before_description->advertisement_code !!}
                                        </div>
                                        ...
                                        <div class="row">
                                            @foreach($after_description_section_collections as $after_description_section_collections_key => $after_description_section_collection)
                                                <div class="col-md-6 col-sm-12 mb-3">
                                                    ...
                                                    @if($after_description_section_collection->item_section_collection_collectible_type == \App\Models\ItemSectionCollection::COLLECTIBLE_TYPE_PRODUCT)
                                                        @php
                                                            $find_product_after_description = \App\Models\Product::find($after_description_section_collection->item_section_collection_collectible_id);
                                                        @endphp
                                                        <div class="row align-items-center border-right">
                                                            <div class="col-md-5 col-4">
                    ...
                    @if($item->item_type == \App\Models\Item::ITEM_TYPE_REGULAR)
                        ...
                        @if($ads_before_location->count() > 0)
                            @foreach($ads_before_location as $ads_before_location_key => $ad_before_location)
                                <div class="row mb-3">
                                    @if($ad_before_location->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_LEFT)
                                        <div class="col-12 text-left">
                                            <div>
                                                {!! $ad_before_location->advertisement_code !!}
                                            </div>
                                        </div>
                                    @elseif($ad_before_location->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_CENTER)
                                        <div class="col-12 text-center">
                                            <div>
                                                {!! $ad_before_location->advertisement_code !!}
                                            </div>
                                        </div>
                                    @elseif($ad_before_location->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_RIGHT)
                                        <div class="col-12 text-right">
                                            <div>
                                                {!! $ad_before_location->advertisement_code !!}
                                            </div>
                                            ...
                                            <div class="row">
                                                @foreach($after_location_map_section_collections as $after_location_map_section_collections_key => $after_location_map_section_collection)
                                                    <div class="col-md-6 col-sm-12 mb-3">
                                                        ...
                                                        @if($after_location_map_section_collection->item_section_collection_collectible_type == \App\Models\ItemSectionCollection::COLLECTIBLE_TYPE_PRODUCT)
                                                            @php
                                                                $find_product_after_location_map = \App\Models\Product::find($after_location_map_section_collection->item_section_collection_collectible_id);
                                                            @endphp
                                                            <div class="row align-items-center border-right">
                                                                <div class="col-md-5 col-4">
                    ...
                    @if($ads_before_features->count() > 0)
                        @foreach($ads_before_features as $ads_before_features_key => $ad_before_features)
                            <div class="row mb-3">
                                @if($ad_before_features->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_LEFT)
                                    <div class="col-12 text-left">
                                        <div>
                                            {!! $ad_before_features->advertisement_code !!}
                                        </div>
                                    </div>
                                @elseif($ad_before_features->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_CENTER)
                                    <div class="col-12 text-center">
                                        <div>
                                            {!! $ad_before_features->advertisement_code !!}
                                        </div>
                                    </div>
                                @elseif($ad_before_features->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_RIGHT)
                                    <div class="col-12 text-right">
                                        <div>
                                            {!! $ad_before_features->advertisement_code !!}
                                        </div>
                                    ...
                                    <div class="row pt-2 pb-2 mt-2 mb-2 border-left {{ $item_features_key%2 == 0 ? 'bg-light' : '' }}">
                                            ...
                                            <div class="col-9">
                                                @if($feature->item_feature_value)
                                                    @if($feature->customField->custom_field_type == \App\Models\CustomField::TYPE_LINK)
                                                        @php
                                                    ...
                                                    @elseif($feature->customField->custom_field_type == \App\Models\CustomField::TYPE_MULTI_SELECT)
                                                    ...
                                                    @elseif($feature->customField->custom_field_type == \App\Models\CustomField::TYPE_SELECT)
                                                        {{ $feature->item_feature_value }}

                                                    @elseif($feature->customField->custom_field_type == \App\Models\CustomField::TYPE_TEXT)
                                                        {!! clean(nl2br($feature->item_feature_value), array('HTML.Allowed' => 'b,strong,i,em,u,ul,ol,li,p,br')) !!}
                                                    @endif
                                                @endif
                                            </div>
                                        ...
                                        <div class="row">
                                            @foreach($after_features_section_collections as $after_features_section_collections_key => $after_features_section_collection)
                                                <div class="col-md-6 col-sm-12 mb-3">
                                                    ...
                                                    @if($after_features_section_collection->item_section_collection_collectible_type == \App\Models\ItemSectionCollection::COLLECTIBLE_TYPE_PRODUCT)
                                                        @php
                                                            $find_product_after_features = \App\Models\Product::find($after_features_section_collection->item_section_collection_collectible_id);
                                                        @endphp
                                                        <div class="row align-items-center border-right">
                                                            <div class="col-md-5 col-4">
                    ...
                    @if($ads_before_reviews->count() > 0)
                        @foreach($ads_before_reviews as $ads_before_reviews_key => $ad_before_reviews)
                            <div class="row mb-3">
                                @if($ad_before_reviews->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_LEFT)
                                    <div class="col-12 text-left">
                                        <div>
                                            {!! $ad_before_reviews->advertisement_code !!}
                                        </div>
                                    </div>
                                @elseif($ad_before_reviews->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_CENTER)
                                    <div class="col-12 text-center">
                                        <div>
                                            {!! $ad_before_reviews->advertisement_code !!}
                                        </div>
                                    </div>
                                @elseif($ad_before_reviews->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_RIGHT)
                                    <div class="col-12 text-right">
                                        <div>
                                            {!! $ad_before_reviews->advertisement_code !!}
                                        </div>
                        ...
                        'item_slug' => $item->item_slug
                    ]) }}#review-section" method="GET" class="form-inline" id="item-rating-sort-by-form">
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select ml-2 @error('rating_sort_by') is-invalid @enderror" name="rating_sort_by" id="rating_sort_by">
                                                        <option value="{{ \App\Models\Item::ITEM_RATING_SORT_BY_NEWEST }}" {{ $rating_sort_by == \App\Models\Item::ITEM_RATING_SORT_BY_NEWEST ? 'selected' : '' }}>{{ __('rating_summary.sort-by-newest') }}</option>
                                                        <option value="{{ \App\Models\Item::ITEM_RATING_SORT_BY_OLDEST }}" {{ $rating_sort_by == \App\Models\Item::ITEM_RATING_SORT_BY_OLDEST ? 'selected' : '' }}>{{ __('rating_summary.sort-by-oldest') }}</option>
                                                        <option value="{{ \App\Models\Item::ITEM_RATING_SORT_BY_HIGHEST }}" {{ $rating_sort_by == \App\Models\Item::ITEM_RATING_SORT_BY_HIGHEST ? 'selected' : '' }}>{{ __('rating_summary.sort-by-highest') }}</option>
                                                        <option value="{{ \App\Models\Item::ITEM_RATING_SORT_BY_LOWEST }}" {{ $rating_sort_by == \App\Models\Item::ITEM_RATING_SORT_BY_LOWEST ? 'selected' : '' }}>{{ __('rating_summary.sort-by-lowest') }}</option>
                                                    </select>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-4">
                                            ...
                                            <div class="row align-items-center mb-3">
                                                <div class="col-4">
                                                    @if(empty(\App\Models\User::find($review->author_id)->user_image))
                                                    ...
                                                    @else
                                                        <img src="{{ Storage::disk('public')->url('user/' . \App\Models\User::find($review->author_id)->user_image) }}" alt="{{ \App\Models\User::find($review->author_id)->name }}" class="img-fluid rounded-circle">
                                                    @endif
                                                </div>
                                                <div class="col-8 pl-0">
                                                    <span>{{ \App\Models\User::find($review->author_id)->name }}</span>
                                                </div>
                                            </div>
                                            ...
                                            @if($review->recommend == \App\Models\Item::ITEM_REVIEW_RECOMMEND_YES)
                                                <div class="row mb-2">
                                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            @foreach($after_reviews_section_collections as $after_reviews_section_collections_key => $after_reviews_section_collection)
                                                <div class="col-md-6 col-sm-12 mb-3">
                                                    ...
                                                    @if($after_reviews_section_collection->item_section_collection_collectible_type == \App\Models\ItemSectionCollection::COLLECTIBLE_TYPE_PRODUCT)
                                                        @php
                                                            $find_product_after_reviews = \App\Models\Product::find($after_reviews_section_collection->item_section_collection_collectible_id);
                                                        @endphp
                                                        <div class="row align-items-center border-right">
                                                            <div class="col-md-5 col-4">
                    ...
                    @if($ads_before_comments->count() > 0)
                        @foreach($ads_before_comments as $ads_before_comments_key => $ad_before_comments)
                            <div class="row mb-3">
                                @if($ad_before_comments->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_LEFT)
                                    <div class="col-12 text-left">
                                        <div>
                                            {!! $ad_before_comments->advertisement_code !!}
                                        </div>
                                    </div>
                                @elseif($ad_before_comments->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_CENTER)
                                    <div class="col-12 text-center">
                                        <div>
                                            {!! $ad_before_comments->advertisement_code !!}
                                        </div>
                                    </div>
                                @elseif($ad_before_comments->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_RIGHT)
                                    <div class="col-12 text-right">
                                        <div>
                                            {!! $ad_before_comments->advertisement_code !!}
                                        </div>
                                        ...
                                        <div class="row">
                                            @foreach($after_comments_section_collections as $after_comments_section_collections_key => $after_comments_section_collection)
                                                <div class="col-md-6 col-sm-12 mb-3">
                                                    ...
                                                    @if($after_comments_section_collection->item_section_collection_collectible_type == \App\Models\ItemSectionCollection::COLLECTIBLE_TYPE_PRODUCT)
                                                        @php
                                                            $find_product_after_comments = \App\Models\Product::find($after_comments_section_collection->item_section_collection_collectible_id);
                                                        @endphp
                                                        <div class="row align-items-center border-right">
                                                            <div class="col-md-5 col-4">
                    ...
                    @if($ads_before_share->count() > 0)
                        @foreach($ads_before_share as $ads_before_share_key => $ad_before_share)
                            <div class="row mb-3">
                                @if($ad_before_share->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_LEFT)
                                    <div class="col-12 text-left">
                                        <div>
                                            {!! $ad_before_share->advertisement_code !!}
                                        </div>
                                    </div>
                                @elseif($ad_before_share->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_CENTER)
                                    <div class="col-12 text-center">
                                        <div>
                                            {!! $ad_before_share->advertisement_code !!}
                                        </div>
                                    </div>
                                @elseif($ad_before_share->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_RIGHT)
                                    <div class="col-12 text-right">
                                        <div>
                                            {!! $ad_before_share->advertisement_code !!}
                                        </div>
                    ...
                    @if($ads_after_share->count() > 0)
                        @foreach($ads_after_share as $ads_after_share_key => $ad_after_share)
                            <div class="row mb-3">
                                @if($ad_after_share->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_LEFT)
                                    <div class="col-12 text-left">
                                        <div>
                                            {!! $ad_after_share->advertisement_code !!}
                                        </div>
                                    </div>
                                @elseif($ad_after_share->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_CENTER)
                                    <div class="col-12 text-center">
                                        <div>
                                            {!! $ad_after_share->advertisement_code !!}
                                        </div>
                                    </div>
                                @elseif($ad_after_share->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_RIGHT)
                                    <div class="col-12 text-right">
                                        <div>
                                            {!! $ad_after_share->advertisement_code !!}
                                        </div>
                                        ...
                                        <div class="row">
                                            @foreach($after_share_section_collections as $after_share_section_collections_key => $after_share_section_collection)
                                                <div class="col-md-6 col-sm-12 mb-3">
                                                    ...
                                                    @if($after_share_section_collection->item_section_collection_collectible_type == \App\Models\ItemSectionCollection::COLLECTIBLE_TYPE_PRODUCT)
                                                        @php
                                                            $find_product_after_share = \App\Models\Product::find($after_share_section_collection->item_section_collection_collectible_id);
                                                        @endphp
                                                        <div class="row align-items-center border-right">
                                                            <div class="col-md-5 col-4">
                    ...
                    <div class="pt-3">
                        ...
                        @if($ads_before_sidebar_content->count() > 0)
                            @foreach($ads_before_sidebar_content as $ads_before_sidebar_content_key => $ad_before_sidebar_content)
                                <div class="row mb-5">
                                    @if($ad_before_sidebar_content->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_LEFT)
                                        <div class="col-12 text-left">
                                            <div>
                                                {!! $ad_before_sidebar_content->advertisement_code !!}
                                            </div>
                                        </div>
                                    @elseif($ad_before_sidebar_content->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_CENTER)
                                        <div class="col-12 text-center">
                                            <div>
                                                {!! $ad_before_sidebar_content->advertisement_code !!}
                                            </div>
                                        </div>
                                    @elseif($ad_before_sidebar_content->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_RIGHT)
                                        <div class="col-12 text-right">
                                            <div>
                                                {!! $ad_before_sidebar_content->advertisement_code !!}
                                            </div>
                        ...
                        @if($ads_after_sidebar_content->count() > 0)
                            @foreach($ads_after_sidebar_content as $ads_after_sidebar_content_key => $ad_after_sidebar_content)
                                <div class="row mt-5">
                                    @if($ad_after_sidebar_content->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_LEFT)
                                        <div class="col-12 text-left">
                                            <div>
                                                {!! $ad_after_sidebar_content->advertisement_code !!}
                                            </div>
                                        </div>
                                    @elseif($ad_after_sidebar_content->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_CENTER)
                                        <div class="col-12 text-center">
                                            <div>
                                                {!! $ad_after_sidebar_content->advertisement_code !!}
                                            </div>
                                        </div>
                                    @elseif($ad_after_sidebar_content->advertisement_alignment == \App\Models\Advertisement::AD_ALIGNMENT_RIGHT)
                                        <div class="col-12 text-right">
                                            <div>
                                                {!! $ad_after_sidebar_content->advertisement_code !!}
                                            </div>
            ...
            @foreach($similar_items as $similar_items_key => $similar_item)
                <div class="col-lg-6">
                    <div class="d-block d-md-flex listing">
                        ...
                        'category_slug' => $similar_item->category->parent?->category_slug ?? $similar_item->category->category_slug,
                        'sub_category_slug' => $similar_item->category->category_slug,
                        'state_slug' => $similar_item->state->state_slug,
                        'item_slug' => $similar_item->item_slug
                    ]) }}" class="img d-block" style="background-image: url({{ !empty($similar_item->item_image_small) ? Storage::disk('public')->url('item/' . $similar_item->item_image_small) : (!empty($similar_item->item_image) ? Storage::disk('public')->url('item/' . $similar_item->item_image) : asset('frontend/images/placeholder/full_item_feature_image_small.webp')) }})"></a>
                        <div class="lh-content">

                            @foreach($similar_item->getAllCategories(\App\Models\Item::ITEM_TOTAL_SHOW_CATEGORY) as $similar_item_all_categories_key => $category)
                            ...
                            @if($similar_item->allCategories()->count() > \App\Models\Item::ITEM_TOTAL_SHOW_CATEGORY)
                                <span class="category">{{ __('categories.and') . " " . strval($similar_item->allCategories()->count() - \App\Models\Item::ITEM_TOTAL_SHOW_CATEGORY) . " " . __('categories.more') }}</span>
                            @endif

                            <h3 class="pt-2"><a href="{{ route('page.item', [
                        'category_slug' => $similar_item->category->parent?->category_slug ?? $similar_item->category->category_slug,
                        'sub_category_slug' => $similar_item->category->category_slug,
                        'state_slug' => $similar_item->state->state_slug,
                        'item_slug' => $similar_item->item_slug
                    ]) }}">{{ $similar_item->item_title }}</a></h3>

                            @if($similar_item->item_type == \App\Models\Item::ITEM_TYPE_REGULAR)
                            <address>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-7 col-md-5 pl-0 text-right">
                                    @if($similar_item->item_hour_show_hours == \App\Models\Item::ITEM_HOUR_SHOW)
        ...
        <div class="row">
            ...
            @foreach($nearby_items as $nearby_items_key => $nearby_item)
                <div class="col-lg-6">
                    <div class="d-block d-md-flex listing">
                        <a href="{{ route('page.item', [
                        'category_slug' => $nearby_item->category->parent?->category_slug ?? $nearby_item->category->category_slug,
                        'sub_category_slug' => $nearby_item->category->category_slug,
                        'state_slug' => $nearby_item->state->state_slug,
                        'item_slug' => $nearby_item->item_slug
                    ]) }}" class="img d-block" style="background-image: url({{ !empty($nearby_item->item_image_small) ? Storage::disk('public')->url('item/' . $nearby_item->item_image_small) : (!empty($nearby_item->item_image) ? Storage::disk('public')->url('item/' . $nearby_item->item_image) : asset('frontend/images/placeholder/full_item_feature_image_small.webp')) }})"></a>
                        <div class="lh-content">

                            @foreach($nearby_item->getAllCategories(\App\Models\Item::ITEM_TOTAL_SHOW_CATEGORY) as $nearby_item_all_categories_key => $category)
                                <a href="{{ route('page.category', $category->category_slug) }}">
                                    <span class="category">
                                        @if(!empty($category->category_icon))
                                            <i class="{{ $category->category_icon }}"></i>
                            ...
                            @if($nearby_item->allCategories()->count() > \App\Models\Item::ITEM_TOTAL_SHOW_CATEGORY)
                                <span class="category">{{ __('categories.and') . " " . strval($nearby_item->allCategories()->count() - \App\Models\Item::ITEM_TOTAL_SHOW_CATEGORY) . " " . __('categories.more') }}</span>
                            @endif
                        ...
                        'state_slug' => $nearby_item->state->state_slug,
                        'item_slug' => $nearby_item->item_slug
                    ]) }}">{{ $nearby_item->item_title }}</a></h3>

                            @if($nearby_item->item_type == \App\Models\Item::ITEM_TYPE_REGULAR)
                            <address>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-7 col-md-5 pl-0 text-right">
                                    @if($nearby_item->item_hour_show_hours == \App\Models\Item::ITEM_HOUR_SHOW)
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @endif
                        <form action="{{ route('page.item.email', ['item_slug' => [
                        'category_slug' => $item->category->parent?->category_slug ?? $item->category->category_slug,
                        'sub_category_slug' => $item->category->category_slug,
                        'state_slug' => $item->state->state_slug,
                        'item_slug' => $item->item_slug
...
<div class="modal fade" id="qrcodeModal" tabindex="-1" role="dialog" aria-labelledby="qrcodeModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('theme_alaadin.listing.qr-code')  }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('page.item.lead.store', ['item_slug' => [
                        'category_slug' => $item->category->parent?->category_slug ?? $item->category->category_slug,
                        'sub_category_slug' => $item->category->category_slug,
                        'state_slug' => $item->state->state_slug,
                        'item_slug' => $item->item_slug
...
@section('scripts')
    ...
    <script>
        $(document).ready(function(){
             ...
             * Start initial map
             */
            @if($site_global_settings->setting_site_map == \App\Models\Setting::SITE_MAP_OPEN_STREET_MAP && $item->item_type == \App\Models\Item::ITEM_TYPE_REGULAR)
            ...
            $("#item-qrcode").qrcode({
                ...
                // content
                text: '{{ route('page.item', ['item_slug' => [
                        'category_slug' => $item->category->parent?->category_slug ?? $item->category->category_slug,
                        'sub_category_slug' => $item->category->category_slug,
                        'state_slug' => $item->state->state_slug,
                        'item_slug' => $item->item_slug
    ...
    @if($site_global_settings->setting_site_map == \App\Models\Setting::SITE_MAP_GOOGLE_MAP && $item->item_type == \App\Models\Item::ITEM_TYPE_REGULAR)
    <script>
