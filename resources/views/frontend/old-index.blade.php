        ...
        <div class="row">
            <div class="col-12  block-13">
                <div class="owl-carousel nonloop-block-13">
                    ...
                    @if($paid_items->count() > 0)
                    ...
                    ]) }}" class="img d-block" style="background-image: url({{ !empty($item->item_image_medium) ? Storage::disk('public')->url('item/' . $item->item_image_medium) : (!empty($item->item_image) ? Storage::disk('public')->url('item/' . $item->item_image) : asset('frontend/images/placeholder/full_item_feature_image_medium.webp')) }})"></a>
                        ...
                        'state_slug' => $item->state->state_slug,
                        'item_slug' => $item->item_slug
                    ]) }}">{{ str_limit($item->item_title, 44, '...') }}</a></h3>
                    ...
                    <div class="col-md-6 mb-4 mb-lg-4 col-lg-4">
                        ...
                        <div class="listing-item listing">
                            ...
                            <div class="listing-item-content">
                                ...
                                <h2 class="mb-1 pt-2"><a href="{{ route('page.item', [
                        'category_slug' => $item->category->parent?->category_slug ?? $item->category->category_slug,
                        'sub_category_slug' => $item->category->category_slug,
                        'state_slug' => $item->state->state_slug,
                        'item_slug' => $item->item_slug
                    ]) }}">{{ $item->item_title }}</a></h2>
