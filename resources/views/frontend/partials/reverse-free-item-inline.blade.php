...
<div class="categories__items__list__item  d-inline-flex">
    ...
    style="background: linear-gradient(89deg, #522d79, #1d0e30) !important;color: white !important;">
        ...
        >
            <li class="categories__items__list__item__info__sub-info__item d-flex align-items-center gap-1">
                ...
                <a href="{{ route('page.cities', ['state_slug'=>$item->state->state_slug]) }}"
                   style="color: white !important;"
                ><span>{{ $item->state->state_name }}</span></a>
            </li>
            <li class="categories__items__list__item__info__sub-info__item d-flex align-items-center gap-1">
        ...
        <div class="d-flex jusitfy-content-between gap-3">
            <div>
                ...
                <div class="mb-base d-flex gap-2">
                    <span class="fw-bold">{{__('categories.category')}} : </span>
        ...
        <div
            ...
            @endif
            {{--  <button type="button"
                      class="white-space-nowrap categories__items__list__item__info__footer__btn btn btn-primary my-btn" style="color: var(--primary) !important;background-color: white;>
 ...
 --}}{{--                <a--}}{{--
 --}}{{--                    href="#mapid-box"--}}{{--
 --}}{{--                    class="categories__items__list__item__info__footer__contacts__item_reverse " style="color: var(--primary) !important;background-color: white;--}}{{--
 --}}{{--                    ><i class="las la-map-marker-alt"></i></a>--}}{{--
                 ...
                 <a href="tel:{{ $item->item_phone}}"
                    class="categories__items__list__item__info__footer__contacts__item_reverse " style="color: var(--primary) !important;background-color: white;><i class="las la-phone"></i></a>
             </div>--}}
        </div>
    </div>
</div>
