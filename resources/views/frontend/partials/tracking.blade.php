@if($site_global_settings->setting_site_google_analytic_enabled == \App\Models\Setting::TRACKING_ON)
    ...
    @else
        ...
        @else
            @if($site_global_settings->setting_site_google_analytic_not_track_admin == \App\Models\Setting::TRACKING_ADMIN)
