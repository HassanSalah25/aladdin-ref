                        ...
                        <form class="d-flex flex-column flex-wrap flex-lg-row align-items-lg-center gap-4"
                            ...
                            <div class="d-flex gap-3 align-items-center categories__orders__item">
                                ...
                                <select class="form-select border-0" id="selectOrderBy" name="filter_sort_by">
                                    ...
                                    <option
                                        value="7" {{ ("بالقرب مني" == request('search_city_state') || 7 == request('filter_sort_by')) ? 'selected' : '' }}>{{__('frontend.homepage.nearby-listings')}}</option>
                                <option value="{{ \App\Models\Item::ITEMS_SORT_BY_NEWEST_CREATED }}" {{ request('filter_sort_by') == \App\Models\Item::ITEMS_SORT_BY_NEWEST_CREATED ? 'selected' : '' }}>{{__('listings_filter.sort-by-newest')}}</option>
                                <option value="{{ \App\Models\Item::ITEMS_SORT_BY_OLDEST_CREATED }}" {{ request('filter_sort_by') == \App\Models\Item::ITEMS_SORT_BY_OLDEST_CREATED ? 'selected' : '' }}>{{__('listings_filter.sort-by-oldest')}}</option>
                                </select>
                            </div>
                            ...
                            <div class="d-flex gap-3 align-items-center categories__orders__item">
                                <label for="selectOrderBy" class="white-space-nowrap">
                                    <i class="las la-filter"></i>
                                    <span>{{__('categories.all-cat')}}</span>
                                </label>

                                <select class="form-select border-0" id="selectOrderBy" name="search_category">
                                    <option
                                        value="" {{ empty(request('search_category')) ? 'selected' : '' }}>{{ __('categories.all-cat') }}</option>
                                    {{--                                <option value="max_price" {{ 'max_price' == request('filter_sort_by') ? 'selected' : '' }}>{{__('listings_filter.sort-by-price-high')}}</option>--}}
                                    @foreach($search_categories as $category_key=> $category)
                                        <option
                                            value="{{ $category->id }}" {{ request('search_category') == $category->id ? 'selected' : '' }}>{{ $category->category_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="d-flex gap-3 align-items-center categories__orders__item">
                                <label for="selectOrderBy" class="white-space-nowrap">
                                    <i class="las la-filter"></i>
                                    <span>{{__('categories.all-sub-cat')}}</span>
                                </label>

                                <select class="form-select border-0" id="selectOrderBy" name="search_category_2">
                                    <option
                                        value="" {{ empty(request('search_category_2')) ? 'selected' : '' }}>{{ __('categories.all-sub-cat') }}</option>
                                    {{--                                <option value="max_price" {{ 'max_price' == request('filter_sort_by') ? 'selected' : '' }}>{{__('listings_filter.sort-by-price-high')}}</option>--}}
                                    @foreach($all_sub_categories as $category_key=> $category)
                                        <option
                                            value="{{ $category->id }}" {{ request('search_category_2') == $category->id ? 'selected' : '' }}>{{ $category->category_name }}</option>
                                    @endforeach
                                </select>
                            </div>
